module svm (clk,
 ...
 sky130_fd_sc_hd__or2_1 _4207_ (.A(net314),
    .B(_0723_),
    .X(_0734_));
 sky130_fd_sc_hd__or2_1 _4208_ (.A(net306),
    .B(_0734_),
    .X(_0745_));
 sky130_fd_sc_hd__or3_2 _4209_ (.A(net288),
    .B(net297),
    .C(_0745_),
    .X(_0756_));
 sky130_fd_sc_hd__or3_1 _4210_ (.A(net269),
    .B(net278),
    .C(_0756_),
    .X(_0767_));
 sky130_fd_sc_hd__or2_1 _4211_ (.A(net261),
    .B(_0767_),
    .X(_0778_));
 sky130_fd_sc_hd__or3_1 _4212_ (.A(net217),
    ...
    .C(_0778_),
    .X(_0789_));
 sky130_fd_sc_hd__or2_1 _4213_ (.A(net186),
    .B(_0789_),
    .X(_0800_));
 ...
 sky130_fd_sc_hd__inv_2 _4234_ (.A(net274),
    .Y(_1031_));
 sky130_fd_sc_hd__buf_4 _4235_ (.A(_1031_),
    .X(_1042_));
 ...
 sky130_fd_sc_hd__and3_1 _4240_ (.A(net79),
    ...
    .C(_1075_),
    .X(_1097_));
 sky130_fd_sc_hd__inv_2 _4241_ (.A(net293),
    .Y(_1108_));
 sky130_fd_sc_hd__buf_4 _4242_ (.A(_1108_),
    .X(_1119_));
 ...
 sky130_fd_sc_hd__or4_1 _4285_ (.A(\counter[10] ),
    ...
    .D(_1580_),
    .X(_1591_));
 sky130_fd_sc_hd__or3_1 _4286_ (.A(_1558_),
    .B(_1569_),
    .C(_1591_),
    .X(_1602_));
 ...
 sky130_fd_sc_hd__buf_4 _4291_ (.A(_1646_),
    .X(_1657_));
 sky130_fd_sc_hd__xnor2_1 _4292_ (.A(\delta[15] ),
    .B(_1657_),
    .Y(_0063_));
 sky130_fd_sc_hd__xnor2_1 _4293_ (.A(\delta[14] ),
    .B(_1657_),
    .Y(_0062_));
 sky130_fd_sc_hd__xnor2_1 _4294_ (.A(\delta[13] ),
    .B(_1657_),
    .Y(_0061_));
 sky130_fd_sc_hd__xnor2_1 _4295_ (.A(\delta[12] ),
    .B(_1657_),
    .Y(_0060_));
 sky130_fd_sc_hd__xnor2_1 _4296_ (.A(\delta[11] ),
    .B(_1657_),
    .Y(_0059_));
 sky130_fd_sc_hd__xnor2_1 _4297_ (.A(\delta[10] ),
    .B(_1657_),
    .Y(_0058_));
 sky130_fd_sc_hd__xnor2_1 _4298_ (.A(\delta[9] ),
    .B(_1657_),
    .Y(_0057_));
 sky130_fd_sc_hd__xnor2_1 _4299_ (.A(\delta[8] ),
    .B(_1657_),
    .Y(_0056_));
 sky130_fd_sc_hd__xnor2_1 _4300_ (.A(\delta[7] ),
    .B(_1657_),
    .Y(_0055_));
 sky130_fd_sc_hd__xnor2_1 _4301_ (.A(\delta[6] ),
    .B(_1657_),
    .Y(_0054_));
 sky130_fd_sc_hd__xnor2_1 _4302_ (.A(\delta[5] ),
    .B(_1646_),
    .Y(_0053_));
 sky130_fd_sc_hd__xnor2_1 _4303_ (.A(\delta[4] ),
    .B(_1646_),
    .Y(_0052_));
 sky130_fd_sc_hd__xnor2_1 _4304_ (.A(\delta[3] ),
    .B(_1646_),
    .Y(_0051_));
 sky130_fd_sc_hd__xnor2_1 _4305_ (.A(\delta[2] ),
    .B(_1646_),
    .Y(_0050_));
 sky130_fd_sc_hd__xnor2_1 _4306_ (.A(\delta[1] ),
    .B(_1646_),
    .Y(_0049_));
 ...
 sky130_fd_sc_hd__and4bb_1 _4319_ (.A_N(net158),
    ...
    .D(net283),
    .X(_1950_));
 sky130_fd_sc_hd__a21oi_1 _4320_ (.A1(_1928_),
    .A2(_1939_),
    .B1(_1950_),
    .Y(_1961_));
 sky130_fd_sc_hd__xnor2_1 _4321_ (.A(_1917_),
    .B(_1961_),
    .Y(_1972_));
 ...
 sky130_fd_sc_hd__and4bb_1 _4326_ (.A_N(net158),
    ...
    .D(net283),
    .X(_2027_));
 sky130_fd_sc_hd__a21oi_1 _4327_ (.A1(_2005_),
    .A2(_2016_),
    .B1(_2027_),
    .Y(_2038_));
 sky130_fd_sc_hd__a21oi_1 _4328_ (.A1(_1994_),
    ...
    .B1(_2027_),
    .Y(_2049_));
 sky130_fd_sc_hd__xor2_1 _4329_ (.A(_1972_),
    .B(_2049_),
    .X(_2060_));
 ...
 sky130_fd_sc_hd__a21o_1 _4331_ (.A1(_1906_),
    ...
    .B1(_2071_),
    .X(_2082_));
 sky130_fd_sc_hd__or2b_1 _4332_ (.A(net164),
    .B_N(net258),
    .X(_2093_));
 sky130_fd_sc_hd__nand2b_1 _4333_ (.A_N(net167),
    .B(net265),
    .Y(_2104_));
 sky130_fd_sc_hd__inv_2 _4334_ (.A(net162),
    .Y(_2115_));
 sky130_fd_sc_hd__nand2_1 _4335_ (.A(_2115_),
    .B(net273),
    .Y(_2126_));
 ...
 sky130_fd_sc_hd__nor2_1 _4340_ (.A(net45),
    .B(_0921_),
    .Y(_2180_));
 sky130_fd_sc_hd__clkinv_4 _4341_ (.A(net182),
    .Y(_2191_));
 ...
 sky130_fd_sc_hd__a21o_1 _4347_ (.A1(_2180_),
    ...
    .B1(_2246_),
    .X(_2257_));
 sky130_fd_sc_hd__inv_2 _4348_ (.A(net265),
    .Y(_2268_));
 ...
 sky130_fd_sc_hd__nand2_1 _4355_ (.A(_2257_),
    .B(_2323_),
    .Y(_2345_));
 sky130_fd_sc_hd__a21boi_1 _4356_ (.A1(_2169_),
    .A2(_2334_),
    .B1_N(_2345_),
    .Y(_2356_));
 ...
 sky130_fd_sc_hd__inv_2 _4358_ (.A(net187),
    .Y(_2378_));
 sky130_fd_sc_hd__nand2_1 _4359_ (.A(net299),
    .B(_2378_),
    .Y(_2389_));
 ...
 sky130_fd_sc_hd__or2b_1 _4392_ (.A(net166),
    .B_N(net210),
    .X(_2752_));
 sky130_fd_sc_hd__or2b_1 _4393_ (.A(net164),
    .B_N(net239),
    .X(_2763_));
 ...
 sky130_fd_sc_hd__nor2_1 _4397_ (.A(_2796_),
    .B(net162),
    .Y(_2807_));
 sky130_fd_sc_hd__xnor2_1 _4398_ (.A(_2785_),
    .B(_2807_),
    .Y(_2818_));
 sky130_fd_sc_hd__or3_1 _4399_ (.A(_2697_),
    .B(_2741_),
    .C(_2818_),
    .X(_2829_));
 ...
 sky130_fd_sc_hd__inv_2 _4410_ (.A(net39),
    .Y(_2950_));
 sky130_fd_sc_hd__nand2_1 _4411_ (.A(net299),
    .B(_2950_),
    .Y(_2961_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _4422_ (.A(_2950_),
    .X(_3082_));
 sky130_fd_sc_hd__and3_1 _4423_ (.A(net299),
    .B(_3082_),
    .C(_3005_),
    .X(_3093_));
 ...
 sky130_fd_sc_hd__xnor2_2 _4425_ (.A(_3071_),
    .B(_3104_),
    .Y(_3115_));
 sky130_fd_sc_hd__nand2_1 _4426_ (.A(net299),
    .B(net179),
    .Y(_3126_));
 ...
 sky130_fd_sc_hd__a21o_1 _4438_ (.A1(_3203_),
    ...
    .B1(_3236_),
    .X(_3258_));
 sky130_fd_sc_hd__nand2_1 _4439_ (.A(net239),
    .B(_2115_),
    .Y(_3269_));
 ...
 sky130_fd_sc_hd__nor2_1 _4469_ (.A(_3280_),
    .B(_2752_),
    .Y(_3593_));
 sky130_fd_sc_hd__a31o_1 _4470_ (.A1(net239),
    .A2(_2115_),
    .A3(_3313_),
    .B1(_3593_),
    .X(_3601_));
 ...
 sky130_fd_sc_hd__and4bb_1 _4474_ (.A_N(net173),
    ...
    .D(net117),
    .X(_3638_));
 sky130_fd_sc_hd__inv_2 _4475_ (.A(net148),
    .Y(_3641_));
 ...
 sky130_fd_sc_hd__xnor2_2 _4498_ (.A(_3555_),
    .B(_3663_),
    .Y(_3664_));
 sky130_fd_sc_hd__or2b_1 _4499_ (.A(_2840_),
    .B_N(_2829_),
    .X(_3665_));
 ...
 sky130_fd_sc_hd__inv_2 _4501_ (.A(net42),
    .Y(_3667_));
 sky130_fd_sc_hd__clkbuf_4 _4502_ (.A(_3667_),
    .X(_3668_));
 ...
 sky130_fd_sc_hd__xor2_2 _4504_ (.A(_3657_),
    .B(_3669_),
    .X(_3670_));
 sky130_fd_sc_hd__or3_1 _4505_ (.A(_1459_),
    .B(net42),
    .C(_3656_),
    .X(_3671_));
 ...
 sky130_fd_sc_hd__nor2_1 _4535_ (.A(_3676_),
    .B(_3700_),
    .Y(_3701_));
 sky130_fd_sc_hd__or4bb_1 _4536_ (.A(net175),
    .B(net197),
    .C_N(net148),
    .D_N(net118),
    .X(_3702_));
 ...
 sky130_fd_sc_hd__and4bb_1 _4564_ (.A_N(net173),
    ...
    .D(net238),
    .X(_3730_));
 sky130_fd_sc_hd__a21oi_1 _4565_ (.A1(_2235_),
    .A2(_3729_),
    .B1(_3730_),
    .Y(_3731_));
 ...
 sky130_fd_sc_hd__a21bo_1 _4571_ (.A1(_3728_),
    ...
    .B1_N(_3736_),
    .X(_3737_));
 sky130_fd_sc_hd__xor2_1 _4572_ (.A(_1906_),
    .B(_2060_),
    .X(_3738_));
 ...
 sky130_fd_sc_hd__xnor2_2 _4574_ (.A(_3737_),
    .B(_3738_),
    .Y(_3740_));
 sky130_fd_sc_hd__xnor2_1 _4575_ (.A(_1994_),
    .B(_2038_),
    .Y(_3741_));
 ...
 sky130_fd_sc_hd__and4bb_1 _4579_ (.A_N(net158),
    ...
    .D(net300),
    .X(_3745_));
 sky130_fd_sc_hd__a21oi_1 _4580_ (.A1(_3743_),
    .A2(_3744_),
    .B1(_3745_),
    .Y(_3746_));
 sky130_fd_sc_hd__a21oi_1 _4581_ (.A1(_3742_),
    .A2(_3746_),
    .B1(_3745_),
    .Y(_3747_));
 sky130_fd_sc_hd__xor2_1 _4582_ (.A(_3741_),
    .B(_3747_),
    .X(_3748_));
 ...
 sky130_fd_sc_hd__nor2_1 _4587_ (.A(_3750_),
    .B(_3752_),
    .Y(_3753_));
 sky130_fd_sc_hd__xnor2_1 _4588_ (.A(_3749_),
    .B(_3753_),
    .Y(_3754_));
 ...
 sky130_fd_sc_hd__nand2_1 _4598_ (.A(net86),
    .B(net179),
    .Y(_3764_));
 sky130_fd_sc_hd__xnor2_1 _4599_ (.A(_3762_),
    .B(_3764_),
    .Y(_3765_));
 sky130_fd_sc_hd__xnor2_1 _4600_ (.A(_3694_),
    .B(_3714_),
    .Y(_3766_));
 ...
 sky130_fd_sc_hd__and4bb_1 _4606_ (.A_N(net176),
    ...
    .D(net180),
    .X(_3772_));
 sky130_fd_sc_hd__a21oi_1 _4607_ (.A1(_3770_),
    .A2(_3771_),
    .B1(_3772_),
    .Y(_3773_));
 ...
 sky130_fd_sc_hd__o21a_1 _4609_ (.A1(_3676_),
    ...
    .B1(_3702_),
    .X(_3775_));
 sky130_fd_sc_hd__xnor2_1 _4610_ (.A(_3699_),
    .B(_3775_),
    .Y(_3776_));
 sky130_fd_sc_hd__xor2_1 _4611_ (.A(_3774_),
    .B(_3776_),
    .X(_3777_));
 sky130_fd_sc_hd__nand2_1 _4612_ (.A(_3652_),
    .B(net257),
    .Y(_3778_));
 sky130_fd_sc_hd__xnor2_1 _4613_ (.A(_3778_),
    .B(_3731_),
    .Y(_3779_));
 ...
 sky130_fd_sc_hd__or2b_1 _4623_ (.A(_3768_),
    .B_N(_3787_),
    .X(_3789_));
 sky130_fd_sc_hd__a21bo_1 _4624_ (.A1(_3767_),
    .A2(_3788_),
    .B1_N(_3789_),
    .X(_3790_));
 sky130_fd_sc_hd__xnor2_1 _4625_ (.A(_3766_),
    .B(_3790_),
    .Y(_3791_));
 ...
 sky130_fd_sc_hd__xnor2_2 _4629_ (.A(_3793_),
    .B(_3794_),
    .Y(_3795_));
 sky130_fd_sc_hd__or2b_1 _4630_ (.A(_3794_),
    .B_N(_3793_),
    .X(_3796_));
 ...
 sky130_fd_sc_hd__or4bb_1 _4637_ (.A(net167),
    ...
    .D_N(net283),
    .X(_3803_));
 sky130_fd_sc_hd__o21ai_1 _4638_ (.A1(_3800_),
    .A2(_3802_),
    .B1(_3803_),
    .Y(_3804_));
 ...
 sky130_fd_sc_hd__a21o_1 _4649_ (.A1(_3804_),
    ...
    .B1(_3814_),
    .X(_3815_));
 sky130_fd_sc_hd__xor2_1 _4650_ (.A(_3748_),
    .B(_3754_),
    .X(_3816_));
 sky130_fd_sc_hd__xnor2_1 _4651_ (.A(_3815_),
    .B(_3816_),
    .Y(_3817_));
 ...
 sky130_fd_sc_hd__a21o_1 _4657_ (.A1(_3818_),
    ...
    .B1(_3821_),
    .X(_3823_));
 sky130_fd_sc_hd__xnor2_1 _4658_ (.A(_3742_),
    .B(_3746_),
    .Y(_3824_));
 sky130_fd_sc_hd__xnor2_1 _4659_ (.A(_3823_),
    .B(_3824_),
    .Y(_3825_));
 ...
 sky130_fd_sc_hd__nor2_1 _4664_ (.A(_3828_),
    .B(_3829_),
    .Y(_3830_));
 sky130_fd_sc_hd__xnor2_1 _4665_ (.A(_3826_),
    .B(_3830_),
    .Y(_3831_));
 ...
 sky130_fd_sc_hd__a31o_1 _4674_ (.A1(net92),
    ...
    .B1(_3839_),
    .X(_3840_));
 sky130_fd_sc_hd__xnor2_1 _4675_ (.A(_3765_),
    .B(_3791_),
    .Y(_3841_));
 ...
 sky130_fd_sc_hd__nand2_1 _4684_ (.A(_3667_),
    .B(net209),
    .Y(_3850_));
 sky130_fd_sc_hd__xnor2_1 _4685_ (.A(_3850_),
    .B(_3773_),
    .Y(_3851_));
 sky130_fd_sc_hd__xor2_1 _4686_ (.A(_3849_),
    .B(_3851_),
    .X(_3852_));
 ...
 sky130_fd_sc_hd__nand2_1 _4689_ (.A(_3849_),
    .B(_3851_),
    .Y(_3855_));
 sky130_fd_sc_hd__a21boi_1 _4690_ (.A1(_3852_),
    .A2(_3854_),
    .B1_N(_3855_),
    .Y(_3856_));
 sky130_fd_sc_hd__xnor2_1 _4691_ (.A(_3777_),
    .B(_3779_),
    .Y(_3857_));
 sky130_fd_sc_hd__xor2_1 _4692_ (.A(_3856_),
    .B(_3857_),
    .X(_3858_));
 sky130_fd_sc_hd__or2b_1 _4693_ (.A(_3814_),
    .B_N(_3813_),
    .X(_3859_));
 sky130_fd_sc_hd__xnor2_1 _4694_ (.A(_3804_),
    .B(_3859_),
    .Y(_3860_));
 ...
 sky130_fd_sc_hd__xnor2_2 _4702_ (.A(_3844_),
    .B(_3867_),
    .Y(_3868_));
 sky130_fd_sc_hd__or2b_1 _4703_ (.A(_3844_),
    .B_N(_3867_),
    .X(_3869_));
 sky130_fd_sc_hd__a21boi_1 _4704_ (.A1(_3843_),
    .A2(_3868_),
    .B1_N(_3869_),
    .Y(_3870_));
 sky130_fd_sc_hd__xor2_1 _4705_ (.A(_3841_),
    .B(_3870_),
    .X(_3871_));
 ...
 sky130_fd_sc_hd__a21oi_2 _4707_ (.A1(_3840_),
    ...
    .B1(_3872_),
    .Y(_3873_));
 sky130_fd_sc_hd__or2_1 _4708_ (.A(_3799_),
    .B(_3873_),
    .X(_3874_));
 sky130_fd_sc_hd__nand2_1 _4709_ (.A(_3799_),
    .B(_3873_),
    .Y(_3875_));
 sky130_fd_sc_hd__and2_1 _4710_ (.A(_3874_),
    .B(_3875_),
    .X(_3876_));
 sky130_fd_sc_hd__xnor2_1 _4711_ (.A(_3840_),
    .B(_3871_),
    .Y(_3877_));
 ...
 sky130_fd_sc_hd__a21bo_1 _4728_ (.A1(_3892_),
    ...
    .B1_N(_3890_),
    .X(_3894_));
 sky130_fd_sc_hd__a21boi_1 _4729_ (.A1(_3883_),
    .A2(_3891_),
    .B1_N(_3894_),
    .Y(_3895_));
 sky130_fd_sc_hd__xnor2_1 _4730_ (.A(_3825_),
    .B(_3831_),
    .Y(_3896_));
 sky130_fd_sc_hd__or2_1 _4731_ (.A(_3895_),
    .B(_3896_),
    .X(_3897_));
 sky130_fd_sc_hd__xnor2_1 _4732_ (.A(_3895_),
    .B(_3896_),
    .Y(_3898_));
 ...
 sky130_fd_sc_hd__and3_1 _4750_ (.A(_3897_),
    ...
    .C(_3914_),
    .X(_3916_));
 sky130_fd_sc_hd__nor2_1 _4751_ (.A(_3915_),
    .B(_3916_),
    .Y(_3917_));
 sky130_fd_sc_hd__a31o_1 _4752_ (.A1(net318),
    .A2(net179),
    .A3(_3917_),
    .B1(_3915_),
    .X(_3918_));
 ...
 sky130_fd_sc_hd__nor2_1 _4771_ (.A(_3931_),
    .B(_3932_),
    .Y(_3937_));
 sky130_fd_sc_hd__a21oi_1 _4772_ (.A1(_3933_),
    .A2(_3936_),
    .B1(_3937_),
    .Y(_3938_));
 sky130_fd_sc_hd__xnor2_1 _4773_ (.A(_3858_),
    .B(_3860_),
    .Y(_3939_));
 sky130_fd_sc_hd__xor2_1 _4774_ (.A(_3938_),
    .B(_3939_),
    .X(_3940_));
 ...
 sky130_fd_sc_hd__or2b_1 _4798_ (.A(net163),
    .B_N(net298),
    .X(_3964_));
 sky130_fd_sc_hd__a21boi_1 _4799_ (.A1(_3963_),
    .A2(_3964_),
    .B1_N(_3961_),
    .Y(_3965_));
 ...
 sky130_fd_sc_hd__a21oi_1 _4845_ (.A1(_4008_),
    ...
    .B1(_4010_),
    .Y(_4011_));
 sky130_fd_sc_hd__xnor2_1 _4846_ (.A(_3940_),
    .B(_3941_),
    .Y(_4012_));
 sky130_fd_sc_hd__xor2_1 _4847_ (.A(_4011_),
    .B(_4012_),
    .X(_4013_));
 sky130_fd_sc_hd__and3_1 _4848_ (.A(_3908_),
    ...
    .C(_3987_),
    .X(_4014_));
 sky130_fd_sc_hd__nor2_1 _4849_ (.A(_3988_),
    .B(_4014_),
    .Y(_4015_));
 ...
 sky130_fd_sc_hd__xor2_2 _4853_ (.A(_4017_),
    .B(_4018_),
    .X(_4019_));
 sky130_fd_sc_hd__nor2_1 _4854_ (.A(_4017_),
    .B(_4018_),
    .Y(_4020_));
 sky130_fd_sc_hd__a21oi_2 _4855_ (.A1(_3988_),
    ...
    .B1(_4020_),
    .Y(_4021_));
 sky130_fd_sc_hd__o22a_1 _4856_ (.A1(_3877_),
    .A2(_3952_),
    .B1(_3953_),
    .B2(_4021_),
    .X(_4022_));
 ...
 sky130_fd_sc_hd__a31o_1 _4865_ (.A1(_3997_),
    ...
    .B1(_4029_),
    .X(_4031_));
 sky130_fd_sc_hd__xnor2_1 _4866_ (.A(_3962_),
    .B(_3965_),
    .Y(_4032_));
 ...
 sky130_fd_sc_hd__and4bb_1 _4885_ (.A_N(net174),
    ...
    .D(net263),
    .X(_4051_));
 sky130_fd_sc_hd__a21oi_1 _4886_ (.A1(_4049_),
    .A2(_4050_),
    .B1(_4051_),
    .Y(_4052_));
 ...
 sky130_fd_sc_hd__nand2_1 _4926_ (.A(_4069_),
    .B(_4091_),
    .Y(_4092_));
 sky130_fd_sc_hd__a21oi_1 _4927_ (.A1(_4083_),
    .A2(_4090_),
    .B1(_4092_),
    .Y(_4093_));
 ...
 sky130_fd_sc_hd__and2b_1 _4929_ (.A_N(net174),
    .B(net272),
    .X(_4095_));
 sky130_fd_sc_hd__xnor2_1 _4930_ (.A(_4094_),
    .B(_4095_),
    .Y(_4096_));
 ...
 sky130_fd_sc_hd__nand2_1 _4934_ (.A(_3769_),
    .B(net272),
    .Y(_4100_));
 sky130_fd_sc_hd__xnor2_1 _4935_ (.A(_4100_),
    .B(_4052_),
    .Y(_4101_));
 sky130_fd_sc_hd__xor2_1 _4936_ (.A(_4099_),
    .B(_4101_),
    .X(_4102_));
 sky130_fd_sc_hd__nand2_1 _4937_ (.A(_3652_),
    .B(net298),
    .Y(_4103_));
 sky130_fd_sc_hd__xnor2_1 _4938_ (.A(_4103_),
    .B(_4081_),
    .Y(_4104_));
 ...
 sky130_fd_sc_hd__a21oi_1 _4958_ (.A1(_4048_),
    ...
    .B1(_4123_),
    .Y(_4124_));
 sky130_fd_sc_hd__xnor2_1 _4959_ (.A(_4013_),
    .B(_4015_),
    .Y(_4125_));
 ...
 sky130_fd_sc_hd__nand2_1 _4971_ (.A(_3769_),
    .B(net280),
    .Y(_4137_));
 sky130_fd_sc_hd__xnor2_1 _4972_ (.A(_4137_),
    .B(_4096_),
    .Y(_4138_));
 sky130_fd_sc_hd__xor2_1 _4973_ (.A(_4136_),
    .B(_4138_),
    .X(_4139_));
 ...
 sky130_fd_sc_hd__and4bb_1 _4977_ (.A_N(net171),
    ...
    .D(net298),
    .X(_4143_));
 sky130_fd_sc_hd__a21oi_1 _4978_ (.A1(_4141_),
    .A2(_4142_),
    .B1(_4143_),
    .Y(_4144_));
 sky130_fd_sc_hd__xnor2_1 _4979_ (.A(_4140_),
    .B(_4144_),
    .Y(_4145_));
 sky130_fd_sc_hd__nand2_1 _4980_ (.A(_4136_),
    .B(_4138_),
    .Y(_4146_));
 sky130_fd_sc_hd__a21boi_1 _4981_ (.A1(_4139_),
    .A2(_4145_),
    .B1_N(_4146_),
    .Y(_4147_));
 sky130_fd_sc_hd__xnor2_1 _4982_ (.A(_4102_),
    .B(_4104_),
    .Y(_4148_));
 sky130_fd_sc_hd__xor2_1 _4983_ (.A(_4147_),
    .B(_4148_),
    .X(_4149_));
 ...
 sky130_fd_sc_hd__nand2_1 _5021_ (.A(_4183_),
    .B(_4186_),
    .Y(_4187_));
 sky130_fd_sc_hd__xnor2_1 _5022_ (.A(_4152_),
    .B(_4154_),
    .Y(_4188_));
 sky130_fd_sc_hd__xnor2_1 _5023_ (.A(_4187_),
    .B(_4188_),
    .Y(_4189_));
 ...
 sky130_fd_sc_hd__and4bb_1 _5030_ (.A_N(net174),
    ...
    .D(net290),
    .X(_4196_));
 sky130_fd_sc_hd__a21oi_1 _5031_ (.A1(_4194_),
    .A2(_4195_),
    .B1(_4196_),
    .Y(_4197_));
 sky130_fd_sc_hd__a31o_2 _5032_ (.A1(_3769_),
    ...
    .B1(_4196_),
    .X(_4198_));
 sky130_fd_sc_hd__nand2_1 _5033_ (.A(_3769_),
    .B(net290),
    .Y(_4199_));
 ...
 sky130_fd_sc_hd__a32oi_4 _5037_ (.A1(_4186_),
    ...
    .B2(_4200_),
    .Y(_4203_));
 sky130_fd_sc_hd__xnor2_1 _5038_ (.A(_4139_),
    .B(_4145_),
    .Y(_4204_));
 sky130_fd_sc_hd__xor2_1 _5039_ (.A(_4203_),
    .B(_4204_),
    .X(_4205_));
 sky130_fd_sc_hd__xnor2_1 _5040_ (.A(_4189_),
    .B(_4190_),
    .Y(_0064_));
 ...
 sky130_fd_sc_hd__a21o_1 _5042_ (.A1(_4205_),
    ...
    .B1(_0065_),
    .X(_0066_));
 sky130_fd_sc_hd__xor2_1 _5043_ (.A(_4149_),
    .B(_4161_),
    .X(_0067_));
 sky130_fd_sc_hd__xor2_1 _5044_ (.A(_0066_),
    .B(_0067_),
    .X(_0068_));
 sky130_fd_sc_hd__nand2_1 _5045_ (.A(_3978_),
    .B(net316),
    .Y(_0069_));
 sky130_fd_sc_hd__xnor2_1 _5046_ (.A(_0069_),
    .B(_4192_),
    .Y(_0070_));
 ...
 sky130_fd_sc_hd__nor2_1 _5054_ (.A(_4184_),
    .B(_0077_),
    .Y(_0078_));
 sky130_fd_sc_hd__a21oi_1 _5055_ (.A1(_4182_),
    .A2(_0076_),
    .B1(_0078_),
    .Y(_0079_));
 ...
 sky130_fd_sc_hd__nand2_1 _5067_ (.A(_3769_),
    .B(net299),
    .Y(_0091_));
 sky130_fd_sc_hd__xnor2_1 _5068_ (.A(_0091_),
    .B(_4197_),
    .Y(_0092_));
 sky130_fd_sc_hd__xor2_1 _5069_ (.A(_0090_),
    .B(_0092_),
    .X(_0093_));
 sky130_fd_sc_hd__nand2_1 _5070_ (.A(_3997_),
    .B(net91),
    .Y(_0094_));
 sky130_fd_sc_hd__xnor2_1 _5071_ (.A(_0094_),
    .B(_0079_),
    .Y(_0095_));
 ...
 sky130_fd_sc_hd__and2_1 _5074_ (.A(_4186_),
    .B(_4202_),
    .X(_0098_));
 sky130_fd_sc_hd__xnor2_1 _5075_ (.A(_4201_),
    .B(_0098_),
    .Y(_0099_));
 sky130_fd_sc_hd__xnor2_1 _5076_ (.A(_0097_),
    .B(_0099_),
    .Y(_0100_));
 ...
 sky130_fd_sc_hd__a21bo_1 _5078_ (.A1(_0085_),
    ...
    .B1_N(_0101_),
    .X(_0102_));
 sky130_fd_sc_hd__xnor2_1 _5079_ (.A(_4205_),
    .B(_0064_),
    .Y(_0103_));
 sky130_fd_sc_hd__xnor2_1 _5080_ (.A(_0102_),
    .B(_0103_),
    .Y(_0104_));
 sky130_fd_sc_hd__xnor2_1 _5081_ (.A(_0083_),
    .B(_0104_),
    .Y(_0105_));
 ...
 sky130_fd_sc_hd__a21bo_1 _5102_ (.A1(_0122_),
    ...
    .B1_N(_0125_),
    .X(_0126_));
 sky130_fd_sc_hd__xnor2_1 _5103_ (.A(_0093_),
    .B(_0095_),
    .Y(_0127_));
 sky130_fd_sc_hd__xnor2_1 _5104_ (.A(_0126_),
    .B(_0127_),
    .Y(_0128_));
 ...
 sky130_fd_sc_hd__a21bo_1 _5106_ (.A1(_0113_),
    ...
    .B1_N(_0129_),
    .X(_0130_));
 sky130_fd_sc_hd__xnor2_1 _5107_ (.A(_0085_),
    .B(_0100_),
    .Y(_0131_));
 sky130_fd_sc_hd__xnor2_1 _5108_ (.A(_0130_),
    .B(_0131_),
    .Y(_0132_));
 sky130_fd_sc_hd__and2b_1 _5109_ (.A_N(_0131_),
    .B(_0130_),
    .X(_0133_));
 sky130_fd_sc_hd__a21oi_1 _5110_ (.A1(_0111_),
    .A2(_0132_),
    .B1(_0133_),
    .Y(_0134_));
 ...
 sky130_fd_sc_hd__a21bo_1 _5113_ (.A1(_0083_),
    ...
    .B1_N(_0136_),
    .X(_0137_));
 sky130_fd_sc_hd__xor2_1 _5114_ (.A(_0068_),
    .B(_0070_),
    .X(_0138_));
 sky130_fd_sc_hd__xor2_1 _5115_ (.A(_0137_),
    .B(_0138_),
    .X(_0139_));
 ...
 sky130_fd_sc_hd__a21boi_1 _5117_ (.A1(_0135_),
    ...
    .B1_N(_0140_),
    .Y(_0141_));
 sky130_fd_sc_hd__xor2_1 _5118_ (.A(_0105_),
    .B(_0134_),
    .X(_0142_));
 ...
 sky130_fd_sc_hd__xnor2_1 _5136_ (.A(_0111_),
    .B(_0132_),
    .Y(_0160_));
 sky130_fd_sc_hd__xnor2_1 _5137_ (.A(_0113_),
    .B(_0128_),
    .Y(_0161_));
 ...
 sky130_fd_sc_hd__a22oi_4 _5176_ (.A1(_4023_),
    ...
    .B2(_0199_),
    .Y(_0200_));
 sky130_fd_sc_hd__xnor2_1 _5177_ (.A(_3953_),
    .B(_4021_),
    .Y(_0201_));
 sky130_fd_sc_hd__or2_1 _5178_ (.A(_0200_),
    .B(_0201_),
    .X(_0202_));
 sky130_fd_sc_hd__and2_1 _5179_ (.A(_3877_),
    .B(_3952_),
    .X(_0203_));
 ...
 sky130_fd_sc_hd__nand2_1 _5181_ (.A(_3876_),
    .B(_0204_),
    .Y(_0205_));
 sky130_fd_sc_hd__nand2_1 _5182_ (.A(_3874_),
    .B(_0205_),
    .Y(_0206_));
 ...
 sky130_fd_sc_hd__and4bb_1 _5209_ (.A_N(net159),
    ...
    .D(net239),
    .X(_0233_));
 sky130_fd_sc_hd__a21oi_1 _5210_ (.A1(_0231_),
    .A2(_0232_),
    .B1(_0233_),
    .Y(_0234_));
 sky130_fd_sc_hd__a21oi_1 _5211_ (.A1(_0230_),
    .A2(_0234_),
    .B1(_0233_),
    .Y(_0235_));
 ...
 sky130_fd_sc_hd__nor2_1 _5217_ (.A(_0239_),
    .B(_0240_),
    .Y(_0241_));
 sky130_fd_sc_hd__xnor2_1 _5218_ (.A(_0237_),
    .B(_0241_),
    .Y(_0242_));
 ...
 sky130_fd_sc_hd__xnor2_1 _5220_ (.A(_0223_),
    .B(_0243_),
    .Y(_0244_));
 sky130_fd_sc_hd__xnor2_1 _5221_ (.A(_0230_),
    .B(_0234_),
    .Y(_0245_));
 sky130_fd_sc_hd__a21oi_1 _5222_ (.A1(_3478_),
    .A2(_3489_),
    .B1(_3467_),
    .Y(_0246_));
 ...
 sky130_fd_sc_hd__and4bb_1 _5249_ (.A_N(net159),
    ...
    .D(net182),
    .X(_0273_));
 sky130_fd_sc_hd__a21oi_1 _5250_ (.A1(_0271_),
    .A2(_0272_),
    .B1(_0273_),
    .Y(_0274_));
 ...
 sky130_fd_sc_hd__nor3_1 _5277_ (.A(_2202_),
    ...
    .C(_0280_),
    .Y(_0301_));
 sky130_fd_sc_hd__a21oi_1 _5278_ (.A1(_0300_),
    .A2(_0280_),
    .B1(_0301_),
    .Y(_0302_));
 ...
 sky130_fd_sc_hd__nor2_1 _5280_ (.A(_0303_),
    .B(net39),
    .Y(_0304_));
 sky130_fd_sc_hd__xnor2_1 _5281_ (.A(_0302_),
    .B(_0304_),
    .Y(_0305_));
 ...
 sky130_fd_sc_hd__and4bb_1 _5284_ (.A_N(net160),
    ...
    .D(net151),
    .X(_0308_));
 sky130_fd_sc_hd__a21oi_1 _5285_ (.A1(_0306_),
    .A2(_0307_),
    .B1(_0308_),
    .Y(_0309_));
 sky130_fd_sc_hd__nor2_1 _5286_ (.A(_2191_),
    .B(net192),
    .Y(_0310_));
 sky130_fd_sc_hd__xnor2_1 _5287_ (.A(_0309_),
    .B(_0310_),
    .Y(_0311_));
 sky130_fd_sc_hd__a21oi_1 _5288_ (.A1(_0270_),
    .A2(_0274_),
    .B1(_0273_),
    .Y(_0312_));
 sky130_fd_sc_hd__xnor2_1 _5289_ (.A(_0311_),
    .B(_0312_),
    .Y(_0313_));
 ...
 sky130_fd_sc_hd__xor2_1 _5292_ (.A(_0299_),
    .B(_0315_),
    .X(_0316_));
 sky130_fd_sc_hd__or3b_1 _5293_ (.A(_1503_),
    .B(net48),
    .C_N(_0264_),
    .X(_0317_));
 ...
 sky130_fd_sc_hd__and2b_1 _5359_ (.A_N(_0381_),
    .B(_0382_),
    .X(_0383_));
 sky130_fd_sc_hd__a31o_1 _5360_ (.A1(net293),
    .A2(net177),
    .A3(_0383_),
    .B1(_0381_),
    .X(_0384_));
 ...
 sky130_fd_sc_hd__nor2_1 _5367_ (.A(_0389_),
    .B(_0390_),
    .Y(_0391_));
 sky130_fd_sc_hd__nand2_1 _5368_ (.A(net293),
    .B(net177),
    .Y(_0392_));
 ...
 sky130_fd_sc_hd__nand2_1 _5375_ (.A(_0378_),
    .B(_0397_),
    .Y(_0399_));
 sky130_fd_sc_hd__nand2_1 _5376_ (.A(_0398_),
    .B(_0399_),
    .Y(_0400_));
 ...
 sky130_fd_sc_hd__and2_1 _5387_ (.A(_0401_),
    .B(_0409_),
    .X(_0411_));
 sky130_fd_sc_hd__nor2_1 _5388_ (.A(_0410_),
    .B(_0411_),
    .Y(_0412_));
 ...
 sky130_fd_sc_hd__and2_2 _5394_ (.A(_0416_),
    .B(_0417_),
    .X(_0418_));
 sky130_fd_sc_hd__xnor2_1 _5395_ (.A(_3799_),
    .B(_3873_),
    .Y(_0419_));
 sky130_fd_sc_hd__xnor2_1 _5396_ (.A(_3877_),
    .B(_3952_),
    .Y(_0420_));
 sky130_fd_sc_hd__or4_1 _5397_ (.A(_0419_),
    .B(_3798_),
    .C(_0201_),
    .D(_0420_),
    .X(_0421_));
 ...
 sky130_fd_sc_hd__or2_1 _5402_ (.A(_0401_),
    .B(_0409_),
    .X(_0426_));
 sky130_fd_sc_hd__a21oi_1 _5403_ (.A1(_0426_),
    .A2(_0416_),
    .B1(_0411_),
    .Y(_0427_));
 ...
 sky130_fd_sc_hd__o21a_1 _5405_ (.A1(_0400_),
    ...
    .B1(_0398_),
    .X(_0429_));
 sky130_fd_sc_hd__xnor2_1 _5406_ (.A(_0377_),
    .B(_0429_),
    .Y(_0430_));
 sky130_fd_sc_hd__and2_1 _5407_ (.A(\counter[7] ),
    .B(_0430_),
    .X(_0431_));
 sky130_fd_sc_hd__xnor2_1 _5408_ (.A(_0400_),
    .B(_0428_),
    .Y(_0432_));
 ...
 sky130_fd_sc_hd__a21bo_1 _5410_ (.A1(_0418_),
    ...
    .B1_N(_0416_),
    .X(_0434_));
 sky130_fd_sc_hd__xnor2_1 _5411_ (.A(_0412_),
    .B(_0434_),
    .Y(_0435_));
 ...
 sky130_fd_sc_hd__and2_1 _5420_ (.A(\counter[0] ),
    .B(_0443_),
    .X(_0444_));
 sky130_fd_sc_hd__o21a_1 _5421_ (.A1(_3953_),
    .A2(_4021_),
    .B1(_0202_),
    .X(_0445_));
 sky130_fd_sc_hd__xnor2_1 _5422_ (.A(_0420_),
    .B(_0445_),
    .Y(_0446_));
 ...
 sky130_fd_sc_hd__nand2_1 _5433_ (.A(_0455_),
    .B(_0456_),
    .Y(_0457_));
 sky130_fd_sc_hd__buf_4 _5434_ (.A(_3641_),
    .X(_0458_));
 ...
 sky130_fd_sc_hd__or2_1 _5481_ (.A(_0311_),
    .B(_0312_),
    .X(_0505_));
 sky130_fd_sc_hd__o21ai_1 _5482_ (.A1(_0305_),
    .A2(_0313_),
    .B1(_0505_),
    .Y(_0506_));
 ...
 sky130_fd_sc_hd__nand3_1 _5521_ (.A(_0523_),
    ...
    .C(_0543_),
    .Y(_0545_));
 sky130_fd_sc_hd__o211ai_1 _5522_ (.A1(_0517_),
    .A2(_0521_),
    .B1(_0544_),
    .C1(_0545_),
    .Y(_0546_));
 ...
 sky130_fd_sc_hd__and2_1 _5539_ (.A(_0561_),
    .B(_0562_),
    .X(_0563_));
 sky130_fd_sc_hd__a21bo_1 _5540_ (.A1(_0558_),
    .A2(_0563_),
    .B1_N(_0561_),
    .X(_0564_));
 ...
 sky130_fd_sc_hd__nor2_1 _5557_ (.A(_0377_),
    .B(_0400_),
    .Y(_0581_));
 sky130_fd_sc_hd__nand4_1 _5558_ (.A(_0581_),
    .B(_0412_),
    .C(_0418_),
    .D(_0425_),
    .Y(_0582_));
 ...
 sky130_fd_sc_hd__a211oi_1 _5560_ (.A1(_0581_),
    ...
    .C1(_0583_),
    .Y(_0584_));
 sky130_fd_sc_hd__and2_1 _5561_ (.A(_0582_),
    .B(_0584_),
    .X(_0585_));
 sky130_fd_sc_hd__or2_1 _5562_ (.A(_0580_),
    .B(_0585_),
    .X(_0586_));
 ...
 sky130_fd_sc_hd__and2_1 _5577_ (.A(net78),
    .B(_0600_),
    .X(_0601_));
 sky130_fd_sc_hd__xnor2_1 _5578_ (.A(_0569_),
    .B(_0594_),
    .Y(_0602_));
 sky130_fd_sc_hd__nand2_1 _5579_ (.A(_0577_),
    .B(_0586_),
    .Y(_0603_));
 sky130_fd_sc_hd__xor2_1 _5580_ (.A(_0592_),
    .B(_0603_),
    .X(_0604_));
 ...
 sky130_fd_sc_hd__o22a_1 _5582_ (.A1(net77),
    ...
    .B2(net78),
    .X(_0606_));
 sky130_fd_sc_hd__or3b_1 _5583_ (.A(_0601_),
    .B(_0605_),
    .C_N(_0606_),
    .X(_0607_));
 ...
 sky130_fd_sc_hd__or2_1 _5614_ (.A(_0580_),
    .B(_0592_),
    .X(_0638_));
 sky130_fd_sc_hd__a211o_1 _5615_ (.A1(_0582_),
    .A2(_0584_),
    .B1(_0637_),
    .C1(_0638_),
    .X(_0639_));
 ...
 sky130_fd_sc_hd__a31o_1 _5632_ (.A1(_0632_),
    ...
    .B1(_0645_),
    .X(_0656_));
 sky130_fd_sc_hd__xnor2_1 _5633_ (.A(_0651_),
    .B(_0656_),
    .Y(_0657_));
 ...
 sky130_fd_sc_hd__o21a_1 _5644_ (.A1(_0661_),
    ...
    .B1(net76),
    .X(_0668_));
 sky130_fd_sc_hd__a221oi_1 _5645_ (.A1(net74),
    .A2(_0657_),
    .B1(_0666_),
    .B2(net75),
    .C1(_0668_),
    .Y(_0669_));
 sky130_fd_sc_hd__nand4b_1 _5646_ (.A_N(_0655_),
    .B(_0658_),
    .C(_0667_),
    .D(_0669_),
    .Y(_0670_));
 sky130_fd_sc_hd__o22a_1 _5647_ (.A1(\counter[11] ),
    ...
    .B2(\counter[10] ),
    .X(_0671_));
 sky130_fd_sc_hd__or4b_1 _5648_ (.A(_0598_),
    .B(_0607_),
    .C(_0670_),
    .D_N(_0671_),
    .X(_0672_));
 ...
 sky130_fd_sc_hd__or2_1 _5732_ (.A(_0754_),
    .B(_0757_),
    .X(_0759_));
 sky130_fd_sc_hd__nand2_1 _5733_ (.A(_0758_),
    .B(_0759_),
    .Y(_0760_));
 ...
 sky130_fd_sc_hd__xor2_1 _5750_ (.A(_0771_),
    .B(_0777_),
    .X(_0779_));
 sky130_fd_sc_hd__nand2_1 _5751_ (.A(net241),
    .B(_0685_),
    .Y(_0780_));
 ...
 sky130_fd_sc_hd__nor2_1 _5799_ (.A(_0830_),
    .B(_0831_),
    .Y(_0832_));
 sky130_fd_sc_hd__nand2_1 _5800_ (.A(net241),
    .B(net136),
    .Y(_0834_));
 ...
 sky130_fd_sc_hd__nor3_1 _5805_ (.A(_0801_),
    ...
    .C(_0838_),
    .Y(_0839_));
 sky130_fd_sc_hd__and3_1 _5806_ (.A(net241),
    .B(net136),
    .C(_0832_),
    .X(_0840_));
 ...
 sky130_fd_sc_hd__and4bb_1 _5816_ (.A_N(net106),
    ...
    .D(net213),
    .X(_0851_));
 sky130_fd_sc_hd__a21oi_1 _5817_ (.A1(_0849_),
    .A2(_0850_),
    .B1(_0851_),
    .Y(_0852_));
 ...
 sky130_fd_sc_hd__inv_2 _5868_ (.A(net50),
    .Y(_0908_));
 sky130_fd_sc_hd__buf_2 _5869_ (.A(_0908_),
    .X(_0909_));
 ...
 sky130_fd_sc_hd__and4bb_1 _5872_ (.A_N(net128),
    ...
    .D(net281),
    .X(_0913_));
 sky130_fd_sc_hd__a21oi_1 _5873_ (.A1(_0911_),
    .A2(_0912_),
    .B1(_0913_),
    .Y(_0914_));
 sky130_fd_sc_hd__a31o_2 _5874_ (.A1(net264),
    ...
    .B1(_0913_),
    .X(_0915_));
 sky130_fd_sc_hd__buf_2 _5875_ (.A(_0908_),
    .X(_0916_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _5884_ (.A(_0925_),
    .X(_0926_));
 sky130_fd_sc_hd__buf_4 _5885_ (.A(_2455_),
    .X(_0927_));
 ...
 sky130_fd_sc_hd__xor2_1 _5922_ (.A(_0959_),
    .B(_0967_),
    .X(_0968_));
 sky130_fd_sc_hd__xnor2_1 _5923_ (.A(_0958_),
    .B(_0968_),
    .Y(_0969_));
 ...
 sky130_fd_sc_hd__nand2_1 _5971_ (.A(_1019_),
    .B(_1021_),
    .Y(_1022_));
 sky130_fd_sc_hd__a21oi_1 _5972_ (.A1(_1006_),
    .A2(_1007_),
    .B1(_1022_),
    .Y(_1023_));
 ...
 sky130_fd_sc_hd__nand2_1 _6036_ (.A(_1033_),
    .B(_1039_),
    .Y(_1093_));
 sky130_fd_sc_hd__a21boi_1 _6037_ (.A1(_1040_),
    .A2(_1048_),
    .B1_N(_1093_),
    .Y(_1094_));
 ...
 sky130_fd_sc_hd__and2b_1 _6041_ (.A_N(net132),
    .B(net180),
    .X(_1099_));
 sky130_fd_sc_hd__or4bb_1 _6042_ (.A(net129),
    .B(net132),
    .C_N(net180),
    .D_N(net211),
    .X(_1100_));
 sky130_fd_sc_hd__o21ai_1 _6043_ (.A1(_1098_),
    .A2(_1099_),
    .B1(_1100_),
    .Y(_1101_));
 sky130_fd_sc_hd__xnor2_1 _6044_ (.A(_1096_),
    .B(_1101_),
    .Y(_1102_));
 sky130_fd_sc_hd__xor2_1 _6045_ (.A(_1095_),
    .B(_1102_),
    .X(_1103_));
 ...
 sky130_fd_sc_hd__nand2_1 _6049_ (.A(_1105_),
    .B(_1106_),
    .Y(_1107_));
 sky130_fd_sc_hd__xnor2_1 _6050_ (.A(_1104_),
    .B(_1107_),
    .Y(_1109_));
 sky130_fd_sc_hd__xnor2_1 _6051_ (.A(_1103_),
    .B(_1109_),
    .Y(_1110_));
 sky130_fd_sc_hd__xor2_1 _6052_ (.A(_1094_),
    .B(_1110_),
    .X(_1111_));
 sky130_fd_sc_hd__nor2_1 _6053_ (.A(_1056_),
    .B(_1057_),
    .Y(_1112_));
 sky130_fd_sc_hd__o21ai_1 _6054_ (.A1(_1055_),
    .A2(_1112_),
    .B1(_1058_),
    .Y(_1113_));
 ...
 sky130_fd_sc_hd__nor2_1 _6066_ (.A(_1124_),
    .B(_1125_),
    .Y(_1126_));
 sky130_fd_sc_hd__xnor2_1 _6067_ (.A(_1111_),
    .B(_1126_),
    .Y(_1127_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6097_ (.A_N(net127),
    ...
    .D(net291),
    .X(_1160_));
 sky130_fd_sc_hd__a21oi_1 _6098_ (.A1(_1158_),
    .A2(_1159_),
    .B1(_1160_),
    .Y(_1161_));
 ...
 sky130_fd_sc_hd__nand2_1 _6100_ (.A(net264),
    .B(_0916_),
    .Y(_1164_));
 sky130_fd_sc_hd__xnor2_1 _6101_ (.A(_1164_),
    .B(_0914_),
    .Y(_1165_));
 sky130_fd_sc_hd__xor2_1 _6102_ (.A(_1162_),
    .B(_1165_),
    .X(_1166_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6105_ (.A_N(net124),
    ...
    .D(net304),
    .X(_1169_));
 sky130_fd_sc_hd__a21oi_1 _6106_ (.A1(_0930_),
    .A2(_1168_),
    .B1(_1169_),
    .Y(_1170_));
 sky130_fd_sc_hd__xnor2_1 _6107_ (.A(_1167_),
    .B(_1170_),
    .Y(_1171_));
 ...
 sky130_fd_sc_hd__and2_1 _6110_ (.A(_0933_),
    .B(_0934_),
    .X(_1175_));
 sky130_fd_sc_hd__xnor2_1 _6111_ (.A(_0924_),
    .B(_1175_),
    .Y(_1176_));
 sky130_fd_sc_hd__xor2_1 _6112_ (.A(_1173_),
    .B(_1176_),
    .X(_1177_));
 ...
 sky130_fd_sc_hd__xor2_1 _6122_ (.A(_1186_),
    .B(_1187_),
    .X(_1188_));
 sky130_fd_sc_hd__a21oi_1 _6123_ (.A1(_1179_),
    .A2(_1184_),
    .B1(_1188_),
    .Y(_1189_));
 ...
 sky130_fd_sc_hd__nor2_1 _6126_ (.A(_1173_),
    .B(_1176_),
    .Y(_1192_));
 sky130_fd_sc_hd__a21oi_1 _6127_ (.A1(_1177_),
    .A2(_1191_),
    .B1(_1192_),
    .Y(_1193_));
 ...
 sky130_fd_sc_hd__nor2_1 _6149_ (.A(_1094_),
    .B(_1110_),
    .Y(_1217_));
 sky130_fd_sc_hd__a21oi_1 _6150_ (.A1(_1111_),
    .A2(_1126_),
    .B1(_1217_),
    .Y(_1219_));
 sky130_fd_sc_hd__nand2_1 _6151_ (.A(_1095_),
    .B(_1102_),
    .Y(_1220_));
 sky130_fd_sc_hd__a21boi_1 _6152_ (.A1(_1103_),
    .A2(_1109_),
    .B1_N(_1220_),
    .Y(_1221_));
 sky130_fd_sc_hd__o31ai_1 _6153_ (.A1(_0458_),
    .A2(net50),
    .A3(_1101_),
    .B1(_1100_),
    .Y(_1222_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6157_ (.A_N(net129),
    ...
    .D(net181),
    .X(_1226_));
 sky130_fd_sc_hd__a21oi_1 _6158_ (.A1(_1224_),
    .A2(_1225_),
    .B1(_1226_),
    .Y(_1227_));
 sky130_fd_sc_hd__xnor2_1 _6159_ (.A(_1223_),
    .B(_1227_),
    .Y(_1228_));
 sky130_fd_sc_hd__xor2_1 _6160_ (.A(_1222_),
    .B(_1228_),
    .X(_1230_));
 ...
 sky130_fd_sc_hd__nand2_1 _6165_ (.A(_1233_),
    .B(_1234_),
    .Y(_1235_));
 sky130_fd_sc_hd__xnor2_1 _6166_ (.A(_1231_),
    .B(_1235_),
    .Y(_1236_));
 sky130_fd_sc_hd__xnor2_1 _6167_ (.A(_1230_),
    .B(_1236_),
    .Y(_1237_));
 sky130_fd_sc_hd__xor2_1 _6168_ (.A(_1221_),
    .B(_1237_),
    .X(_1238_));
 sky130_fd_sc_hd__nor2_1 _6169_ (.A(_1115_),
    .B(_1116_),
    .Y(_1239_));
 sky130_fd_sc_hd__o21ai_1 _6170_ (.A1(_1114_),
    .A2(_1239_),
    .B1(_1117_),
    .Y(_1241_));
 ...
 sky130_fd_sc_hd__or2b_1 _6180_ (.A(_1249_),
    .B_N(_1250_),
    .X(_1251_));
 sky130_fd_sc_hd__xnor2_1 _6181_ (.A(_1241_),
    .B(_1251_),
    .Y(_1252_));
 sky130_fd_sc_hd__xnor2_1 _6182_ (.A(_1238_),
    .B(_1252_),
    .Y(_1253_));
 sky130_fd_sc_hd__xor2_1 _6183_ (.A(_1219_),
    .B(_1253_),
    .X(_1254_));
 sky130_fd_sc_hd__or2b_1 _6184_ (.A(_1139_),
    .B_N(_1134_),
    .X(_1255_));
 sky130_fd_sc_hd__a21boi_1 _6185_ (.A1(_1113_),
    .A2(_1123_),
    .B1_N(_1121_),
    .Y(_1256_));
 ...
 sky130_fd_sc_hd__nand2_1 _6246_ (.A(net271),
    .B(_0916_),
    .Y(_1323_));
 sky130_fd_sc_hd__xnor2_1 _6247_ (.A(_1323_),
    .B(_1161_),
    .Y(_1324_));
 sky130_fd_sc_hd__xor2_1 _6248_ (.A(_1322_),
    .B(_1324_),
    .X(_1325_));
 ...
 sky130_fd_sc_hd__nand2_1 _6258_ (.A(_1322_),
    .B(_1324_),
    .Y(_1336_));
 sky130_fd_sc_hd__a21boi_1 _6259_ (.A1(_1325_),
    .A2(_1331_),
    .B1_N(_1336_),
    .Y(_1337_));
 sky130_fd_sc_hd__xnor2_1 _6260_ (.A(_1166_),
    .B(_1171_),
    .Y(_1339_));
 sky130_fd_sc_hd__xor2_1 _6261_ (.A(_1337_),
    .B(_1339_),
    .X(_1340_));
 sky130_fd_sc_hd__a31o_1 _6262_ (.A1(net87),
    ...
    .B1(_1329_),
    .X(_1341_));
 sky130_fd_sc_hd__xnor2_1 _6263_ (.A(_1180_),
    .B(_1183_),
    .Y(_1342_));
 sky130_fd_sc_hd__xnor2_1 _6264_ (.A(_1341_),
    .B(_1342_),
    .Y(_1343_));
 sky130_fd_sc_hd__xor2_1 _6265_ (.A(net83),
    .B(_1343_),
    .X(_1344_));
 sky130_fd_sc_hd__xnor2_1 _6266_ (.A(_1340_),
    .B(_1344_),
    .Y(_1345_));
 sky130_fd_sc_hd__xnor2_1 _6267_ (.A(_1335_),
    .B(_1345_),
    .Y(_1346_));
 ...
 sky130_fd_sc_hd__a21o_1 _6271_ (.A1(_1340_),
    ...
    .B1(_1350_),
    .X(_1351_));
 sky130_fd_sc_hd__xor2_1 _6272_ (.A(_1177_),
    .B(_1191_),
    .X(_1352_));
 ...
 sky130_fd_sc_hd__nand2_1 _6275_ (.A(net83),
    .B(_1343_),
    .Y(_1355_));
 sky130_fd_sc_hd__a21oi_1 _6276_ (.A1(_1354_),
    .A2(_1355_),
    .B1(_1010_),
    .Y(_1356_));
 ...
 sky130_fd_sc_hd__or2b_1 _6282_ (.A(_1361_),
    .B_N(_1362_),
    .X(_1363_));
 sky130_fd_sc_hd__xnor2_1 _6283_ (.A(_1301_),
    .B(_1346_),
    .Y(_1364_));
 ...
 sky130_fd_sc_hd__and2b_1 _6311_ (.A_N(_1392_),
    .B(_1391_),
    .X(_1395_));
 sky130_fd_sc_hd__a21oi_1 _6312_ (.A1(_1370_),
    .A2(_1394_),
    .B1(_1395_),
    .Y(_1396_));
 ...
 sky130_fd_sc_hd__and2b_1 _6321_ (.A_N(net127),
    .B(net91),
    .X(_1406_));
 sky130_fd_sc_hd__or4bb_1 _6322_ (.A(net127),
    .B(net130),
    .C_N(net87),
    .D_N(net93),
    .X(_1407_));
 sky130_fd_sc_hd__o21ai_1 _6323_ (.A1(_1405_),
    .A2(_1406_),
    .B1(_1407_),
    .Y(_1408_));
 ...
 sky130_fd_sc_hd__nand2_1 _6359_ (.A(_1351_),
    .B(_1352_),
    .Y(_1447_));
 sky130_fd_sc_hd__a21boi_1 _6360_ (.A1(_1353_),
    .A2(_1358_),
    .B1_N(_1447_),
    .Y(_1449_));
 ...
 sky130_fd_sc_hd__nor2_1 _6377_ (.A(_1216_),
    .B(_1277_),
    .Y(_1467_));
 sky130_fd_sc_hd__a21oi_1 _6378_ (.A1(_1278_),
    .A2(_1284_),
    .B1(_1467_),
    .Y(_1468_));
 sky130_fd_sc_hd__nor2_1 _6379_ (.A(_1219_),
    .B(_1253_),
    .Y(_1469_));
 sky130_fd_sc_hd__a21oi_1 _6380_ (.A1(_1254_),
    .A2(_1276_),
    .B1(_1469_),
    .Y(_1471_));
 sky130_fd_sc_hd__nor2_1 _6381_ (.A(_1221_),
    .B(_1237_),
    .Y(_1472_));
 sky130_fd_sc_hd__a21oi_1 _6382_ (.A1(_1238_),
    .A2(_1252_),
    .B1(_1472_),
    .Y(_1473_));
 sky130_fd_sc_hd__and2_1 _6383_ (.A(_1222_),
    .B(_1228_),
    .X(_1474_));
 sky130_fd_sc_hd__a21oi_1 _6384_ (.A1(_1230_),
    .A2(_1236_),
    .B1(_1474_),
    .Y(_1475_));
 ...
 sky130_fd_sc_hd__or2b_1 _6387_ (.A(net129),
    .B_N(net149),
    .X(_1478_));
 sky130_fd_sc_hd__nand2b_1 _6388_ (.A_N(net133),
    .B(net118),
    .Y(_1479_));
 sky130_fd_sc_hd__xor2_1 _6389_ (.A(_1478_),
    .B(_1479_),
    .X(_1480_));
 sky130_fd_sc_hd__xor2_1 _6390_ (.A(_1477_),
    .B(_1480_),
    .X(_1482_));
 sky130_fd_sc_hd__xor2_1 _6391_ (.A(_1476_),
    .B(_1482_),
    .X(_1483_));
 ...
 sky130_fd_sc_hd__or2b_1 _6396_ (.A(_1486_),
    .B_N(_1487_),
    .X(_1488_));
 sky130_fd_sc_hd__xnor2_1 _6397_ (.A(_1484_),
    .B(_1488_),
    .Y(_1489_));
 sky130_fd_sc_hd__xnor2_1 _6398_ (.A(_1483_),
    .B(_1489_),
    .Y(_1490_));
 sky130_fd_sc_hd__xor2_1 _6399_ (.A(_1475_),
    .B(_1490_),
    .X(_1491_));
 ...
 sky130_fd_sc_hd__nand2_1 _6410_ (.A(_1501_),
    .B(_1502_),
    .Y(_1504_));
 sky130_fd_sc_hd__xnor2_1 _6411_ (.A(_1494_),
    .B(_1504_),
    .Y(_1505_));
 sky130_fd_sc_hd__xnor2_1 _6412_ (.A(_1491_),
    .B(_1505_),
    .Y(_1506_));
 sky130_fd_sc_hd__xor2_1 _6413_ (.A(_1473_),
    .B(_1506_),
    .X(_1507_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6420_ (.A_N(net103),
    ...
    .D(net296),
    .X(_1515_));
 sky130_fd_sc_hd__a21oi_1 _6421_ (.A1(_1512_),
    .A2(_1513_),
    .B1(_1515_),
    .Y(_1516_));
 sky130_fd_sc_hd__xnor2_1 _6422_ (.A(_1511_),
    .B(_1516_),
    .Y(_1517_));
 sky130_fd_sc_hd__a21oi_1 _6423_ (.A1(_1258_),
    .A2(_1263_),
    .B1(_1262_),
    .Y(_1518_));
 sky130_fd_sc_hd__xor2_1 _6424_ (.A(_1517_),
    .B(_1518_),
    .X(_1519_));
 ...
 sky130_fd_sc_hd__nor2_1 _6429_ (.A(_1521_),
    .B(_1523_),
    .Y(_1524_));
 sky130_fd_sc_hd__xnor2_1 _6430_ (.A(_1520_),
    .B(_1524_),
    .Y(_1526_));
 sky130_fd_sc_hd__xor2_1 _6431_ (.A(_1519_),
    .B(_1526_),
    .X(_1527_));
 sky130_fd_sc_hd__xnor2_1 _6432_ (.A(_1510_),
    .B(_1527_),
    .Y(_1528_));
 sky130_fd_sc_hd__xnor2_1 _6433_ (.A(_1509_),
    .B(_1528_),
    .Y(_1529_));
 sky130_fd_sc_hd__xnor2_1 _6434_ (.A(_1507_),
    .B(_1529_),
    .Y(_1530_));
 sky130_fd_sc_hd__xor2_1 _6435_ (.A(_1471_),
    .B(_1530_),
    .X(_1531_));
 ...
 sky130_fd_sc_hd__nor2_1 _6441_ (.A(_1535_),
    .B(_1537_),
    .Y(_1538_));
 sky130_fd_sc_hd__xnor2_1 _6442_ (.A(_1532_),
    .B(_1538_),
    .Y(_1539_));
 sky130_fd_sc_hd__xnor2_1 _6443_ (.A(_1531_),
    .B(_1539_),
    .Y(_1540_));
 sky130_fd_sc_hd__xor2_1 _6444_ (.A(_1468_),
    .B(_1540_),
    .X(_1541_));
 ...
 sky130_fd_sc_hd__nor2_1 _6463_ (.A(_4035_),
    .B(net55),
    .Y(_1562_));
 sky130_fd_sc_hd__xnor2_1 _6464_ (.A(_1561_),
    .B(_1562_),
    .Y(_1563_));
 sky130_fd_sc_hd__nor2_1 _6465_ (.A(_1108_),
    .B(net142),
    .Y(_1564_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6468_ (.A_N(net104),
    ...
    .D(net284),
    .X(_1567_));
 sky130_fd_sc_hd__a21oi_1 _6469_ (.A1(_1565_),
    .A2(_1566_),
    .B1(_1567_),
    .Y(_1568_));
 sky130_fd_sc_hd__xnor2_1 _6470_ (.A(_1564_),
    .B(_1568_),
    .Y(_1570_));
 sky130_fd_sc_hd__a21oi_1 _6471_ (.A1(_1511_),
    .A2(_1516_),
    .B1(_1515_),
    .Y(_1571_));
 sky130_fd_sc_hd__xor2_1 _6472_ (.A(_1570_),
    .B(_1571_),
    .X(_1572_));
 sky130_fd_sc_hd__xor2_1 _6473_ (.A(_1563_),
    .B(_1572_),
    .X(_1573_));
 sky130_fd_sc_hd__xnor2_1 _6474_ (.A(_1557_),
    .B(_1573_),
    .Y(_1574_));
 ...
 sky130_fd_sc_hd__xnor2_2 _6504_ (.A(_1588_),
    .B(_1606_),
    .Y(_1607_));
 sky130_fd_sc_hd__nor2_1 _6505_ (.A(_1475_),
    .B(_1490_),
    .Y(_1608_));
 ...
 sky130_fd_sc_hd__nand2_1 _6528_ (.A(net90),
    .B(net134),
    .Y(_1633_));
 sky130_fd_sc_hd__xnor2_1 _6529_ (.A(_1631_),
    .B(_1633_),
    .Y(_1634_));
 ...
 sky130_fd_sc_hd__a21o_1 _6531_ (.A1(_1563_),
    ...
    .B1(_1636_),
    .X(_1637_));
 sky130_fd_sc_hd__a21boi_1 _6532_ (.A1(_1577_),
    .A2(_1586_),
    .B1_N(_1585_),
    .Y(_1638_));
 ...
 sky130_fd_sc_hd__nor2_1 _6537_ (.A(_2422_),
    .B(net55),
    .Y(_1643_));
 sky130_fd_sc_hd__xnor2_1 _6538_ (.A(_1642_),
    .B(_1643_),
    .Y(_1644_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6542_ (.A_N(net104),
    ...
    .D(net274),
    .X(_1649_));
 sky130_fd_sc_hd__a21oi_1 _6543_ (.A1(_1647_),
    .A2(_1648_),
    .B1(_1649_),
    .Y(_1650_));
 sky130_fd_sc_hd__xnor2_1 _6544_ (.A(_1645_),
    .B(_1650_),
    .Y(_1651_));
 sky130_fd_sc_hd__a21oi_1 _6545_ (.A1(_1564_),
    .A2(_1568_),
    .B1(_1567_),
    .Y(_1652_));
 sky130_fd_sc_hd__xor2_1 _6546_ (.A(_1651_),
    .B(_1652_),
    .X(_1653_));
 sky130_fd_sc_hd__xnor2_1 _6547_ (.A(_1644_),
    .B(_1653_),
    .Y(_1654_));
 sky130_fd_sc_hd__xor2_1 _6548_ (.A(_1638_),
    .B(_1654_),
    .X(_1655_));
 sky130_fd_sc_hd__xor2_1 _6549_ (.A(_1637_),
    .B(_1655_),
    .X(_1656_));
 ...
 sky130_fd_sc_hd__or2b_1 _6559_ (.A(_1665_),
    .B_N(_1666_),
    .X(_1667_));
 sky130_fd_sc_hd__xnor2_1 _6560_ (.A(_1658_),
    .B(_1667_),
    .Y(_1668_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6564_ (.A_N(net125),
    ...
    .D(net150),
    .X(_1672_));
 sky130_fd_sc_hd__a21oi_1 _6565_ (.A1(_1670_),
    .A2(_1671_),
    .B1(_1672_),
    .Y(_1673_));
 sky130_fd_sc_hd__xnor2_1 _6566_ (.A(_1669_),
    .B(_1673_),
    .Y(_1674_));
 sky130_fd_sc_hd__and3_1 _6567_ (.A(net98),
    ...
    .C(_1479_),
    .X(_1675_));
 sky130_fd_sc_hd__xor2_1 _6568_ (.A(_1674_),
    .B(_1675_),
    .X(_1676_));
 sky130_fd_sc_hd__and3_1 _6569_ (.A(_1596_),
    ...
    .C(_1600_),
    .X(_1677_));
 sky130_fd_sc_hd__a21oi_1 _6570_ (.A1(_1595_),
    .A2(_1601_),
    .B1(_1677_),
    .Y(_1678_));
 sky130_fd_sc_hd__xor2_1 _6571_ (.A(_1676_),
    .B(_1678_),
    .X(_1679_));
 sky130_fd_sc_hd__xnor2_1 _6572_ (.A(_1668_),
    .B(_1679_),
    .Y(_1680_));
 sky130_fd_sc_hd__or2b_1 _6573_ (.A(_1603_),
    .B_N(_1605_),
    .X(_1681_));
 sky130_fd_sc_hd__a21boi_1 _6574_ (.A1(_1588_),
    .A2(_1606_),
    .B1_N(_1681_),
    .Y(_1682_));
 sky130_fd_sc_hd__xor2_1 _6575_ (.A(_1680_),
    .B(_1682_),
    .X(_1683_));
 ...
 sky130_fd_sc_hd__nor2_1 _6582_ (.A(_1680_),
    .B(_1682_),
    .Y(_1690_));
 sky130_fd_sc_hd__a21oi_1 _6583_ (.A1(_1656_),
    .A2(_1683_),
    .B1(_1690_),
    .Y(_1691_));
 sky130_fd_sc_hd__nor2_1 _6584_ (.A(_1676_),
    .B(_1678_),
    .Y(_1692_));
 sky130_fd_sc_hd__a21oi_1 _6585_ (.A1(_1668_),
    .A2(_1679_),
    .B1(_1692_),
    .Y(_1693_));
 ...
 sky130_fd_sc_hd__a21o_1 _6596_ (.A1(_1669_),
    ...
    .B1(_1672_),
    .X(_1704_));
 sky130_fd_sc_hd__nand2_1 _6597_ (.A(net239),
    .B(_0868_),
    .Y(_1705_));
 ...
 sky130_fd_sc_hd__nor2_1 _6608_ (.A(_1714_),
    .B(_1715_),
    .Y(_1716_));
 sky130_fd_sc_hd__xnor2_1 _6609_ (.A(_1703_),
    .B(_1716_),
    .Y(_1717_));
 sky130_fd_sc_hd__xor2_1 _6610_ (.A(_1693_),
    .B(_1717_),
    .X(_1718_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6617_ (.A_N(net104),
    ...
    .D(net266),
    .X(_1725_));
 sky130_fd_sc_hd__a21oi_1 _6618_ (.A1(_1723_),
    .A2(_1724_),
    .B1(_1725_),
    .Y(_1726_));
 sky130_fd_sc_hd__xnor2_1 _6619_ (.A(_1722_),
    .B(_1726_),
    .Y(_1727_));
 sky130_fd_sc_hd__a21oi_1 _6620_ (.A1(_1645_),
    .A2(_1650_),
    .B1(_1649_),
    .Y(_1728_));
 sky130_fd_sc_hd__xor2_1 _6621_ (.A(_1727_),
    .B(_1728_),
    .X(_1729_));
 ...
 sky130_fd_sc_hd__nor2_1 _6626_ (.A(_1731_),
    .B(_1733_),
    .Y(_1734_));
 sky130_fd_sc_hd__xnor2_1 _6627_ (.A(_1730_),
    .B(_1734_),
    .Y(_1735_));
 sky130_fd_sc_hd__xor2_1 _6628_ (.A(_1729_),
    .B(_1735_),
    .X(_1736_));
 sky130_fd_sc_hd__xnor2_1 _6629_ (.A(_1721_),
    .B(_1736_),
    .Y(_1737_));
 sky130_fd_sc_hd__xnor2_1 _6630_ (.A(_1720_),
    .B(_1737_),
    .Y(_1738_));
 sky130_fd_sc_hd__xnor2_1 _6631_ (.A(_1718_),
    .B(_1738_),
    .Y(_1739_));
 sky130_fd_sc_hd__xor2_1 _6632_ (.A(_1691_),
    .B(_1739_),
    .X(_1740_));
 ...
 sky130_fd_sc_hd__nor2_1 _6640_ (.A(_1746_),
    .B(_1747_),
    .Y(_1748_));
 sky130_fd_sc_hd__xnor2_1 _6641_ (.A(_1740_),
    .B(_1748_),
    .Y(_1749_));
 ...
 sky130_fd_sc_hd__nor2_1 _6657_ (.A(_1733_),
    .B(_1764_),
    .Y(_1765_));
 sky130_fd_sc_hd__xnor2_1 _6658_ (.A(_1763_),
    .B(_1765_),
    .Y(_1766_));
 sky130_fd_sc_hd__nand2_1 _6659_ (.A(net305),
    .B(net134),
    .Y(_1767_));
 sky130_fd_sc_hd__xnor2_1 _6660_ (.A(_1766_),
    .B(_1767_),
    .Y(_1768_));
 ...
 sky130_fd_sc_hd__a21o_1 _6662_ (.A1(_1729_),
    ...
    .B1(_1769_),
    .X(_1770_));
 sky130_fd_sc_hd__a21oi_1 _6663_ (.A1(_1704_),
    .A2(_1710_),
    .B1(_1714_),
    .Y(_1771_));
 ...
 sky130_fd_sc_hd__nor3_1 _6665_ (.A(_0927_),
    ...
    .C(_1772_),
    .Y(_1773_));
 sky130_fd_sc_hd__a21oi_1 _6666_ (.A1(_1772_),
    .A2(_1732_),
    .B1(_1773_),
    .Y(_1774_));
 sky130_fd_sc_hd__nor2_1 _6667_ (.A(_1119_),
    .B(net55),
    .Y(_1775_));
 sky130_fd_sc_hd__xnor2_1 _6668_ (.A(_1774_),
    .B(_1775_),
    .Y(_1776_));
 ...
 sky130_fd_sc_hd__nand2_1 _6678_ (.A(_1784_),
    .B(_1785_),
    .Y(_1786_));
 sky130_fd_sc_hd__xor2_1 _6679_ (.A(_1776_),
    .B(_1786_),
    .X(_1787_));
 sky130_fd_sc_hd__xnor2_1 _6680_ (.A(_1771_),
    .B(_1787_),
    .Y(_1788_));
 sky130_fd_sc_hd__xor2_1 _6681_ (.A(_1770_),
    .B(_1788_),
    .X(_1789_));
 ...
 sky130_fd_sc_hd__o22a_1 _6683_ (.A1(_1481_),
    ...
    .B2(_1426_),
    .X(_1791_));
 sky130_fd_sc_hd__o21ba_1 _6684_ (.A1(net61),
    .A2(_1790_),
    .B1_N(_1791_),
    .X(_1792_));
 ...
 sky130_fd_sc_hd__xor2_2 _6694_ (.A(_1794_),
    .B(_1801_),
    .X(_1802_));
 sky130_fd_sc_hd__xnor2_1 _6695_ (.A(_1792_),
    .B(_1802_),
    .Y(_1803_));
 sky130_fd_sc_hd__a21oi_1 _6696_ (.A1(_1703_),
    .A2(_1716_),
    .B1(_1701_),
    .Y(_1804_));
 sky130_fd_sc_hd__xor2_1 _6697_ (.A(_1803_),
    .B(_1804_),
    .X(_1805_));
 sky130_fd_sc_hd__xnor2_1 _6698_ (.A(_1789_),
    .B(_1805_),
    .Y(_1806_));
 ...
 sky130_fd_sc_hd__a21o_1 _6700_ (.A1(_1718_),
    ...
    .B1(_1807_),
    .X(_1808_));
 sky130_fd_sc_hd__xnor2_1 _6701_ (.A(_1806_),
    .B(_1808_),
    .Y(_1809_));
 sky130_fd_sc_hd__xnor2_1 _6702_ (.A(_1768_),
    .B(_1809_),
    .Y(_1810_));
 sky130_fd_sc_hd__nor2_1 _6703_ (.A(_1691_),
    .B(_1739_),
    .Y(_1811_));
 sky130_fd_sc_hd__a21oi_1 _6704_ (.A1(_1740_),
    .A2(_1748_),
    .B1(_1811_),
    .Y(_1812_));
 sky130_fd_sc_hd__xor2_1 _6705_ (.A(_1810_),
    .B(_1812_),
    .X(_1813_));
 sky130_fd_sc_hd__xnor2_1 _6706_ (.A(_1761_),
    .B(_1813_),
    .Y(_1814_));
 sky130_fd_sc_hd__or2b_1 _6707_ (.A(_1749_),
    .B_N(_1689_),
    .X(_1815_));
 sky130_fd_sc_hd__a21boi_1 _6708_ (.A1(_1632_),
    .A2(_1750_),
    .B1_N(_1815_),
    .Y(_1816_));
 sky130_fd_sc_hd__xor2_1 _6709_ (.A(_1814_),
    .B(_1816_),
    .X(_1817_));
 ...
 sky130_fd_sc_hd__and4bb_1 _6746_ (.A_N(net105),
    ...
    .D(net241),
    .X(_1858_));
 sky130_fd_sc_hd__a21oi_1 _6747_ (.A1(_1856_),
    .A2(_1857_),
    .B1(_1858_),
    .Y(_1859_));
 sky130_fd_sc_hd__xnor2_1 _6748_ (.A(_1855_),
    .B(_1859_),
    .Y(_1860_));
 sky130_fd_sc_hd__a21oi_1 _6749_ (.A1(_1780_),
    .A2(_1781_),
    .B1(_1779_),
    .Y(_1861_));
 ...
 sky130_fd_sc_hd__o21a_1 _6789_ (.A1(_1845_),
    ...
    .B1(_1904_),
    .X(_1905_));
 sky130_fd_sc_hd__xnor2_1 _6790_ (.A(_0848_),
    .B(_0852_),
    .Y(_1907_));
 sky130_fd_sc_hd__a21oi_1 _6791_ (.A1(_1855_),
    .A2(_1859_),
    .B1(_1858_),
    .Y(_1908_));
 ...
 sky130_fd_sc_hd__nor2_1 _6796_ (.A(_1911_),
    .B(_1912_),
    .Y(_1913_));
 sky130_fd_sc_hd__xnor2_1 _6797_ (.A(_1910_),
    .B(_1913_),
    .Y(_1914_));
 sky130_fd_sc_hd__xnor2_1 _6798_ (.A(_1909_),
    .B(_1914_),
    .Y(_1915_));
 sky130_fd_sc_hd__xnor2_1 _6799_ (.A(_1905_),
    .B(_1915_),
    .Y(_1916_));
 ...
 sky130_fd_sc_hd__and2b_1 _6803_ (.A_N(_1905_),
    .B(_1915_),
    .X(_1921_));
 sky130_fd_sc_hd__a21oi_1 _6804_ (.A1(_1916_),
    .A2(_1920_),
    .B1(_1921_),
    .Y(_1922_));
 ...
 sky130_fd_sc_hd__xnor2_1 _6854_ (.A(_1974_),
    .B(_1976_),
    .Y(_1977_));
 sky130_fd_sc_hd__o21bai_1 _6855_ (.A1(_1932_),
    .A2(_1933_),
    .B1_N(_1938_),
    .Y(_1978_));
 ...
 sky130_fd_sc_hd__a21oi_1 _6912_ (.A1(_0758_),
    ...
    .B1(_0727_),
    .Y(_2041_));
 sky130_fd_sc_hd__a21oi_1 _6913_ (.A1(_0764_),
    .A2(_2040_),
    .B1(_2041_),
    .Y(_2042_));
 ...
 sky130_fd_sc_hd__nand2_1 _6933_ (.A(_0902_),
    .B(_2063_),
    .Y(_2064_));
 sky130_fd_sc_hd__o21ai_1 _6934_ (.A1(_2028_),
    .A2(_2033_),
    .B1(_2035_),
    .Y(_2065_));
 ...
 sky130_fd_sc_hd__a22oi_1 _6936_ (.A1(\counter[9] ),
    ...
    .B2(\counter[10] ),
    .Y(_2067_));
 sky130_fd_sc_hd__or3b_1 _6937_ (.A(_2058_),
    .B(_2062_),
    .C_N(_2067_),
    .X(_2068_));
 ...
 sky130_fd_sc_hd__nor2_1 _6952_ (.A(_1751_),
    .B(_1759_),
    .Y(_2085_));
 sky130_fd_sc_hd__a21o_1 _6953_ (.A1(_1760_),
    .A2(_2084_),
    .B1(_2085_),
    .X(_2086_));
 ...
 sky130_fd_sc_hd__and2_1 _6955_ (.A(\counter[3] ),
    .B(_2087_),
    .X(_2088_));
 sky130_fd_sc_hd__xnor2_1 _6956_ (.A(_1760_),
    .B(_2084_),
    .Y(_2089_));
 ...
 sky130_fd_sc_hd__and2b_1 _7042_ (.A_N(net199),
    .B(net102),
    .X(_2183_));
 sky130_fd_sc_hd__xnor2_1 _7043_ (.A(_2140_),
    .B(_2183_),
    .Y(_2184_));
 ...
 sky130_fd_sc_hd__and4_1 _7049_ (.A(net156),
    ...
    .D(_2130_),
    .X(_2190_));
 sky130_fd_sc_hd__a21oi_1 _7050_ (.A1(_2134_),
    .A2(_2189_),
    .B1(_2190_),
    .Y(_2192_));
 ...
 sky130_fd_sc_hd__or4bb_1 _7077_ (.A(net202),
    ...
    .D_N(net285),
    .X(_2221_));
 sky130_fd_sc_hd__o21ai_1 _7078_ (.A1(_2217_),
    .A2(_2220_),
    .B1(_2221_),
    .Y(_2222_));
 ...
 sky130_fd_sc_hd__nand2_1 _7092_ (.A(_2229_),
    .B(_2236_),
    .Y(_2238_));
 sky130_fd_sc_hd__a21boi_1 _7093_ (.A1(_2222_),
    .A2(_2237_),
    .B1_N(_2238_),
    .Y(_2239_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7097_ (.A_N(net248),
    ...
    .D(net296),
    .X(_2243_));
 sky130_fd_sc_hd__a21oi_1 _7098_ (.A1(_2241_),
    .A2(_2242_),
    .B1(_2243_),
    .Y(_2244_));
 sky130_fd_sc_hd__xnor2_1 _7099_ (.A(_2240_),
    .B(_2244_),
    .Y(_2245_));
 ...
 sky130_fd_sc_hd__a21oi_1 _7104_ (.A1(_2248_),
    ...
    .B1(_2250_),
    .Y(_2251_));
 sky130_fd_sc_hd__a21oi_1 _7105_ (.A1(_2247_),
    .A2(_2251_),
    .B1(_2250_),
    .Y(_2252_));
 sky130_fd_sc_hd__xor2_1 _7106_ (.A(_2245_),
    .B(_2252_),
    .X(_2253_));
 ...
 sky130_fd_sc_hd__nor2_1 _7110_ (.A(_2255_),
    .B(_2256_),
    .Y(_2258_));
 sky130_fd_sc_hd__xnor2_1 _7111_ (.A(_2254_),
    .B(_2258_),
    .Y(_2259_));
 sky130_fd_sc_hd__xnor2_1 _7112_ (.A(_2253_),
    .B(_2259_),
    .Y(_2260_));
 sky130_fd_sc_hd__or2_1 _7113_ (.A(_2239_),
    .B(_2260_),
    .X(_2261_));
 sky130_fd_sc_hd__xnor2_1 _7114_ (.A(_2239_),
    .B(_2260_),
    .Y(_2262_));
 ...
 sky130_fd_sc_hd__and3_1 _7133_ (.A(_2261_),
    ...
    .C(_2281_),
    .X(_2283_));
 sky130_fd_sc_hd__nor2_1 _7134_ (.A(_2282_),
    .B(_2283_),
    .Y(_2284_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7140_ (.A_N(net225),
    ...
    .D(net215),
    .X(_2291_));
 sky130_fd_sc_hd__a21oi_1 _7141_ (.A1(_2288_),
    .A2(_2289_),
    .B1(_2291_),
    .Y(_2292_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7146_ (.A_N(net225),
    ...
    .D(net185),
    .X(_2297_));
 sky130_fd_sc_hd__a21oi_1 _7147_ (.A1(_2295_),
    .A2(_2296_),
    .B1(_2297_),
    .Y(_2298_));
 sky130_fd_sc_hd__xnor2_1 _7148_ (.A(_2294_),
    .B(_2298_),
    .Y(_2299_));
 sky130_fd_sc_hd__xor2_1 _7149_ (.A(_2293_),
    .B(_2299_),
    .X(_2300_));
 sky130_fd_sc_hd__nand2_1 _7150_ (.A(_2227_),
    .B(_2228_),
    .Y(_2302_));
 sky130_fd_sc_hd__xnor2_1 _7151_ (.A(_2223_),
    .B(_2302_),
    .Y(_2303_));
 sky130_fd_sc_hd__nand2_1 _7152_ (.A(_2293_),
    .B(_2299_),
    .Y(_2304_));
 sky130_fd_sc_hd__a21boi_1 _7153_ (.A1(_2300_),
    .A2(_2303_),
    .B1_N(_2304_),
    .Y(_2305_));
 sky130_fd_sc_hd__a31o_1 _7154_ (.A1(net215),
    ...
    .B1(_2297_),
    .X(_2306_));
 sky130_fd_sc_hd__nand2_1 _7155_ (.A(net185),
    .B(_2286_),
    .Y(_2307_));
 ...
 sky130_fd_sc_hd__o21a_1 _7159_ (.A1(_2308_),
    ...
    .B1(_2310_),
    .X(_2311_));
 sky130_fd_sc_hd__xnor2_1 _7160_ (.A(_2307_),
    .B(_2311_),
    .Y(_2313_));
 sky130_fd_sc_hd__xor2_1 _7161_ (.A(_2306_),
    .B(_2313_),
    .X(_2314_));
 ...
 sky130_fd_sc_hd__nand2_1 _7167_ (.A(_2317_),
    .B(_2319_),
    .Y(_2320_));
 sky130_fd_sc_hd__xnor2_1 _7168_ (.A(_2315_),
    .B(_2320_),
    .Y(_2321_));
 sky130_fd_sc_hd__xnor2_1 _7169_ (.A(_2314_),
    .B(_2321_),
    .Y(_2322_));
 sky130_fd_sc_hd__xor2_1 _7170_ (.A(_2305_),
    .B(_2322_),
    .X(_2324_));
 sky130_fd_sc_hd__nand2_1 _7171_ (.A(_2238_),
    .B(_2237_),
    .Y(_2325_));
 sky130_fd_sc_hd__xnor2_1 _7172_ (.A(_2222_),
    .B(_2325_),
    .Y(_2326_));
 sky130_fd_sc_hd__nor2_1 _7173_ (.A(_2305_),
    .B(_2322_),
    .Y(_2327_));
 sky130_fd_sc_hd__a21oi_1 _7174_ (.A1(_2324_),
    .A2(_2326_),
    .B1(_2327_),
    .Y(_2328_));
 sky130_fd_sc_hd__nand2_1 _7175_ (.A(_2306_),
    .B(_2313_),
    .Y(_2329_));
 sky130_fd_sc_hd__a21boi_1 _7176_ (.A1(_2314_),
    .A2(_2321_),
    .B1_N(_2329_),
    .Y(_2330_));
 sky130_fd_sc_hd__nor2_1 _7177_ (.A(_2308_),
    .B(_2309_),
    .Y(_2331_));
 sky130_fd_sc_hd__o21ai_1 _7178_ (.A1(_2307_),
    .A2(_2331_),
    .B1(_2310_),
    .Y(_2332_));
 sky130_fd_sc_hd__nand2_1 _7179_ (.A(net154),
    .B(_2286_),
    .Y(_2333_));
 sky130_fd_sc_hd__nand2b_1 _7180_ (.A_N(net226),
    .B(net121),
    .Y(_2335_));
 sky130_fd_sc_hd__and2b_1 _7181_ (.A_N(net18),
    .B(net101),
    .X(_2336_));
 sky130_fd_sc_hd__xnor2_1 _7182_ (.A(_2335_),
    .B(_2336_),
    .Y(_2337_));
 sky130_fd_sc_hd__xnor2_1 _7183_ (.A(_2333_),
    .B(_2337_),
    .Y(_2338_));
 sky130_fd_sc_hd__xor2_1 _7184_ (.A(_2332_),
    .B(_2338_),
    .X(_2339_));
 ...
 sky130_fd_sc_hd__and2_1 _7191_ (.A(_2344_),
    .B(_2346_),
    .X(_2347_));
 sky130_fd_sc_hd__xnor2_1 _7192_ (.A(_2339_),
    .B(_2347_),
    .Y(_2348_));
 sky130_fd_sc_hd__xor2_1 _7193_ (.A(_2330_),
    .B(_2348_),
    .X(_2349_));
 sky130_fd_sc_hd__nor2_1 _7194_ (.A(_2231_),
    .B(_2232_),
    .Y(_2350_));
 sky130_fd_sc_hd__o21ai_1 _7195_ (.A1(_2230_),
    .A2(_2350_),
    .B1(_2233_),
    .Y(_2351_));
 ...
 sky130_fd_sc_hd__and2b_1 _7199_ (.A_N(net203),
    .B(net268),
    .X(_2355_));
 sky130_fd_sc_hd__or4bb_1 _7200_ (.A(net203),
    .B(net206),
    .C_N(net260),
    .D_N(net270),
    .X(_2357_));
 ...
 sky130_fd_sc_hd__nand2_1 _7205_ (.A(_2360_),
    .B(_2361_),
    .Y(_2362_));
 sky130_fd_sc_hd__xnor2_1 _7206_ (.A(_2351_),
    .B(_2362_),
    .Y(_2363_));
 sky130_fd_sc_hd__xnor2_1 _7207_ (.A(_2349_),
    .B(_2363_),
    .Y(_2364_));
 sky130_fd_sc_hd__xor2_1 _7208_ (.A(_2328_),
    .B(_2364_),
    .X(_2365_));
 ...
 sky130_fd_sc_hd__a21oi_2 _7211_ (.A1(_2365_),
    ...
    .B1(_2368_),
    .Y(_2369_));
 sky130_fd_sc_hd__nor2_1 _7212_ (.A(_2330_),
    .B(_2348_),
    .Y(_2370_));
 ...
 sky130_fd_sc_hd__nor2_1 _7231_ (.A(_2354_),
    .B(_2355_),
    .Y(_2391_));
 sky130_fd_sc_hd__o21ai_1 _7232_ (.A1(_2353_),
    .A2(_2391_),
    .B1(_2357_),
    .Y(_2392_));
 ...
 sky130_fd_sc_hd__and2b_1 _7235_ (.A_N(net203),
    .B(net260),
    .X(_2395_));
 sky130_fd_sc_hd__or4bb_1 _7236_ (.A(net203),
    .B(net206),
    .C_N(net243),
    .D_N(net262),
    .X(_2396_));
 ...
 sky130_fd_sc_hd__a21oi_1 _7243_ (.A1(_2399_),
    ...
    .B1(_2392_),
    .Y(_2404_));
 sky130_fd_sc_hd__nor2_1 _7244_ (.A(_2403_),
    .B(_2404_),
    .Y(_2405_));
 ...
 sky130_fd_sc_hd__a21o_1 _7248_ (.A1(_2253_),
    ...
    .B1(_2408_),
    .X(_2409_));
 sky130_fd_sc_hd__a21boi_1 _7249_ (.A1(_2351_),
    .A2(_2361_),
    .B1_N(_2360_),
    .Y(_2410_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7253_ (.A_N(net247),
    ...
    .D(net287),
    .X(_2415_));
 sky130_fd_sc_hd__a21oi_1 _7254_ (.A1(_2413_),
    .A2(_2414_),
    .B1(_2415_),
    .Y(_2416_));
 sky130_fd_sc_hd__xnor2_1 _7255_ (.A(_2412_),
    .B(_2416_),
    .Y(_2417_));
 sky130_fd_sc_hd__a21oi_1 _7256_ (.A1(_2240_),
    .A2(_2244_),
    .B1(_2243_),
    .Y(_2418_));
 sky130_fd_sc_hd__xor2_1 _7257_ (.A(_2417_),
    .B(_2418_),
    .X(_2419_));
 ...
 sky130_fd_sc_hd__nor2_1 _7261_ (.A(_2421_),
    .B(_2423_),
    .Y(_2424_));
 sky130_fd_sc_hd__xnor2_1 _7262_ (.A(_2420_),
    .B(_2424_),
    .Y(_2425_));
 sky130_fd_sc_hd__xnor2_1 _7263_ (.A(_2419_),
    .B(_2425_),
    .Y(_2426_));
 sky130_fd_sc_hd__xnor2_1 _7264_ (.A(_2410_),
    .B(_2426_),
    .Y(_2427_));
 ...
 sky130_fd_sc_hd__nor2_1 _7270_ (.A(_2369_),
    .B(_2429_),
    .Y(_2434_));
 sky130_fd_sc_hd__a21oi_1 _7271_ (.A1(_2430_),
    .A2(_2432_),
    .B1(_2434_),
    .Y(_2435_));
 sky130_fd_sc_hd__nor2_1 _7272_ (.A(_2371_),
    .B(_2406_),
    .Y(_2436_));
 sky130_fd_sc_hd__a21oi_1 _7273_ (.A1(_2407_),
    .A2(_2428_),
    .B1(_2436_),
    .Y(_2437_));
 sky130_fd_sc_hd__nor2_1 _7274_ (.A(_2373_),
    .B(_2388_),
    .Y(_2438_));
 sky130_fd_sc_hd__a21oi_1 _7275_ (.A1(_2390_),
    .A2(_2405_),
    .B1(_2438_),
    .Y(_2439_));
 sky130_fd_sc_hd__and2_1 _7276_ (.A(_2376_),
    .B(_2379_),
    .X(_2440_));
 sky130_fd_sc_hd__a21oi_1 _7277_ (.A1(_2380_),
    .A2(_2387_),
    .B1(_2440_),
    .Y(_2441_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7281_ (.A_N(net220),
    ...
    .D(net155),
    .X(_2446_));
 sky130_fd_sc_hd__a21oi_1 _7282_ (.A1(_2443_),
    .A2(_2445_),
    .B1(_2446_),
    .Y(_2447_));
 sky130_fd_sc_hd__xnor2_1 _7283_ (.A(_2442_),
    .B(_2447_),
    .Y(_2448_));
 sky130_fd_sc_hd__clkbuf_4 _7284_ (.A(_2286_),
    .X(_2449_));
 sky130_fd_sc_hd__and3_1 _7285_ (.A(net101),
    .B(_2449_),
    .C(_2335_),
    .X(_2450_));
 sky130_fd_sc_hd__xnor2_1 _7286_ (.A(_2448_),
    .B(_2450_),
    .Y(_2451_));
 sky130_fd_sc_hd__xnor2_1 _7287_ (.A(_2441_),
    .B(_2451_),
    .Y(_2452_));
 ...
 sky130_fd_sc_hd__and2b_1 _7292_ (.A_N(net203),
    .B(net243),
    .X(_2458_));
 sky130_fd_sc_hd__or4bb_1 _7293_ (.A(net203),
    .B(net206),
    .C_N(net216),
    .D_N(net244),
    .X(_2459_));
 ...
 sky130_fd_sc_hd__o21ai_1 _7296_ (.A1(_2383_),
    ...
    .B1(_2461_),
    .Y(_2462_));
 sky130_fd_sc_hd__or3_1 _7297_ (.A(_2383_),
    .B(_2385_),
    .C(_2461_),
    .X(_2463_));
 ...
 sky130_fd_sc_hd__xnor2_2 _7299_ (.A(_2454_),
    .B(_2464_),
    .Y(_2465_));
 sky130_fd_sc_hd__xnor2_1 _7300_ (.A(_2452_),
    .B(_2465_),
    .Y(_2467_));
 sky130_fd_sc_hd__xor2_1 _7301_ (.A(_2439_),
    .B(_2467_),
    .X(_2468_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7308_ (.A_N(net247),
    ...
    .D(net278),
    .X(_2475_));
 sky130_fd_sc_hd__a21oi_1 _7309_ (.A1(_2473_),
    .A2(_2474_),
    .B1(_2475_),
    .Y(_2476_));
 sky130_fd_sc_hd__xnor2_1 _7310_ (.A(_2472_),
    .B(_2476_),
    .Y(_2478_));
 sky130_fd_sc_hd__a21oi_1 _7311_ (.A1(_2412_),
    .A2(_2416_),
    .B1(_2415_),
    .Y(_2479_));
 sky130_fd_sc_hd__xor2_1 _7312_ (.A(_2478_),
    .B(_2479_),
    .X(_2480_));
 ...
 sky130_fd_sc_hd__nor2_1 _7316_ (.A(_2482_),
    .B(_2483_),
    .Y(_2484_));
 sky130_fd_sc_hd__xnor2_1 _7317_ (.A(_2481_),
    .B(_2484_),
    .Y(_2485_));
 sky130_fd_sc_hd__xnor2_1 _7318_ (.A(_2480_),
    .B(_2485_),
    .Y(_2486_));
 sky130_fd_sc_hd__xnor2_1 _7319_ (.A(_2471_),
    .B(_2486_),
    .Y(_2487_));
 sky130_fd_sc_hd__xnor2_2 _7320_ (.A(_2470_),
    .B(_2487_),
    .Y(_2489_));
 sky130_fd_sc_hd__xnor2_1 _7321_ (.A(_2468_),
    .B(_2489_),
    .Y(_2490_));
 sky130_fd_sc_hd__xor2_1 _7322_ (.A(_2437_),
    .B(_2490_),
    .X(_2491_));
 ...
 sky130_fd_sc_hd__o21ba_1 _7326_ (.A1(_2420_),
    ...
    .B1_N(_2423_),
    .X(_2495_));
 sky130_fd_sc_hd__a21oi_1 _7327_ (.A1(_2493_),
    .A2(_2494_),
    .B1(_2495_),
    .Y(_2496_));
 sky130_fd_sc_hd__and3_1 _7328_ (.A(_2493_),
    ...
    .C(_2495_),
    .X(_2497_));
 sky130_fd_sc_hd__nor2_1 _7329_ (.A(_2496_),
    .B(_2497_),
    .Y(_2498_));
 sky130_fd_sc_hd__xnor2_1 _7330_ (.A(_2492_),
    .B(_2498_),
    .Y(_2500_));
 sky130_fd_sc_hd__xnor2_1 _7331_ (.A(_2491_),
    .B(_2500_),
    .Y(_2501_));
 sky130_fd_sc_hd__xor2_1 _7332_ (.A(_2435_),
    .B(_2501_),
    .X(_2502_));
 ...
 sky130_fd_sc_hd__or2b_1 _7341_ (.A(net219),
    .B_N(net270),
    .X(_2512_));
 sky130_fd_sc_hd__o21ai_1 _7342_ (.A1(_0303_),
    .A2(net222),
    .B1(_2512_),
    .Y(_2513_));
 ...
 sky130_fd_sc_hd__a21bo_1 _7350_ (.A1(_2519_),
    ...
    .B1_N(_2515_),
    .X(_2522_));
 sky130_fd_sc_hd__a21boi_1 _7351_ (.A1(_2509_),
    .A2(_2518_),
    .B1_N(_2522_),
    .Y(_2523_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7377_ (.A_N(net225),
    ...
    .D(net243),
    .X(_2551_));
 sky130_fd_sc_hd__a21oi_1 _7378_ (.A1(_2549_),
    .A2(_2550_),
    .B1(_2551_),
    .Y(_2552_));
 ...
 sky130_fd_sc_hd__nand2_1 _7380_ (.A(net243),
    .B(_2287_),
    .Y(_2555_));
 sky130_fd_sc_hd__xnor2_1 _7381_ (.A(_2555_),
    .B(_2292_),
    .Y(_2556_));
 sky130_fd_sc_hd__xor2_1 _7382_ (.A(_2553_),
    .B(_2556_),
    .X(_2557_));
 ...
 sky130_fd_sc_hd__nand2_1 _7385_ (.A(_2553_),
    .B(_2556_),
    .Y(_2560_));
 sky130_fd_sc_hd__a21boi_1 _7386_ (.A1(_2557_),
    .A2(_2559_),
    .B1_N(_2560_),
    .Y(_2561_));
 sky130_fd_sc_hd__xnor2_1 _7387_ (.A(_2300_),
    .B(_2303_),
    .Y(_2562_));
 sky130_fd_sc_hd__xor2_1 _7388_ (.A(_2561_),
    .B(_2562_),
    .X(_2563_));
 ...
 sky130_fd_sc_hd__a21oi_1 _7390_ (.A1(_2522_),
    ...
    .B1(_2509_),
    .Y(_2566_));
 sky130_fd_sc_hd__nor2_1 _7391_ (.A(_2564_),
    .B(_2566_),
    .Y(_2567_));
 sky130_fd_sc_hd__nor2_1 _7392_ (.A(_2561_),
    .B(_2562_),
    .Y(_2568_));
 sky130_fd_sc_hd__a21oi_1 _7393_ (.A1(_2563_),
    .A2(_2567_),
    .B1(_2568_),
    .Y(_2569_));
 sky130_fd_sc_hd__xnor2_1 _7394_ (.A(_2324_),
    .B(_2326_),
    .Y(_2570_));
 sky130_fd_sc_hd__xor2_1 _7395_ (.A(_2569_),
    .B(_2570_),
    .X(_2571_));
 ...
 sky130_fd_sc_hd__nor2_1 _7398_ (.A(_2569_),
    .B(_2570_),
    .Y(_2574_));
 sky130_fd_sc_hd__a21oi_1 _7399_ (.A1(_2571_),
    .A2(_2573_),
    .B1(_2574_),
    .Y(_2575_));
 sky130_fd_sc_hd__xnor2_1 _7400_ (.A(_2365_),
    .B(_2366_),
    .Y(_2577_));
 sky130_fd_sc_hd__xor2_1 _7401_ (.A(_2575_),
    .B(_2577_),
    .X(_2578_));
 sky130_fd_sc_hd__nand2_1 _7402_ (.A(net319),
    .B(net227),
    .Y(_2579_));
 sky130_fd_sc_hd__xnor2_1 _7403_ (.A(_2579_),
    .B(_2547_),
    .Y(_2580_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7419_ (.A_N(net219),
    ...
    .D(net277),
    .X(_2597_));
 sky130_fd_sc_hd__a2111o_1 _7420_ (.A1(_2596_),
    .A2(_2516_),
    .B1(_2597_),
    .C1(_0927_),
    .D1(net29),
 ...
 sky130_fd_sc_hd__or2b_1 _7433_ (.A(_2593_),
    .B_N(_2612_),
    .X(_2613_));
 sky130_fd_sc_hd__xor2_1 _7434_ (.A(_2612_),
    .B(_2593_),
    .X(_2614_));
 ...
 sky130_fd_sc_hd__a21oi_1 _7452_ (.A1(_2630_),
    ...
    .B1(_2633_),
    .Y(_2634_));
 sky130_fd_sc_hd__a31o_1 _7453_ (.A1(net268),
    .A2(_2287_),
    .A3(_2634_),
    .B1(_2633_),
    .X(_2635_));
 sky130_fd_sc_hd__nand2_1 _7454_ (.A(net260),
    .B(_2286_),
    .Y(_2636_));
 sky130_fd_sc_hd__xnor2_1 _7455_ (.A(_2636_),
    .B(_2552_),
    .Y(_2637_));
 sky130_fd_sc_hd__xor2_1 _7456_ (.A(_2635_),
    .B(_2637_),
    .X(_2638_));
 ...
 sky130_fd_sc_hd__a32oi_2 _7459_ (.A1(_2599_),
    ...
    .B2(_2637_),
    .Y(_2641_));
 sky130_fd_sc_hd__xnor2_1 _7460_ (.A(_2557_),
    .B(_2559_),
    .Y(_2643_));
 sky130_fd_sc_hd__xor2_1 _7461_ (.A(_2641_),
    .B(_2643_),
    .X(_2644_));
 ...
 sky130_fd_sc_hd__nor2_1 _7463_ (.A(_2641_),
    .B(_2643_),
    .Y(_2646_));
 sky130_fd_sc_hd__a21oi_1 _7464_ (.A1(_2644_),
    .A2(_2645_),
    .B1(_2646_),
    .Y(_2647_));
 sky130_fd_sc_hd__xnor2_1 _7465_ (.A(_2563_),
    .B(_2567_),
    .Y(_2648_));
 sky130_fd_sc_hd__xor2_1 _7466_ (.A(_2647_),
    .B(_2648_),
    .X(_2649_));
 sky130_fd_sc_hd__xnor2_1 _7467_ (.A(_2627_),
    .B(_2614_),
    .Y(_2650_));
 sky130_fd_sc_hd__nor2_1 _7468_ (.A(_2647_),
    .B(_2648_),
    .Y(_2651_));
 sky130_fd_sc_hd__a21oi_1 _7469_ (.A1(_2649_),
    .A2(_2650_),
    .B1(_2651_),
    .Y(_2652_));
 sky130_fd_sc_hd__xnor2_1 _7470_ (.A(_2571_),
    .B(_2573_),
    .Y(_2654_));
 sky130_fd_sc_hd__xor2_1 _7471_ (.A(_2652_),
    .B(_2654_),
    .X(_2655_));
 ...
 sky130_fd_sc_hd__nor2_1 _7474_ (.A(_2652_),
    .B(_2654_),
    .Y(_2658_));
 sky130_fd_sc_hd__a21oi_1 _7475_ (.A1(_2655_),
    .A2(_2657_),
    .B1(_2658_),
    .Y(_2659_));
 sky130_fd_sc_hd__xnor2_1 _7476_ (.A(_2578_),
    .B(_2580_),
    .Y(_2660_));
 sky130_fd_sc_hd__xor2_1 _7477_ (.A(_2659_),
    .B(_2660_),
    .X(_2661_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7518_ (.A_N(net247),
    ...
    .D(net269),
    .X(_2706_));
 sky130_fd_sc_hd__a21oi_1 _7519_ (.A1(_2704_),
    .A2(_2705_),
    .B1(_2706_),
    .Y(_2707_));
 sky130_fd_sc_hd__xnor2_1 _7520_ (.A(_2703_),
    .B(_2707_),
    .Y(_2709_));
 sky130_fd_sc_hd__a21oi_1 _7521_ (.A1(_2472_),
    .A2(_2476_),
    .B1(_2475_),
    .Y(_2710_));
 sky130_fd_sc_hd__xor2_1 _7522_ (.A(_2709_),
    .B(_2710_),
    .X(_2711_));
 ...
 sky130_fd_sc_hd__nor2_1 _7526_ (.A(_2713_),
    .B(_2714_),
    .Y(_2715_));
 sky130_fd_sc_hd__xnor2_1 _7527_ (.A(_2712_),
    .B(_2715_),
    .Y(_2716_));
 sky130_fd_sc_hd__xnor2_1 _7528_ (.A(_2711_),
    .B(_2716_),
    .Y(_2717_));
 sky130_fd_sc_hd__xnor2_1 _7529_ (.A(_2702_),
    .B(_2717_),
    .Y(_2718_));
 ...
 sky130_fd_sc_hd__o21ba_1 _7536_ (.A1(_2481_),
    ...
    .B1_N(_2483_),
    .X(_2726_));
 sky130_fd_sc_hd__a21oi_1 _7537_ (.A1(_2724_),
    .A2(_2725_),
    .B1(_2726_),
    .Y(_2727_));
 sky130_fd_sc_hd__and3_1 _7538_ (.A(_2724_),
    ...
    .C(_2726_),
    .X(_2728_));
 sky130_fd_sc_hd__nor2_1 _7539_ (.A(_2727_),
    .B(_2728_),
    .Y(_2729_));
 ...
 sky130_fd_sc_hd__nor2_1 _7548_ (.A(_2670_),
    .B(_2721_),
    .Y(_2739_));
 sky130_fd_sc_hd__a21oi_1 _7549_ (.A1(_2722_),
    .A2(_2731_),
    .B1(_2739_),
    .Y(_2740_));
 ...
 sky130_fd_sc_hd__and3_1 _7597_ (.A(_2789_),
    ...
    .C(_2791_),
    .X(_2793_));
 sky130_fd_sc_hd__nor2_1 _7598_ (.A(_2792_),
    .B(_2793_),
    .Y(_2794_));
 sky130_fd_sc_hd__xnor2_1 _7599_ (.A(_2788_),
    .B(_2794_),
    .Y(_2795_));
 sky130_fd_sc_hd__xnor2_1 _7600_ (.A(_2787_),
    .B(_2795_),
    .Y(_2797_));
 sky130_fd_sc_hd__xor2_1 _7601_ (.A(_2740_),
    .B(_2797_),
    .X(_2798_));
 sky130_fd_sc_hd__xnor2_1 _7602_ (.A(_2738_),
    .B(_2798_),
    .Y(_2799_));
 sky130_fd_sc_hd__nor2_1 _7603_ (.A(_2668_),
    .B(_2732_),
    .Y(_2800_));
 sky130_fd_sc_hd__a21oi_1 _7604_ (.A1(_2666_),
    .A2(_2733_),
    .B1(_2800_),
    .Y(_2801_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7631_ (.A_N(net224),
    ...
    .D(net268),
    .X(_2831_));
 sky130_fd_sc_hd__a21oi_1 _7632_ (.A1(_2828_),
    .A2(_2830_),
    .B1(_2831_),
    .Y(_2832_));
 ...
 sky130_fd_sc_hd__a21oi_1 _7664_ (.A1(_2864_),
    ...
    .B1(_2866_),
    .Y(_2867_));
 sky130_fd_sc_hd__a31o_1 _7665_ (.A1(net285),
    .A2(_2287_),
    .A3(_2867_),
    .B1(_2866_),
    .X(_2868_));
 sky130_fd_sc_hd__nand2_1 _7666_ (.A(net276),
    .B(_2286_),
    .Y(_2869_));
 sky130_fd_sc_hd__xnor2_1 _7667_ (.A(_2869_),
    .B(_2832_),
    .Y(_2870_));
 sky130_fd_sc_hd__xor2_1 _7668_ (.A(_2868_),
    .B(_2870_),
    .X(_2871_));
 sky130_fd_sc_hd__or2b_1 _7669_ (.A(net219),
    .B_N(net294),
    .X(_2872_));
 sky130_fd_sc_hd__o21ai_1 _7670_ (.A1(_0927_),
    .A2(net222),
    .B1(_2872_),
    .Y(_2874_));
 sky130_fd_sc_hd__or2b_1 _7671_ (.A(net222),
    .B_N(net294),
    .X(_2875_));
 sky130_fd_sc_hd__or2_1 _7672_ (.A(_2810_),
    .B(_2875_),
    .X(_2876_));
 sky130_fd_sc_hd__nand4_2 _7673_ (.A(net303),
    .B(_2381_),
    .C(_2874_),
    .D(_2876_),
    .Y(_2877_));
 ...
 sky130_fd_sc_hd__xor2_1 _7687_ (.A(_2889_),
    .B(_2891_),
    .X(_2892_));
 sky130_fd_sc_hd__xnor2_1 _7688_ (.A(_2888_),
    .B(_2892_),
    .Y(_2893_));
 ...
 sky130_fd_sc_hd__nand2_1 _7696_ (.A(_2852_),
    .B(_2901_),
    .Y(_2902_));
 sky130_fd_sc_hd__a21oi_1 _7697_ (.A1(_2899_),
    .A2(_2900_),
    .B1(_2902_),
    .Y(_2903_));
 ...
 sky130_fd_sc_hd__a21oi_1 _7842_ (.A1(_3028_),
    ...
    .B1(_3062_),
    .Y(_3063_));
 sky130_fd_sc_hd__a31oi_1 _7843_ (.A1(net320),
    .A2(_2678_),
    .A3(_3063_),
    .B1(_3062_),
    .Y(_3064_));
 ...
 sky130_fd_sc_hd__and3_1 _7879_ (.A(net312),
    ...
    .C(_3102_),
    .X(_3103_));
 sky130_fd_sc_hd__a31oi_1 _7880_ (.A1(net94),
    .A2(_2449_),
    .A3(_3101_),
    .B1(_3103_),
    .Y(_3105_));
 ...
 sky130_fd_sc_hd__a21oi_1 _7919_ (.A1(_2861_),
    ...
    .B1(_2804_),
    .Y(_3147_));
 sky130_fd_sc_hd__a41o_1 _7920_ (.A1(_2863_),
    .A2(_2919_),
    .A3(_2975_),
    .A4(_3146_),
    .B1(_3147_),
    .X(_3149_));
 sky130_fd_sc_hd__nand3b_1 _7921_ (.A_N(_2590_),
    .B(_2803_),
    .C(_3149_),
    .Y(_3150_));
 sky130_fd_sc_hd__nand2_1 _7922_ (.A(_2737_),
    .B(_2802_),
    .Y(_3151_));
 sky130_fd_sc_hd__nor2_1 _7923_ (.A(_2591_),
    .B(_2663_),
    .Y(_3152_));
 ...
 sky130_fd_sc_hd__o21a_1 _7936_ (.A1(_3163_),
    ...
    .B1(_3165_),
    .X(_3166_));
 sky130_fd_sc_hd__xnor2_1 _7937_ (.A(_3162_),
    .B(_3166_),
    .Y(_3167_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7952_ (.A_N(net246),
    ...
    .D(net244),
    .X(_3184_));
 sky130_fd_sc_hd__a21oi_1 _7953_ (.A1(_3182_),
    .A2(_3183_),
    .B1(_3184_),
    .Y(_3185_));
 sky130_fd_sc_hd__xnor2_1 _7954_ (.A(_3180_),
    .B(_3185_),
    .Y(_3186_));
 sky130_fd_sc_hd__a21oi_1 _7955_ (.A1(_2768_),
    .A2(_2772_),
    .B1(_2771_),
    .Y(_3187_));
 ...
 sky130_fd_sc_hd__nor2_1 _7960_ (.A(_3190_),
    .B(_3191_),
    .Y(_3193_));
 sky130_fd_sc_hd__xnor2_1 _7961_ (.A(_3189_),
    .B(_3193_),
    .Y(_3194_));
 sky130_fd_sc_hd__xnor2_1 _7962_ (.A(_3188_),
    .B(_3194_),
    .Y(_3195_));
 ...
 sky130_fd_sc_hd__and4bb_1 _7991_ (.A_N(net246),
    ...
    .D(net217),
    .X(_3227_));
 sky130_fd_sc_hd__a21oi_1 _7992_ (.A1(_3224_),
    .A2(_3226_),
    .B1(_3227_),
    .Y(_3228_));
 ...
 sky130_fd_sc_hd__xor2_1 _8014_ (.A(_3244_),
    .B(_3251_),
    .X(_3252_));
 sky130_fd_sc_hd__or2b_1 _8015_ (.A(_3161_),
    .B_N(_3172_),
    .X(_3253_));
 ...
 sky130_fd_sc_hd__a21oi_1 _8036_ (.A1(_2738_),
    ...
    .B1(_3275_),
    .Y(_3276_));
 sky130_fd_sc_hd__or2_1 _8037_ (.A(_3274_),
    .B(_3276_),
    .X(_3277_));
 ...
 sky130_fd_sc_hd__and4bb_1 _8050_ (.A_N(net246),
    ...
    .D(net4),
    .X(_3292_));
 sky130_fd_sc_hd__a21oi_1 _8051_ (.A1(_3289_),
    .A2(_3290_),
    .B1(_3292_),
    .Y(_3293_));
 sky130_fd_sc_hd__xnor2_1 _8052_ (.A(_3288_),
    .B(_3293_),
    .Y(_3294_));
 sky130_fd_sc_hd__a21oi_1 _8053_ (.A1(_3223_),
    .A2(_3228_),
    .B1(_3227_),
    .Y(_3295_));
 sky130_fd_sc_hd__xnor2_1 _8054_ (.A(_3294_),
    .B(_3295_),
    .Y(_3296_));
 sky130_fd_sc_hd__nand2_1 _8055_ (.A(net269),
    .B(_2162_),
    .Y(_3297_));
 ...
 sky130_fd_sc_hd__o21a_1 _8097_ (.A1(_2181_),
    ...
    .B1(_3342_),
    .X(_3343_));
 sky130_fd_sc_hd__xnor2_1 _8098_ (.A(_3340_),
    .B(_3343_),
    .Y(_3344_));
 sky130_fd_sc_hd__xnor2_1 _8099_ (.A(_3339_),
    .B(_3344_),
    .Y(_3345_));
 ...
 sky130_fd_sc_hd__nor2_1 _8103_ (.A(_3348_),
    .B(_3349_),
    .Y(_3350_));
 sky130_fd_sc_hd__xnor2_1 _8104_ (.A(_3347_),
    .B(_3350_),
    .Y(_3351_));
 sky130_fd_sc_hd__xor2_1 _8105_ (.A(_3345_),
    .B(_3351_),
    .X(_3352_));
 sky130_fd_sc_hd__xor2_1 _8106_ (.A(_3312_),
    .B(_3352_),
    .X(_3353_));
 ...
 sky130_fd_sc_hd__nor2_1 _8108_ (.A(_3294_),
    .B(_3295_),
    .Y(_3355_));
 sky130_fd_sc_hd__a21oi_1 _8109_ (.A1(_3354_),
    .A2(_3301_),
    .B1(_3355_),
    .Y(_3356_));
 ...
 sky130_fd_sc_hd__a211oi_1 _8130_ (.A1(_3378_),
    ...
    .C1(_3375_),
    .Y(_3380_));
 sky130_fd_sc_hd__a211oi_1 _8131_ (.A1(_3369_),
    .A2(_3377_),
    .B1(_3380_),
    .C1(_3367_),
    .Y(_3381_));
 ...
 sky130_fd_sc_hd__or2b_1 _8134_ (.A(_3312_),
    .B_N(_3352_),
    .X(_3384_));
 sky130_fd_sc_hd__o21ai_1 _8135_ (.A1(_3353_),
    .A2(_3356_),
    .B1(_3384_),
    .Y(_3385_));
 ...
 sky130_fd_sc_hd__and2_1 _8158_ (.A(_3408_),
    .B(_3409_),
    .X(_3410_));
 sky130_fd_sc_hd__xnor2_1 _8159_ (.A(_3392_),
    .B(_3410_),
    .Y(_3411_));
 ...
 sky130_fd_sc_hd__xnor2_1 _8161_ (.A(_3411_),
    .B(_3413_),
    .Y(_3414_));
 sky130_fd_sc_hd__o21ai_1 _8162_ (.A1(_3382_),
    .A2(_3383_),
    .B1(_3414_),
    .Y(_3415_));
 ...
 sky130_fd_sc_hd__or2_1 _8169_ (.A(_3420_),
    .B(_3421_),
    .X(_3422_));
 sky130_fd_sc_hd__a21oi_1 _8170_ (.A1(_3376_),
    .A2(_3381_),
    .B1(_3422_),
    .Y(_3424_));
 ...
 sky130_fd_sc_hd__nand3_1 _8229_ (.A(_3463_),
    ...
    .C(_3487_),
    .Y(_3488_));
 sky130_fd_sc_hd__a21oi_1 _8230_ (.A1(_3424_),
    .A2(_3482_),
    .B1(_3488_),
    .Y(_3490_));
 ...
 sky130_fd_sc_hd__nand2_1 _8235_ (.A(_3493_),
    .B(_3494_),
    .Y(_3495_));
 sky130_fd_sc_hd__o21ai_1 _8236_ (.A1(_3490_),
    .A2(_3495_),
    .B1(_3493_),
    .Y(_3496_));
 sky130_fd_sc_hd__a21oi_1 _8237_ (.A1(_2207_),
    ...
    .B1(_2176_),
    .Y(_3497_));
 sky130_fd_sc_hd__a21oi_1 _8238_ (.A1(_2214_),
    .A2(_3496_),
    .B1(_3497_),
    .Y(_3498_));
 sky130_fd_sc_hd__xor2_1 _8239_ (.A(_2174_),
    .B(_3498_),
    .X(_3499_));
 ...
 sky130_fd_sc_hd__xnor2_1 _8250_ (.A(_3474_),
    .B(_3508_),
    .Y(_3512_));
 sky130_fd_sc_hd__o22ai_1 _8251_ (.A1(\counter[11] ),
    .A2(_3510_),
    .B1(_3512_),
    .B2(\counter[10] ),
    .Y(_3513_));
 ...
 sky130_fd_sc_hd__or2_1 _8261_ (.A(_3521_),
    .B(_3523_),
    .X(_3524_));
 sky130_fd_sc_hd__a22oi_1 _8262_ (.A1(net79),
    .A2(_3518_),
    .B1(_3524_),
    .B2(\counter[5] ),
    .Y(_3525_));
 ...
 sky130_fd_sc_hd__a22oi_1 _8275_ (.A1(\counter[10] ),
    ...
    .B2(net77),
    .Y(_3539_));
 sky130_fd_sc_hd__or3b_1 _8276_ (.A(_3535_),
    .B(_3538_),
    .C_N(_3539_),
    .X(_3540_));
 ...
 sky130_fd_sc_hd__a21oi_1 _8279_ (.A1(_3542_),
    ...
    .B1(_2588_),
    .Y(_3543_));
 sky130_fd_sc_hd__nor2_1 _8280_ (.A(_2734_),
    .B(_2736_),
    .Y(_3545_));
 sky130_fd_sc_hd__a21o_1 _8281_ (.A1(_2737_),
    .A2(_3543_),
    .B1(_3545_),
    .X(_3546_));
 sky130_fd_sc_hd__xnor2_1 _8282_ (.A(_2802_),
    .B(_3546_),
    .Y(_3547_));
 sky130_fd_sc_hd__and2_1 _8283_ (.A(\counter[3] ),
    .B(_3547_),
    .X(_3548_));
 sky130_fd_sc_hd__xnor2_1 _8284_ (.A(_2737_),
    .B(_3543_),
    .Y(_3549_));
 ...
 sky130_fd_sc_hd__a21o_1 _8334_ (.A1(\delta[4] ),
    ...
    .B1(_3592_),
    .X(_3597_));
 sky130_fd_sc_hd__o21ai_1 _8335_ (.A1(\delta[4] ),
    .A2(net80),
    .B1(_3597_),
    .Y(_3598_));
 ...
 sky130_fd_sc_hd__a21o_1 _8352_ (.A1(\delta[8] ),
    ...
    .B1(_3608_),
    .X(_3613_));
 sky130_fd_sc_hd__o21ai_1 _8353_ (.A1(\delta[8] ),
    .A2(\counter[8] ),
    .B1(_3613_),
    .Y(_3614_));
 ...
 sky130_fd_sc_hd__inv_2 _8415_ (.A(clk),
    .Y(_0048_));
 sky130_fd_sc_hd__dfrtp_1 _8416_ (.CLK(_0017_),
    .D(_0049_),
    .RESET_B(net252),
    .Q(\delta[1] ));
 sky130_fd_sc_hd__dfrtp_1 _8417_ (.CLK(_0018_),
    .D(_0050_),
    .RESET_B(net252),
    .Q(\delta[2] ));
 sky130_fd_sc_hd__dfrtp_1 _8418_ (.CLK(_0019_),
    .D(_0051_),
    .RESET_B(net252),
    .Q(\delta[3] ));
 sky130_fd_sc_hd__dfrtp_1 _8419_ (.CLK(_0020_),
    .D(_0052_),
    .RESET_B(net252),
    .Q(\delta[4] ));
 sky130_fd_sc_hd__dfrtp_1 _8420_ (.CLK(_0021_),
    .D(_0053_),
    .RESET_B(net252),
    .Q(\delta[5] ));
 sky130_fd_sc_hd__dfrtp_1 _8421_ (.CLK(_0022_),
    .D(_0054_),
    .RESET_B(net253),
    .Q(\delta[6] ));
 sky130_fd_sc_hd__dfrtp_1 _8422_ (.CLK(_0023_),
    .D(_0055_),
    .RESET_B(net253),
    .Q(\delta[7] ));
 sky130_fd_sc_hd__dfrtp_1 _8423_ (.CLK(_0024_),
    .D(_0056_),
    .RESET_B(net253),
    .Q(\delta[8] ));
 sky130_fd_sc_hd__dfrtp_1 _8424_ (.CLK(_0025_),
    .D(_0057_),
    .RESET_B(net254),
    .Q(\delta[9] ));
 sky130_fd_sc_hd__dfrtp_1 _8425_ (.CLK(_0026_),
    .D(_0058_),
    .RESET_B(net254),
    .Q(\delta[10] ));
 sky130_fd_sc_hd__dfrtp_1 _8426_ (.CLK(_0027_),
    .D(_0059_),
    .RESET_B(net254),
    .Q(\delta[11] ));
 sky130_fd_sc_hd__dfrtp_1 _8427_ (.CLK(_0028_),
    .D(_0060_),
    .RESET_B(net253),
    .Q(\delta[12] ));
 sky130_fd_sc_hd__dfrtp_1 _8428_ (.CLK(_0029_),
    .D(_0061_),
    .RESET_B(net253),
    .Q(\delta[13] ));
 sky130_fd_sc_hd__dfrtp_1 _8429_ (.CLK(_0030_),
    .D(_0062_),
    .RESET_B(net253),
    .Q(\delta[14] ));
 sky130_fd_sc_hd__dfrtp_1 _8430_ (.CLK(_0031_),
    .D(_0063_),
    .RESET_B(net253),
    .Q(\delta[15] ));
 sky130_fd_sc_hd__dfrtp_4 _8431_ (.CLK(_0032_),
    .D(_0001_),
    .RESET_B(net252),
    .Q(\counter[0] ));
 sky130_fd_sc_hd__dfrtp_1 _8432_ (.CLK(_0033_),
    .D(_0008_),
    .RESET_B(net252),
    .Q(\counter[1] ));
 sky130_fd_sc_hd__dfrtp_1 _8433_ (.CLK(_0034_),
    .D(_0009_),
    .RESET_B(net252),
    .Q(\counter[2] ));
 sky130_fd_sc_hd__dfrtp_4 _8434_ (.CLK(_0035_),
    .D(_0010_),
    .RESET_B(net252),
    .Q(\counter[3] ));
 sky130_fd_sc_hd__dfrtp_1 _8435_ (.CLK(_0036_),
    .D(_0011_),
    .RESET_B(net252),
    .Q(\counter[4] ));
 sky130_fd_sc_hd__dfrtp_4 _8436_ (.CLK(_0037_),
    .D(_0012_),
    .RESET_B(net255),
    .Q(\counter[5] ));
 sky130_fd_sc_hd__dfrtp_1 _8437_ (.CLK(_0038_),
    .D(_0013_),
    .RESET_B(net254),
    .Q(\counter[6] ));
 sky130_fd_sc_hd__dfrtp_4 _8438_ (.CLK(_0039_),
    .D(_0014_),
    .RESET_B(net253),
    .Q(\counter[7] ));
 sky130_fd_sc_hd__dfrtp_1 _8439_ (.CLK(_0040_),
    .D(_0015_),
    .RESET_B(net254),
    .Q(\counter[8] ));
 sky130_fd_sc_hd__dfrtp_1 _8440_ (.CLK(_0041_),
    .D(_0016_),
    .RESET_B(net254),
    .Q(\counter[9] ));
 sky130_fd_sc_hd__dfrtp_4 _8441_ (.CLK(_0042_),
    .D(_0002_),
    .RESET_B(net254),
    .Q(\counter[10] ));
 sky130_fd_sc_hd__dfrtp_4 _8442_ (.CLK(_0043_),
    .D(_0003_),
    .RESET_B(net254),
    .Q(\counter[11] ));
 sky130_fd_sc_hd__dfrtp_1 _8443_ (.CLK(_0044_),
    .D(_0004_),
    .RESET_B(net254),
    .Q(\counter[12] ));
 sky130_fd_sc_hd__dfrtp_1 _8444_ (.CLK(_0045_),
    .D(_0005_),
    .RESET_B(net254),
    .Q(\counter[13] ));
 sky130_fd_sc_hd__dfrtp_1 _8445_ (.CLK(_0046_),
    .D(_0006_),
    .RESET_B(net253),
    .Q(\counter[14] ));
 sky130_fd_sc_hd__dfrtp_1 _8446_ (.CLK(_0047_),
    .D(_0007_),
    .RESET_B(net253),
    .Q(\counter[15] ));
 sky130_fd_sc_hd__dfstp_1 _8447_ (.CLK(_0048_),
    .D(_0000_),
    .SET_B(net255),
    .Q(rising));
 ...
 sky130_fd_sc_hd__buf_1 input1 (.A(periodTop[0]),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_1 input2 (.A(periodTop[10]),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(periodTop[11]),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_4 input4 (.A(periodTop[12]),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_1 input5 (.A(periodTop[13]),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_1 input6 (.A(periodTop[14]),
    .X(net6));
 sky130_fd_sc_hd__buf_2 input7 (.A(periodTop[15]),
    .X(net7));
 sky130_fd_sc_hd__buf_1 input8 (.A(periodTop[1]),
    .X(net8));
 sky130_fd_sc_hd__buf_2 input9 (.A(periodTop[2]),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_2 input10 (.A(periodTop[3]),
    .X(net10));
 sky130_fd_sc_hd__clkbuf_1 input11 (.A(periodTop[4]),
    .X(net11));
 sky130_fd_sc_hd__buf_2 input12 (.A(periodTop[5]),
    .X(net12));
 sky130_fd_sc_hd__clkbuf_1 input13 (.A(periodTop[6]),
    .X(net13));
 sky130_fd_sc_hd__clkbuf_2 input14 (.A(periodTop[7]),
    .X(net14));
 sky130_fd_sc_hd__buf_2 input15 (.A(periodTop[8]),
    .X(net15));
 sky130_fd_sc_hd__buf_2 input16 (.A(periodTop[9]),
    .X(net16));
 ...
 sky130_fd_sc_hd__buf_1 input36 (.A(vB[11]),
    .X(net36));
 sky130_fd_sc_hd__clkbuf_1 input37 (.A(vB[12]),
    .X(net37));
 sky130_fd_sc_hd__buf_1 input38 (.A(vB[13]),
    .X(net38));
 sky130_fd_sc_hd__buf_4 input39 (.A(vB[14]),
    .X(net39));
 sky130_fd_sc_hd__dlymetal6s2s_1 input40 (.A(vB[15]),
    .X(net40));
 sky130_fd_sc_hd__clkbuf_1 input41 (.A(vB[1]),
    .X(net41));
 sky130_fd_sc_hd__buf_2 input42 (.A(vB[2]),
    .X(net42));
 ...
 sky130_fd_sc_hd__clkbuf_1 input49 (.A(vB[9]),
    .X(net49));
 sky130_fd_sc_hd__buf_2 input50 (.A(vC[0]),
    .X(net50));
 ...
 sky130_fd_sc_hd__clkbuf_1 input53 (.A(vC[12]),
    .X(net53));
 sky130_fd_sc_hd__clkbuf_1 input54 (.A(vC[13]),
    .X(net54));
 ...
 sky130_fd_sc_hd__clkbuf_4 input61 (.A(vC[5]),
    .X(net61));
 sky130_fd_sc_hd__clkbuf_1 input62 (.A(vC[6]),
    .X(net62));
 ...
 sky130_fd_sc_hd__clkbuf_4 output69 (.A(net69),
    .X(pwmC));
 sky130_fd_sc_hd__clkbuf_1 max_cap70 (.A(_0839_),
    .X(net70));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout76 (.A(\counter[12] ),
    .X(net76));
 sky130_fd_sc_hd__clkbuf_4 fanout77 (.A(\counter[9] ),
    .X(net77));
 sky130_fd_sc_hd__clkbuf_4 fanout78 (.A(\counter[8] ),
    .X(net78));
 sky130_fd_sc_hd__clkbuf_4 fanout79 (.A(\counter[6] ),
    .X(net79));
 sky130_fd_sc_hd__clkbuf_4 fanout80 (.A(\counter[4] ),
    .X(net80));
 sky130_fd_sc_hd__buf_2 fanout81 (.A(\counter[2] ),
    .X(net81));
 sky130_fd_sc_hd__clkbuf_4 fanout82 (.A(\counter[1] ),
    .X(net82));
 sky130_fd_sc_hd__buf_1 wire83 (.A(_1298_),
    .X(net83));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout99 (.A(net100),
    .X(net99));
 sky130_fd_sc_hd__clkbuf_4 fanout100 (.A(net7),
    .X(net100));
 sky130_fd_sc_hd__clkbuf_2 fanout101 (.A(net7),
    .X(net101));
 sky130_fd_sc_hd__buf_2 fanout102 (.A(net7),
    .X(net102));
 ...
 sky130_fd_sc_hd__buf_2 fanout106 (.A(net65),
    .X(net106));
 sky130_fd_sc_hd__clkbuf_4 fanout107 (.A(net64),
    .X(net107));
 sky130_fd_sc_hd__buf_2 fanout108 (.A(net63),
    .X(net108));
 sky130_fd_sc_hd__buf_1 fanout109 (.A(net63),
    .X(net109));
 sky130_fd_sc_hd__buf_2 fanout110 (.A(net63),
    .X(net110));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout125 (.A(net126),
    .X(net125));
 sky130_fd_sc_hd__clkbuf_2 fanout126 (.A(net59),
    .X(net126));
 sky130_fd_sc_hd__clkbuf_2 fanout127 (.A(net58),
    .X(net127));
 sky130_fd_sc_hd__clkbuf_2 fanout128 (.A(net58),
    .X(net128));
 sky130_fd_sc_hd__clkbuf_2 fanout129 (.A(net58),
    .X(net129));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout138 (.A(net54),
    .X(net138));
 sky130_fd_sc_hd__buf_2 fanout139 (.A(net54),
    .X(net139));
 ...
 sky130_fd_sc_hd__buf_2 fanout144 (.A(net147),
    .X(net144));
 sky130_fd_sc_hd__buf_1 fanout145 (.A(net147),
    .X(net145));
 ...
 sky130_fd_sc_hd__buf_1 fanout149 (.A(net150),
    .X(net149));
 sky130_fd_sc_hd__clkbuf_2 fanout150 (.A(net157),
    .X(net150));
 ...
 sky130_fd_sc_hd__buf_2 fanout156 (.A(net157),
    .X(net156));
 sky130_fd_sc_hd__clkbuf_4 fanout157 (.A(net5),
    .X(net157));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout160 (.A(net161),
    .X(net160));
 sky130_fd_sc_hd__clkbuf_2 fanout161 (.A(net49),
    .X(net161));
 sky130_fd_sc_hd__clkbuf_4 fanout162 (.A(net48),
    .X(net162));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout165 (.A(net47),
    .X(net165));
 sky130_fd_sc_hd__clkbuf_2 fanout166 (.A(net46),
    .X(net166));
 sky130_fd_sc_hd__buf_2 fanout167 (.A(net46),
    .X(net167));
 sky130_fd_sc_hd__buf_2 fanout168 (.A(net170),
    .X(net168));
 sky130_fd_sc_hd__buf_2 fanout169 (.A(net170),
    .X(net169));
 sky130_fd_sc_hd__clkbuf_2 fanout170 (.A(net44),
    .X(net170));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout178 (.A(net40),
    .X(net178));
 sky130_fd_sc_hd__buf_2 fanout179 (.A(net40),
    .X(net179));
 ...
 sky130_fd_sc_hd__buf_1 fanout183 (.A(net184),
    .X(net183));
 sky130_fd_sc_hd__buf_1 fanout184 (.A(net4),
    .X(net184));
 sky130_fd_sc_hd__clkbuf_2 fanout185 (.A(net186),
    .X(net185));
 sky130_fd_sc_hd__buf_2 fanout186 (.A(net4),
    .X(net186));
 sky130_fd_sc_hd__clkbuf_4 fanout187 (.A(net38),
    .X(net187));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout190 (.A(net37),
    .X(net190));
 sky130_fd_sc_hd__clkbuf_4 fanout191 (.A(net36),
    .X(net191));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout192 (.A(net36),
    .X(net192));
 sky130_fd_sc_hd__buf_2 fanout193 (.A(net194),
    .X(net193));
 sky130_fd_sc_hd__clkbuf_2 fanout194 (.A(net35),
    .X(net194));
 sky130_fd_sc_hd__buf_2 fanout195 (.A(net35),
    .X(net195));
 ...
 sky130_fd_sc_hd__buf_2 fanout200 (.A(net33),
    .X(net200));
 sky130_fd_sc_hd__clkbuf_2 fanout201 (.A(net33),
    .X(net201));
 ...
 sky130_fd_sc_hd__buf_2 fanout210 (.A(net211),
    .X(net210));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout211 (.A(net218),
    .X(net211));
 ...
 sky130_fd_sc_hd__buf_2 fanout217 (.A(net218),
    .X(net217));
 sky130_fd_sc_hd__clkbuf_4 fanout218 (.A(net3),
    .X(net218));
 sky130_fd_sc_hd__buf_2 fanout219 (.A(net221),
    .X(net219));
 sky130_fd_sc_hd__clkbuf_2 fanout220 (.A(net221),
    .X(net220));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout221 (.A(net28),
    .X(net221));
 sky130_fd_sc_hd__buf_2 fanout222 (.A(net223),
    .X(net222));
 sky130_fd_sc_hd__clkbuf_2 fanout223 (.A(net27),
    .X(net223));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout230 (.A(net24),
    .X(net230));
 sky130_fd_sc_hd__clkbuf_4 fanout231 (.A(net22),
    .X(net231));
 ...
 sky130_fd_sc_hd__buf_2 fanout237 (.A(net238),
    .X(net237));
 sky130_fd_sc_hd__clkbuf_2 fanout238 (.A(net242),
    .X(net238));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout244 (.A(net245),
    .X(net244));
 sky130_fd_sc_hd__clkbuf_4 fanout245 (.A(net2),
    .X(net245));
 ...
 sky130_fd_sc_hd__buf_1 fanout250 (.A(net18),
    .X(net250));
 sky130_fd_sc_hd__clkbuf_2 fanout251 (.A(net18),
    .X(net251));
 ...
 sky130_fd_sc_hd__buf_4 fanout274 (.A(net275),
    .X(net274));
 sky130_fd_sc_hd__clkbuf_2 fanout275 (.A(net14),
    .X(net275));
 ...
 sky130_fd_sc_hd__buf_2 fanout281 (.A(net282),
    .X(net281));
 sky130_fd_sc_hd__buf_2 fanout282 (.A(net289),
    .X(net282));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout288 (.A(net289),
    .X(net288));
 sky130_fd_sc_hd__buf_4 fanout289 (.A(net13),
    .X(net289));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout292 (.A(net293),
    .X(net292));
 sky130_fd_sc_hd__clkbuf_4 fanout293 (.A(net12),
    .X(net293));
 ...
 sky130_fd_sc_hd__buf_2 fanout298 (.A(net299),
    .X(net298));
 sky130_fd_sc_hd__clkbuf_4 fanout299 (.A(net307),
    .X(net299));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout300 (.A(net307),
    .X(net300));
 ...
 sky130_fd_sc_hd__buf_2 fanout309 (.A(net310),
    .X(net309));
 sky130_fd_sc_hd__buf_2 fanout310 (.A(net10),
    .X(net310));
 sky130_fd_sc_hd__buf_2 fanout311 (.A(net315),
    .X(net311));
 sky130_fd_sc_hd__buf_2 fanout312 (.A(net315),
    .X(net312));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout313 (.A(net315),
    .X(net313));
