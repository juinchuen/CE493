module svm (clk,
 ...
 sky130_fd_sc_hd__or2b_1 _4317_ (.A(net158),
    .B_N(net273),
    .X(_1928_));
 sky130_fd_sc_hd__or2b_4 _4318_ (.A(net195),
    .B_N(net283),
    .X(_1939_));
 ...
 sky130_fd_sc_hd__nand2_1 _4489_ (.A(_3642_),
    .B(_3654_),
    .Y(_3655_));
 sky130_fd_sc_hd__or2b_4 _4490_ (.A(net175),
    .B_N(net118),
    .X(_3656_));
 ...
 sky130_fd_sc_hd__nand2_2 _4515_ (.A(_3671_),
    .B(_3673_),
    .Y(_3681_));
 sky130_fd_sc_hd__xnor2_4 _4516_ (.A(_3681_),
    .B(_3678_),
    .Y(_3682_));
 ...
 sky130_fd_sc_hd__nand2_1 _4598_ (.A(net86),
    .B(net179),
    .Y(_3764_));
 sky130_fd_sc_hd__xnor2_4 _4599_ (.A(_3762_),
    .B(_3764_),
    .Y(_3765_));
 ...
 sky130_fd_sc_hd__xnor2_2 _4622_ (.A(_3768_),
    .B(_3787_),
    .Y(_3788_));
 sky130_fd_sc_hd__or2b_4 _4623_ (.A(_3768_),
    .B_N(_3787_),
    .X(_3789_));
 ...
 sky130_fd_sc_hd__or2b_1 _4626_ (.A(_3766_),
    .B_N(_3790_),
    .X(_3792_));
 sky130_fd_sc_hd__a21bo_4 _4627_ (.A1(_3765_),
    .A2(_3791_),
    .B1_N(_3792_),
    .X(_3793_));
 sky130_fd_sc_hd__xnor2_2 _4628_ (.A(_3718_),
    .B(_3720_),
    .Y(_3794_));
 sky130_fd_sc_hd__xnor2_4 _4629_ (.A(_3793_),
    .B(net396),
    .Y(_3795_));
 sky130_fd_sc_hd__or2b_1 _4630_ (.A(_3793_),
    .B_N(_3794_),
    .X(_3796_));
 sky130_fd_sc_hd__a21boi_4 _4631_ (.A1(_3763_),
    .A2(_3795_),
    .B1_N(_3796_),
    .Y(_3797_));
 ...
 sky130_fd_sc_hd__a31o_1 _4674_ (.A1(net92),
    ...
    .B1(_3839_),
    .X(_3840_));
 sky130_fd_sc_hd__xnor2_4 _4675_ (.A(_3765_),
    .B(_3791_),
    .Y(_3841_));
 ...
 sky130_fd_sc_hd__a21boi_1 _4690_ (.A1(_3852_),
    ...
    .B1_N(_3855_),
    .Y(_3856_));
 sky130_fd_sc_hd__xnor2_4 _4691_ (.A(net367),
    .B(_3779_),
    .Y(_3857_));
 sky130_fd_sc_hd__xor2_4 _4692_ (.A(_3856_),
    .B(_3857_),
    .X(_3858_));
 ...
 sky130_fd_sc_hd__a21oi_2 _4707_ (.A1(_3840_),
    ...
    .B1(_3872_),
    .Y(_3873_));
 sky130_fd_sc_hd__or2_4 _4708_ (.A(_3799_),
    .B(net355),
    .X(_3874_));
 sky130_fd_sc_hd__nand2_1 _4709_ (.A(_3799_),
    .B(net356),
    .Y(_3875_));
 sky130_fd_sc_hd__and2_4 _4710_ (.A(_3875_),
    .B(_3874_),
    .X(_3876_));
 sky130_fd_sc_hd__xnor2_4 _4711_ (.A(_3840_),
    .B(net368),
    .Y(_3877_));
 ...
 sky130_fd_sc_hd__a21oi_1 _5180_ (.A1(_4022_),
    ...
    .B1(_0203_),
    .Y(_0204_));
 sky130_fd_sc_hd__nand2_4 _5181_ (.A(_3876_),
    .B(_0204_),
    .Y(_0205_));
 sky130_fd_sc_hd__nand2_4 _5182_ (.A(_0205_),
    .B(_3874_),
    .Y(_0206_));
 sky130_fd_sc_hd__xor2_2 _5183_ (.A(net370),
    .B(_0206_),
    .X(_0207_));
 sky130_fd_sc_hd__or2_4 _5184_ (.A(_3876_),
    .B(_0204_),
    .X(_0208_));
 sky130_fd_sc_hd__nand2_4 _5185_ (.A(_0205_),
    .B(_0208_),
    .Y(_0209_));
 ...
 sky130_fd_sc_hd__o21a_1 _5421_ (.A1(_3953_),
    ...
    .B1(_0202_),
    .X(_0445_));
 sky130_fd_sc_hd__xnor2_1 _5422_ (.A(net389),
    .B(_0445_),
    .Y(_0446_));
 ...
 sky130_fd_sc_hd__or2_1 _5425_ (.A(_0447_),
    .B(_0448_),
    .X(_0449_));
 sky130_fd_sc_hd__and2_4 _5426_ (.A(net81),
    .B(_0209_),
    .X(_0450_));
 sky130_fd_sc_hd__nor2_1 _5427_ (.A(\counter[0] ),
    .B(_0443_),
    .Y(_0451_));
 sky130_fd_sc_hd__or4_4 _5428_ (.A(_0444_),
    .B(_0449_),
    .C(_0450_),
    .D(_0451_),
    .X(_0452_));
 ...
 sky130_fd_sc_hd__nor2_1 _6126_ (.A(_1173_),
    .B(_1176_),
    .Y(_1192_));
 sky130_fd_sc_hd__a21oi_2 _6127_ (.A1(net377),
    .A2(_1191_),
    .B1(_1192_),
    .Y(_1193_));
 ...
 sky130_fd_sc_hd__nor2_1 _7404_ (.A(_2575_),
    .B(_2577_),
    .Y(_2581_));
 sky130_fd_sc_hd__a21oi_4 _7405_ (.A1(_2578_),
    .A2(_2580_),
    .B1(_2581_),
    .Y(_2582_));
 ...
 sky130_fd_sc_hd__buf_6 fanout258 (.A(net259),
    .X(net258));
 sky130_fd_sc_hd__buf_8 fanout259 (.A(net16),
    .X(net259));
 ...
 sky130_fd_sc_hd__buf_6 fanout274 (.A(net275),
    .X(net274));
 sky130_fd_sc_hd__buf_4 fanout275 (.A(net14),
    .X(net275));
 ...
 sky130_fd_sc_hd__buf_4 fanout283 (.A(net284),
    .X(net283));
 sky130_fd_sc_hd__buf_8 fanout284 (.A(net289),
    .X(net284));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout288 (.A(net289),
    .X(net288));
 sky130_fd_sc_hd__buf_8 fanout289 (.A(net13),
    .X(net289));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout292 (.A(net293),
    .X(net292));
 sky130_fd_sc_hd__buf_8 fanout293 (.A(net12),
    .X(net293));
 ...
 sky130_fd_sc_hd__buf_4 rebuffer1 (.A(_3783_),
    .X(net354));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(net358),
    .X(net355));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer3 (.A(net355),
    .X(net356));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(_0425_),
    .X(net357));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer5 (.A(net359),
    .X(net358));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer6 (.A(net360),
    .X(net359));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(net361),
    .X(net360));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer8 (.A(net362),
    .X(net361));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer9 (.A(net363),
    .X(net362));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(net364),
    .X(net363));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer11 (.A(_3873_),
    .X(net364));
 sky130_fd_sc_hd__buf_6 rebuffer12 (.A(_3864_),
    .X(net365));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer13 (.A(_4019_),
    .X(net366));
 sky130_fd_sc_hd__buf_6 rebuffer14 (.A(_3777_),
    .X(net367));
 sky130_fd_sc_hd__buf_4 rebuffer15 (.A(net388),
    .X(net368));
 sky130_fd_sc_hd__clkbuf_1 rebuffer16 (.A(_3877_),
    .X(net369));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer17 (.A(_3798_),
    .X(net370));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer18 (.A(_3944_),
    .X(net371));
 sky130_fd_sc_hd__buf_8 rebuffer19 (.A(_3766_),
    .X(net372));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer20 (.A(_2802_),
    .X(net373));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer21 (.A(_2737_),
    .X(net374));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer22 (.A(_2798_),
    .X(net375));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer23 (.A(_3740_),
    .X(net376));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer24 (.A(_1177_),
    .X(net377));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer25 (.A(_1353_),
    .X(net378));
 sky130_fd_sc_hd__buf_2 rebuffer26 (.A(_2330_),
    .X(net379));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer27 (.A(_2583_),
    .X(net380));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer28 (.A(_4013_),
    .X(net381));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer29 (.A(_0201_),
    .X(net382));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer30 (.A(net382),
    .X(net383));
 sky130_fd_sc_hd__clkbuf_1 rebuffer31 (.A(_4126_),
    .X(net384));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer32 (.A(_4126_),
    .X(net385));
 sky130_fd_sc_hd__clkbuf_2 rebuffer33 (.A(_3873_),
    .X(net386));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer34 (.A(_3873_),
    .X(net387));
 sky130_fd_sc_hd__clkbuf_1 rebuffer35 (.A(_3871_),
    .X(net388));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer36 (.A(_0420_),
    .X(net389));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer37 (.A(_2734_),
    .X(net390));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer38 (.A(_2734_),
    .X(net391));
 sky130_fd_sc_hd__buf_2 rebuffer39 (.A(_3863_),
    .X(net392));
 sky130_fd_sc_hd__clkbuf_16 clone40 (.A(net149),
    .X(net393));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer41 (.A(_1759_),
    .X(net394));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer42 (.A(net394),
    .X(net395));
 sky130_fd_sc_hd__buf_6 rebuffer43 (.A(_3794_),
    .X(net396));
 sky130_fd_sc_hd__buf_2 rebuffer44 (.A(_1760_),
    .X(net397));
 sky130_fd_sc_hd__clkbuf_16 clone45 (.A(net242),
    .X(net398));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer46 (.A(_3797_),
    .X(net399));
 sky130_fd_sc_hd__clkbuf_16 clone47 (.A(net240),
    .X(net400));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer48 (.A(_2668_),
    .X(net401));
 sky130_fd_sc_hd__buf_2 rebuffer49 (.A(_1475_),
    .X(net402));
