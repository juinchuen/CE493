module cordic (clk,
 ...
 sky130_fd_sc_hd__xor2_2 _4005_ (.A(_1175_),
    .B(_1174_),
    .X(_1176_));
 sky130_fd_sc_hd__nand2_4 _4006_ (.A(net73),
    .B(net81),
    .Y(_1177_));
 ...
 sky130_fd_sc_hd__nand2_4 _4009_ (.A(net81),
    .B(net87),
    .Y(_1180_));
 sky130_fd_sc_hd__xnor2_4 _4010_ (.A(_1179_),
    .B(_1180_),
    .Y(_1181_));
 ...
 sky130_fd_sc_hd__and2b_1 _4268_ (.A_N(_1430_),
    .B(_1429_),
    .X(_1439_));
 sky130_fd_sc_hd__xnor2_1 _4269_ (.A(_1343_),
    .B(_1439_),
    .Y(_1440_));
 ...
 sky130_fd_sc_hd__or2_1 _4296_ (.A(_1464_),
    .B(_1466_),
    .X(_1467_));
 sky130_fd_sc_hd__xnor2_1 _4297_ (.A(_1440_),
    .B(_1446_),
    .Y(_1468_));
 ...
 sky130_fd_sc_hd__a21oi_1 _4307_ (.A1(_1470_),
    ...
    .B1(_1477_),
    .Y(_1478_));
 sky130_fd_sc_hd__xnor2_1 _4308_ (.A(_1468_),
    .B(_1478_),
    .Y(_1479_));
 ...
 sky130_fd_sc_hd__buf_1 rebuffer1 (.A(_1095_),
    .X(net292));
