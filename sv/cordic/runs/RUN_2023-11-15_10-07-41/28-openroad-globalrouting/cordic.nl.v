module cordic (clk,
 ...
 sky130_fd_sc_hd__nand2_2 _4037_ (.A(net62),
    .B(net65),
    .Y(_1208_));
 sky130_fd_sc_hd__xor2_2 _4038_ (.A(net292),
    .B(_1208_),
    .X(_1209_));
 ...
 sky130_fd_sc_hd__or2_1 _4217_ (.A(_1349_),
    .B(_1351_),
    .X(_1388_));
 sky130_fd_sc_hd__and2_4 _4218_ (.A(_1343_),
    .B(_1350_),
    .X(_1389_));
 ...
 sky130_fd_sc_hd__nor2_1 _4265_ (.A(_1431_),
    .B(_1433_),
    .Y(_1436_));
 sky130_fd_sc_hd__or2_4 _4266_ (.A(_1434_),
    .B(_1436_),
    .X(_1437_));
 ...
 sky130_fd_sc_hd__and2b_1 _4306_ (.A_N(_1471_),
    .B(_1475_),
    .X(_1477_));
 sky130_fd_sc_hd__a21oi_4 _4307_ (.A1(_1470_),
    .A2(_1476_),
    .B1(_1477_),
    .Y(_1478_));
 ...
 sky130_fd_sc_hd__a21bo_1 _4313_ (.A1(_1464_),
    ...
    .B1_N(_1483_),
    .X(_1484_));
 sky130_fd_sc_hd__and2b_1 _4314_ (.A_N(_1484_),
    .B(_1457_),
    .X(_1485_));
 ...
 sky130_fd_sc_hd__buf_12 fanout70 (.A(net71),
    .X(net70));
 sky130_fd_sc_hd__buf_12 fanout71 (.A(net72),
    .X(net71));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout80 (.A(net81),
    .X(net80));
 sky130_fd_sc_hd__buf_4 fanout81 (.A(\vec[1][7] ),
    .X(net81));
 ...
 sky130_fd_sc_hd__buf_6 fanout89 (.A(net90),
    .X(net89));
 sky130_fd_sc_hd__buf_4 fanout90 (.A(\vec[1][4] ),
    .X(net90));
 ...
 sky130_fd_sc_hd__clkbuf_2 rebuffer1 (.A(_1095_),
    .X(net292));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(_1479_),
    .X(net293));
 sky130_fd_sc_hd__clkbuf_16 clone3 (.A(net71),
    .X(net294));
 sky130_fd_sc_hd__clkbuf_16 clone4 (.A(net72),
    .X(net295));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_3 (.DIODE(_1743_));
endmodule
