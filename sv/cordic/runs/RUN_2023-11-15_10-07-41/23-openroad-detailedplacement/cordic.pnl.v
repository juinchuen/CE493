module cordic (clk,
 ...
 sky130_fd_sc_hd__or2_1 _2350_ (.A(net154),
    ...
    .VPWR(VPWR),
    .X(_1742_));
 sky130_fd_sc_hd__buf_2 _2351_ (.A(_1742_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _2399_ (.A(_1762_),
    ...
    .VPWR(VPWR),
    .Y(_1791_));
 sky130_fd_sc_hd__clkbuf_4 _2400_ (.A(_1791_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _2401_ (.A(_1792_),
    ...
    .VPWR(VPWR),
    .X(_1793_));
 sky130_fd_sc_hd__buf_2 _2402_ (.A(_1793_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1794_));
 sky130_fd_sc_hd__nor2_1 _2403_ (.A(net152),
    .B(_1743_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _2410_ (.A(net153),
    ...
    .VPWR(VPWR),
    .Y(_1802_));
 sky130_fd_sc_hd__buf_2 _2411_ (.A(_1802_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _2431_ (.A(net153),
    ...
    .VPWR(VPWR),
    .Y(_1823_));
 sky130_fd_sc_hd__mux4_1 _2432_ (.A0(net126),
    .A1(net123),
    .A2(net122),
    .A3(net118),
    .S0(net164),
 ...
 sky130_fd_sc_hd__or2b_1 _2446_ (.A(net154),
    ...
    .VPWR(VPWR),
    .X(_1838_));
 sky130_fd_sc_hd__buf_2 _2447_ (.A(_1838_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1839_));
 sky130_fd_sc_hd__mux4_1 _2448_ (.A0(net140),
    .A1(net138),
    .A2(net132),
    .A3(net129),
    .S0(net164),
 ...
 sky130_fd_sc_hd__inv_2 _2449_ (.A(net152),
    ...
    .VPWR(VPWR),
    .Y(_1841_));
 sky130_fd_sc_hd__buf_2 _2450_ (.A(_1841_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _2460_ (.A(_1841_),
    ...
    .VPWR(VPWR),
    .X(_1852_));
 sky130_fd_sc_hd__and3_2 _2461_ (.A(net152),
    .B(_1830_),
    .C(_1804_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux4_1 _2463_ (.A0(_1806_),
    ...
    .VPWR(VPWR),
    .X(_1855_));
 sky130_fd_sc_hd__a22o_1 _2464_ (.A1(net104),
    .A2(_1853_),
    .B1(_1855_),
    .B2(_1841_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2469_ (.A(_1852_),
    ...
    .VPWR(VPWR),
    .X(_1861_));
 sky130_fd_sc_hd__nor2_1 _2470_ (.A(_1849_),
    .B(_1861_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4_1 _2477_ (.A(_1818_),
    ...
    .VPWR(VPWR),
    .X(_1869_));
 sky130_fd_sc_hd__nor2_1 _2478_ (.A(_1815_),
    .B(_1869_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2493_ (.A(_1810_),
    ...
    .VPWR(VPWR),
    .Y(_1885_));
 sky130_fd_sc_hd__and2_1 _2494_ (.A(net66),
    .B(_1885_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2503_ (.A(_1818_),
    ...
    .VPWR(VPWR),
    .Y(_1895_));
 sky130_fd_sc_hd__nand2_1 _2504_ (.A(net71),
    .B(_1895_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1896_));
 sky130_fd_sc_hd__or2_1 _2505_ (.A(net71),
    .B(_1895_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _2551_ (.A1(_1923_),
    ...
    .VPWR(VPWR),
    .X(_1943_));
 sky130_fd_sc_hd__a21boi_1 _2552_ (.A1(_1919_),
    .A2(_1943_),
    .B1_N(_1917_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2555_ (.A(net74),
    ...
    .VPWR(VPWR),
    .Y(_1947_));
 sky130_fd_sc_hd__o311a_1 _2556_ (.A1(_1906_),
    .A2(_1909_),
    .A3(_1946_),
    .B1(_1904_),
    .C1(_1947_),
 ...
 sky130_fd_sc_hd__or2_1 _2563_ (.A(net63),
    ...
    .VPWR(VPWR),
    .X(_1955_));
 sky130_fd_sc_hd__o21ai_1 _2564_ (.A1(_1886_),
    .A2(_1954_),
    .B1(_1955_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _2575_ (.A(net169),
    ...
    .VPWR(VPWR),
    .Y(_1967_));
 sky130_fd_sc_hd__clkbuf_4 _2576_ (.A(_1967_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _2577_ (.A(_1968_),
    ...
    .VPWR(VPWR),
    .Y(_1969_));
 sky130_fd_sc_hd__clkbuf_4 _2578_ (.A(_1969_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__o32ai_1 _2597_ (.A1(_1954_),
    ...
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__clkbuf_4 _2598_ (.A(_1969_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _2625_ (.A(_1923_),
    ...
    .VPWR(VPWR),
    .X(_2005_));
 sky130_fd_sc_hd__clkbuf_4 _2626_ (.A(_1968_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _2641_ (.A(_1967_),
    ...
    .VPWR(VPWR),
    .X(_2016_));
 sky130_fd_sc_hd__clkbuf_4 _2642_ (.A(_2016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _2687_ (.A1(net55),
    ...
    .VPWR(VPWR),
    .X(_2046_));
 sky130_fd_sc_hd__mux4_1 _2688_ (.A0(net68),
    .A1(net66),
    .A2(net63),
    .A3(net60),
    .S0(net163),
 ...
 sky130_fd_sc_hd__nor2_1 _2691_ (.A(_1811_),
    ...
    .VPWR(VPWR),
    .Y(_2050_));
 sky130_fd_sc_hd__mux4_1 _2692_ (.A0(net71),
    .A1(net68),
    .A2(net66),
    .A3(net63),
    .S0(net163),
 ...
 sky130_fd_sc_hd__mux4_1 _2712_ (.A0(_2068_),
    ...
    .VPWR(VPWR),
    .X(_2071_));
 sky130_fd_sc_hd__a22o_1 _2713_ (.A1(net55),
    .A2(_1853_),
    .B1(_2071_),
    .B2(_1841_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _2741_ (.A1(_1793_),
    ...
    .VPWR(VPWR),
    .X(_2100_));
 sky130_fd_sc_hd__o21ai_1 _2742_ (.A1(_1793_),
    .A2(_2053_),
    .B1(_2100_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _2816_ (.A(net119),
    ...
    .VPWR(VPWR),
    .Y(_2175_));
 sky130_fd_sc_hd__xnor2_1 _2817_ (.A(_2050_),
    .B(_2101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2894_ (.A(_2236_),
    ...
    .VPWR(VPWR),
    .X(_0164_));
 sky130_fd_sc_hd__nor2_1 _2895_ (.A(_1743_),
    .B(_2096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4b_1 _2913_ (.A_N(_2251_),
    ...
    .VPWR(VPWR),
    .X(_2255_));
 sky130_fd_sc_hd__and2_1 _2914_ (.A(_2250_),
    .B(_2255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _2929_ (.A0(_2259_),
    ...
    .VPWR(VPWR),
    .X(_2271_));
 sky130_fd_sc_hd__nand2_1 _2930_ (.A(\slte0.opA[11] ),
    .B(_2271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _2980_ (.A(\slte0.opA[8] ),
    ...
    .VPWR(VPWR),
    .X(_2322_));
 sky130_fd_sc_hd__a31o_1 _2981_ (.A1(_2283_),
    .A2(_2286_),
    .A3(_2321_),
    .B1(_2322_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3070_ (.A(_0257_),
    ...
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__buf_4 _3071_ (.A(_2233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xor2_4 _3114_ (.A(net110),
    ...
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__o21ai_1 _3115_ (.A1(net112),
    .A2(_0301_),
    .B1(net118),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _3121_ (.A0(net112),
    ...
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__xnor2_1 _3122_ (.A(_0302_),
    .B(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3132_ (.A(_0317_),
    ...
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__or3b_1 _3133_ (.A(_2170_),
    .B(_0313_),
    .C_N(_0319_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _3136_ (.A1(_2170_),
    ...
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__and3_1 _3137_ (.A(net106),
    .B(net111),
    .C(_0265_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3149_ (.A(_0264_),
    ...
    .VPWR(VPWR),
    .Y(_0336_));
 sky130_fd_sc_hd__xnor2_1 _3150_ (.A(net103),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0337_));
 sky130_fd_sc_hd__xnor2_1 _3151_ (.A(_0336_),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _3165_ (.A_N(_0350_),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__xnor2_1 _3166_ (.A(_0338_),
    .B(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_4 _3175_ (.A(net116),
    ...
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__o21ai_1 _3176_ (.A1(net118),
    .A2(_0362_),
    .B1(net123),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _3194_ (.A(\vec[0][8] ),
    ...
    .VPWR(VPWR),
    .Y(_0381_));
 sky130_fd_sc_hd__xor2_1 _3195_ (.A(_0353_),
    .B(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _3202_ (.A(_0362_),
    ...
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__nand2_1 _3203_ (.A(net120),
    .B(net123),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_1 _3230_ (.A1(_0398_),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__xor2_1 _3231_ (.A(_0381_),
    .B(_0382_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3238_ (.A(_0267_),
    ...
    .VPWR(VPWR),
    .Y(_0425_));
 sky130_fd_sc_hd__xor2_1 _3239_ (.A(net109),
    .B(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3260_ (.A(net112),
    ...
    .VPWR(VPWR),
    .Y(_0447_));
 sky130_fd_sc_hd__and2_1 _3261_ (.A(net112),
    .B(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3266_ (.A(_0307_),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__xnor2_1 _3267_ (.A(_0362_),
    .B(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__xnor2_1 _3268_ (.A(_0390_),
    .B(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3270_ (.A(_0446_),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__xor2_2 _3271_ (.A(net124),
    .B(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _3273_ (.A(_0434_),
    ...
    .VPWR(VPWR),
    .Y(_0460_));
 sky130_fd_sc_hd__nand2_1 _3274_ (.A(net124),
    .B(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3295_ (.A(_0465_),
    ...
    .VPWR(VPWR),
    .Y(_0482_));
 sky130_fd_sc_hd__xnor2_1 _3296_ (.A(_0481_),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _3297_ (.A(_0452_),
    ...
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__xor2_1 _3298_ (.A(_0484_),
    .B(_0455_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3303_ (.A(_0488_),
    ...
    .VPWR(VPWR),
    .X(_0490_));
 sky130_fd_sc_hd__a21oi_1 _3304_ (.A1(_0283_),
    .A2(_0490_),
    .B1(_0324_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _3309_ (.A_N(_0491_),
    ...
    .VPWR(VPWR),
    .X(_0496_));
 sky130_fd_sc_hd__a21oi_1 _3310_ (.A1(_0492_),
    .A2(_0495_),
    .B1(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0497_));
 sky130_fd_sc_hd__xnor2_1 _3311_ (.A(_0485_),
    .B(_0497_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_4 _3312_ (.A(net126),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__o21ai_1 _3313_ (.A1(net131),
    .A2(_0499_),
    .B1(net136),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3320_ (.A(_0505_),
    ...
    .VPWR(VPWR),
    .Y(_0507_));
 sky130_fd_sc_hd__xnor2_1 _3321_ (.A(_0500_),
    .B(_0507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _3325_ (.A_N(_0500_),
    ...
    .VPWR(VPWR),
    .X(_0512_));
 sky130_fd_sc_hd__o21ai_1 _3326_ (.A1(_0505_),
    .A2(_0512_),
    .B1(net141),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _3350_ (.A1(_0518_),
    ...
    .VPWR(VPWR),
    .X(_0537_));
 sky130_fd_sc_hd__xnor2_1 _3351_ (.A(_0498_),
    .B(_0508_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _3352_ (.A(_0492_),
    ...
    .VPWR(VPWR),
    .Y(_0539_));
 sky130_fd_sc_hd__xor2_1 _3353_ (.A(_0283_),
    .B(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3357_ (.A(net109),
    ...
    .VPWR(VPWR),
    .X(_0544_));
 sky130_fd_sc_hd__a21oi_1 _3358_ (.A1(_0304_),
    .A2(_0543_),
    .B1(_0544_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0545_));
 sky130_fd_sc_hd__xnor2_1 _3359_ (.A(_0540_),
    .B(_0545_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3362_ (.A(_0547_),
    ...
    .VPWR(VPWR),
    .Y(_0549_));
 sky130_fd_sc_hd__xnor2_1 _3363_ (.A(_0461_),
    .B(_0549_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_4 _3367_ (.A(net129),
    ...
    .VPWR(VPWR),
    .X(_0554_));
 sky130_fd_sc_hd__o21ai_1 _3368_ (.A1(net134),
    .A2(_0554_),
    .B1(net141),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3372_ (.A(net137),
    ...
    .VPWR(VPWR),
    .Y(_0559_));
 sky130_fd_sc_hd__a21oi_1 _3373_ (.A1(net137),
    .A2(_0558_),
    .B1(_0559_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0560_));
 sky130_fd_sc_hd__xor2_1 _3374_ (.A(_0556_),
    .B(_0560_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0561_));
 sky130_fd_sc_hd__xnor2_1 _3375_ (.A(_0555_),
    .B(_0561_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3376_ (.A(_0539_),
    ...
    .VPWR(VPWR),
    .Y(_0563_));
 sky130_fd_sc_hd__a21oi_1 _3377_ (.A1(_0553_),
    .A2(_0562_),
    .B1(_0563_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _3380_ (.A_N(_0555_),
    ...
    .VPWR(VPWR),
    .X(_0567_));
 sky130_fd_sc_hd__o21ai_1 _3381_ (.A1(_0566_),
    .A2(_0567_),
    .B1(\vec[0][3] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3431_ (.A(_0617_),
    ...
    .VPWR(VPWR),
    .Y(_0618_));
 sky130_fd_sc_hd__xnor2_1 _3432_ (.A(_0546_),
    .B(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3476_ (.A(_0557_),
    ...
    .VPWR(VPWR),
    .Y(_0663_));
 sky130_fd_sc_hd__xor2_1 _3477_ (.A(_0326_),
    .B(_0623_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _3481_ (.A1(_0367_),
    ...
    .VPWR(VPWR),
    .X(_0668_));
 sky130_fd_sc_hd__xor2_1 _3482_ (.A(_0664_),
    .B(_0668_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3559_ (.A(net143),
    ...
    .VPWR(VPWR),
    .Y(_0746_));
 sky130_fd_sc_hd__nor2_1 _3560_ (.A(_0741_),
    .B(_0746_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3590_ (.A(_0775_),
    ...
    .VPWR(VPWR),
    .Y(_0777_));
 sky130_fd_sc_hd__xor2_1 _3591_ (.A(_0558_),
    .B(_0777_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3595_ (.A(net135),
    ...
    .VPWR(VPWR),
    .X(_0782_));
 sky130_fd_sc_hd__a21oi_1 _3596_ (.A1(_0606_),
    .A2(_0781_),
    .B1(_0782_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0783_));
 sky130_fd_sc_hd__xnor2_1 _3597_ (.A(_0778_),
    .B(_0783_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3598_ (.A(net145),
    ...
    .VPWR(VPWR),
    .X(_0785_));
 sky130_fd_sc_hd__dlymetal6s2s_1 _3599_ (.A(_0785_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3600_ (.A(net145),
    ...
    .VPWR(VPWR),
    .Y(_0787_));
 sky130_fd_sc_hd__nor2_1 _3601_ (.A(_0786_),
    .B(_0787_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0788_));
 sky130_fd_sc_hd__xor2_1 _3602_ (.A(_0788_),
    .B(_0779_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0789_));
 sky130_fd_sc_hd__xnor2_1 _3603_ (.A(_0784_),
    .B(_0789_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3621_ (.A(net130),
    ...
    .VPWR(VPWR),
    .X(_0808_));
 sky130_fd_sc_hd__a21oi_1 _3622_ (.A1(_0558_),
    .A2(_0777_),
    .B1(_0808_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3685_ (.A(_0695_),
    ...
    .VPWR(VPWR),
    .Y(_0872_));
 sky130_fd_sc_hd__xor2_1 _3686_ (.A(_0440_),
    .B(_0755_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3687_ (.A(net124),
    ...
    .VPWR(VPWR),
    .X(_0874_));
 sky130_fd_sc_hd__a21oi_1 _3688_ (.A1(_0462_),
    .A2(_0850_),
    .B1(_0874_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0875_));
 sky130_fd_sc_hd__xnor2_1 _3689_ (.A(_0873_),
    .B(_0875_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _3743_ (.A_N(_0386_),
    ...
    .VPWR(VPWR),
    .X(_0930_));
 sky130_fd_sc_hd__xnor2_1 _3744_ (.A(_0418_),
    .B(_0417_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 _3764_ (.A(_2233_),
    ...
    .VPWR(VPWR),
    .X(_0950_));
 sky130_fd_sc_hd__clkbuf_8 _3765_ (.A(_0950_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0951_));
 sky130_fd_sc_hd__a22o_1 _3766_ (.A1(net24),
    .A2(_0947_),
    .B1(_0949_),
    .B2(_0951_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3768_ (.A(_0281_),
    ...
    .VPWR(VPWR),
    .Y(_0953_));
 sky130_fd_sc_hd__a22o_1 _3769_ (.A1(net23),
    .A2(_0947_),
    .B1(_0953_),
    .B2(_0951_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3771_ (.A(_2014_),
    ...
    .VPWR(VPWR),
    .Y(_0955_));
 sky130_fd_sc_hd__a22o_1 _3772_ (.A1(net22),
    .A2(_0947_),
    .B1(_0954_),
    .B2(_0955_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3788_ (.A(_2014_),
    ...
    .VPWR(VPWR),
    .Y(_0968_));
 sky130_fd_sc_hd__a22o_1 _3789_ (.A1(net33),
    .A2(_0947_),
    .B1(_0967_),
    .B2(_0968_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _3794_ (.A(_0587_),
    ...
    .VPWR(VPWR),
    .X(_0973_));
 sky130_fd_sc_hd__a22o_1 _3795_ (.A1(net32),
    .A2(_0947_),
    .B1(_0973_),
    .B2(_0951_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _3800_ (.A(_0925_),
    ...
    .VPWR(VPWR),
    .X(_0977_));
 sky130_fd_sc_hd__a22o_1 _3801_ (.A1(net30),
    .A2(_0947_),
    .B1(_0977_),
    .B2(_0951_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3802_ (.A(_0924_),
    ...
    .VPWR(VPWR),
    .Y(_0978_));
 sky130_fd_sc_hd__a22o_1 _3803_ (.A1(net29),
    .A2(_0947_),
    .B1(_0978_),
    .B2(_0951_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3813_ (.A(_0983_),
    ...
    .VPWR(VPWR),
    .Y(_0986_));
 sky130_fd_sc_hd__a22o_1 _3814_ (.A1(net26),
    .A2(_0946_),
    .B1(_0986_),
    .B2(_0951_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _3851_ (.A(net53),
    ...
    .VPWR(VPWR),
    .X(_1022_));
 sky130_fd_sc_hd__nand2_1 _3852_ (.A(net58),
    .B(_1022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3873_ (.A(_1014_),
    ...
    .VPWR(VPWR),
    .X(_1044_));
 sky130_fd_sc_hd__o21ai_1 _3874_ (.A1(_1038_),
    .A2(_1042_),
    .B1(_1044_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _3883_ (.A(net56),
    ...
    .VPWR(VPWR),
    .X(_1054_));
 sky130_fd_sc_hd__nand2_1 _3884_ (.A(net62),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3907_ (.A(_1077_),
    ...
    .VPWR(VPWR),
    .X(_1078_));
 sky130_fd_sc_hd__a211oi_1 _3908_ (.A1(_1045_),
    .A2(_1048_),
    .B1(_1021_),
    .C1(_1020_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _3918_ (.A1(_1027_),
    ...
    .VPWR(VPWR),
    .Y(_1089_));
 sky130_fd_sc_hd__nand2_1 _3919_ (.A(net65),
    .B(net70),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _3952_ (.A(_1095_),
    ...
    .VPWR(VPWR),
    .Y(_1123_));
 sky130_fd_sc_hd__nand2_2 _3953_ (.A(net67),
    .B(net73),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _3955_ (.A0(_1123_),
    ...
    .VPWR(VPWR),
    .X(_1126_));
 sky130_fd_sc_hd__xor2_1 _3956_ (.A(_1122_),
    .B(_1126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_4 _3957_ (.A(net68),
    ...
    .VPWR(VPWR),
    .X(_1128_));
 sky130_fd_sc_hd__o21ai_2 _3958_ (.A1(net71),
    .A2(_1128_),
    .B1(net78),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1129_));
 sky130_fd_sc_hd__xor2_1 _3959_ (.A(_1127_),
    .B(_1129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3974_ (.A(_1106_),
    ...
    .VPWR(VPWR),
    .Y(_1145_));
 sky130_fd_sc_hd__a21oi_1 _3975_ (.A1(_1139_),
    .A2(_1144_),
    .B1(_1145_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o221a_1 _3986_ (.A1(_1049_),
    ...
    .VPWR(VPWR),
    .X(_1157_));
 sky130_fd_sc_hd__nand2_1 _3987_ (.A(net70),
    .B(net73),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _3994_ (.A(_1163_),
    ...
    .VPWR(VPWR),
    .Y(_1165_));
 sky130_fd_sc_hd__nor2_1 _3995_ (.A(net90),
    .B(_1163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1166_));
 sky130_fd_sc_hd__a21oi_1 _3996_ (.A1(net90),
    .A2(_1165_),
    .B1(_1166_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _4002_ (.A(_1935_),
    ...
    .VPWR(VPWR),
    .X(_1173_));
 sky130_fd_sc_hd__nand2_1 _4003_ (.A(net68),
    .B(net70),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_4 _4004_ (.A(net70),
    ...
    .VPWR(VPWR),
    .X(_1175_));
 sky130_fd_sc_hd__xor2_1 _4005_ (.A(_1175_),
    .B(_1174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1176_));
 sky130_fd_sc_hd__nand2_2 _4006_ (.A(net73),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_4 _4008_ (.A(net77),
    ...
    .VPWR(VPWR),
    .X(_1179_));
 sky130_fd_sc_hd__nand2_2 _4009_ (.A(net81),
    .B(net87),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _4020_ (.A1(net81),
    ...
    .VPWR(VPWR),
    .Y(_1191_));
 sky130_fd_sc_hd__nand2_1 _4021_ (.A(net65),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1192_));
 sky130_fd_sc_hd__xor2_1 _4022_ (.A(_1128_),
    .B(_1192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1193_));
 sky130_fd_sc_hd__nand2_2 _4023_ (.A(net71),
    .B(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1194_));
 sky130_fd_sc_hd__o22ai_2 _4024_ (.A1(net73),
    .A2(_1192_),
    .B1(_1193_),
    .B2(_1194_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _4042_ (.A1(_1207_),
    ...
    .VPWR(VPWR),
    .Y(_1213_));
 sky130_fd_sc_hd__and2_1 _4043_ (.A(_1212_),
    .B(_1213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1214_));
 sky130_fd_sc_hd__xnor2_1 _4044_ (.A(_1194_),
    .B(_1193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _4050_ (.A(_1216_),
    ...
    .VPWR(VPWR),
    .X(_1221_));
 sky130_fd_sc_hd__o21ai_1 _4051_ (.A1(_1215_),
    .A2(_1220_),
    .B1(_1221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1222_));
 sky130_fd_sc_hd__xnor2_1 _4052_ (.A(_1214_),
    .B(_1222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1223_));
 sky130_fd_sc_hd__xnor2_1 _4053_ (.A(_1202_),
    .B(_1223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _4067_ (.A(_1227_),
    ...
    .VPWR(VPWR),
    .X(_1238_));
 sky130_fd_sc_hd__o21ai_1 _4068_ (.A1(_1226_),
    .A2(_1237_),
    .B1(_1238_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1239_));
 sky130_fd_sc_hd__xor2_1 _4069_ (.A(_1224_),
    .B(_1239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _4071_ (.A(net96),
    ...
    .VPWR(VPWR),
    .Y(_1242_));
 sky130_fd_sc_hd__xor2_1 _4072_ (.A(_1226_),
    .B(_1237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _4076_ (.A(_1161_),
    ...
    .VPWR(VPWR),
    .Y(_1247_));
 sky130_fd_sc_hd__xnor2_1 _4077_ (.A(_1028_),
    .B(_1231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _4078_ (.A(net70),
    ...
    .VPWR(VPWR),
    .X(_1249_));
 sky130_fd_sc_hd__and2_1 _4079_ (.A(_1158_),
    .B(_1249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _4080_ (.A(net63),
    ...
    .VPWR(VPWR),
    .X(_1251_));
 sky130_fd_sc_hd__a21oi_1 _4081_ (.A1(_1056_),
    .A2(_1250_),
    .B1(_1251_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1252_));
 sky130_fd_sc_hd__xnor2_1 _4082_ (.A(_1248_),
    .B(_1252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _4087_ (.A1(_1245_),
    ...
    .VPWR(VPWR),
    .X(_1258_));
 sky130_fd_sc_hd__xnor2_1 _4088_ (.A(_1243_),
    .B(_1258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _4090_ (.A1(_1242_),
    ...
    .VPWR(VPWR),
    .Y(_1261_));
 sky130_fd_sc_hd__xnor2_1 _4091_ (.A(_1241_),
    .B(_1261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _4094_ (.A(_1195_),
    ...
    .VPWR(VPWR),
    .X(_1265_));
 sky130_fd_sc_hd__o21ai_1 _4095_ (.A1(_1265_),
    .A2(_1200_),
    .B1(net90),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1266_));
 sky130_fd_sc_hd__or3_1 _4096_ (.A(net90),
    .B(_1265_),
    .C(_1200_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _4097_ (.A(_1266_),
    ...
    .VPWR(VPWR),
    .X(_1268_));
 sky130_fd_sc_hd__o22ai_4 _4098_ (.A1(net70),
    .A2(_1208_),
    .B1(_1209_),
    .B2(_1124_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _4100_ (.A(net81),
    ...
    .VPWR(VPWR),
    .Y(_1271_));
 sky130_fd_sc_hd__a21oi_1 _4101_ (.A1(net81),
    .A2(_1270_),
    .B1(_1271_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _4116_ (.A(_1214_),
    ...
    .VPWR(VPWR),
    .X(_1287_));
 sky130_fd_sc_hd__a21oi_1 _4117_ (.A1(_1202_),
    .A2(_1286_),
    .B1(_1287_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4124_ (.A_N(_1264_),
    ...
    .VPWR(VPWR),
    .X(_1295_));
 sky130_fd_sc_hd__xor2_1 _4125_ (.A(_1173_),
    .B(_1262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _4126_ (.A(net99),
    ...
    .VPWR(VPWR),
    .Y(_1297_));
 sky130_fd_sc_hd__nand2_1 _4127_ (.A(net73),
    .B(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1298_));
 sky130_fd_sc_hd__xor2_1 _4128_ (.A(_1179_),
    .B(_1298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _4129_ (.A1(net82),
    ...
    .VPWR(VPWR),
    .Y(_1300_));
 sky130_fd_sc_hd__nand2_1 _4130_ (.A(net87),
    .B(net93),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _4132_ (.A(net93),
    ...
    .VPWR(VPWR),
    .Y(_1303_));
 sky130_fd_sc_hd__a21oi_1 _4133_ (.A1(net93),
    .A2(_1302_),
    .B1(_1303_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4143_ (.A_N(_1307_),
    ...
    .VPWR(VPWR),
    .X(_1314_));
 sky130_fd_sc_hd__or2_1 _4144_ (.A(_1308_),
    .B(_1314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1315_));
 sky130_fd_sc_hd__xnor2_1 _4145_ (.A(_1247_),
    .B(_1253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1316_));
 sky130_fd_sc_hd__xnor2_1 _4146_ (.A(_1180_),
    .B(_1299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1317_));
 sky130_fd_sc_hd__xnor2_1 _4147_ (.A(_1056_),
    .B(_1250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _4148_ (.A(net73),
    ...
    .VPWR(VPWR),
    .X(_1319_));
 sky130_fd_sc_hd__and2_1 _4149_ (.A(_1298_),
    .B(_1319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _4150_ (.A(net65),
    ...
    .VPWR(VPWR),
    .X(_1321_));
 sky130_fd_sc_hd__a21oi_1 _4151_ (.A1(_1091_),
    .A2(_1320_),
    .B1(_1321_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1322_));
 sky130_fd_sc_hd__xnor2_1 _4152_ (.A(_1318_),
    .B(_1322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _4154_ (.A1(_1317_),
    ...
    .VPWR(VPWR),
    .X(_1325_));
 sky130_fd_sc_hd__xnor2_1 _4155_ (.A(_1316_),
    .B(_1325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _4171_ (.A1(net82),
    ...
    .VPWR(VPWR),
    .X(_1342_));
 sky130_fd_sc_hd__nand2_2 _4172_ (.A(net88),
    .B(net94),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _4186_ (.A(_1355_),
    ...
    .VPWR(VPWR),
    .X(_1357_));
 sky130_fd_sc_hd__xor2_1 _4187_ (.A(_1315_),
    .B(_1326_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _4188_ (.A(_1348_),
    ...
    .VPWR(VPWR),
    .Y(_1359_));
 sky130_fd_sc_hd__or2_1 _4189_ (.A(_1354_),
    .B(_1359_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1360_));
 sky130_fd_sc_hd__xnor2_1 _4190_ (.A(_1317_),
    .B(_1323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _4192_ (.A(_1164_),
    ...
    .VPWR(VPWR),
    .Y(_1363_));
 sky130_fd_sc_hd__xor2_1 _4193_ (.A(_1091_),
    .B(_1320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _4196_ (.A(net68),
    ...
    .VPWR(VPWR),
    .X(_1367_));
 sky130_fd_sc_hd__a21oi_1 _4197_ (.A1(_1125_),
    .A2(_1366_),
    .B1(_1367_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1368_));
 sky130_fd_sc_hd__xnor2_1 _4198_ (.A(_1364_),
    .B(_1368_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _4199_ (.A_N(_1368_),
    ...
    .VPWR(VPWR),
    .X(_1370_));
 sky130_fd_sc_hd__a21oi_1 _4200_ (.A1(_1363_),
    .A2(_1369_),
    .B1(_1370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1371_));
 sky130_fd_sc_hd__xnor2_1 _4201_ (.A(_1361_),
    .B(_1371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _4203_ (.A1(_1360_),
    ...
    .VPWR(VPWR),
    .X(_1374_));
 sky130_fd_sc_hd__xnor2_1 _4204_ (.A(_1358_),
    .B(_1374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _4211_ (.A1(_1378_),
    ...
    .VPWR(VPWR),
    .Y(_1382_));
 sky130_fd_sc_hd__xnor2_1 _4212_ (.A(_1357_),
    .B(_1375_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4213_ (.A(net80),
    ...
    .VPWR(VPWR),
    .Y(_1384_));
 sky130_fd_sc_hd__or2b_1 _4214_ (.A(_1168_),
    .B_N(_1384_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _4220_ (.A1(net99),
    ...
    .VPWR(VPWR),
    .X(_1391_));
 sky130_fd_sc_hd__xnor2_1 _4221_ (.A(_1387_),
    .B(_1391_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1392_));
 sky130_fd_sc_hd__xor2_1 _4222_ (.A(net92),
    .B(net98),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _4226_ (.A1(_1392_),
    ...
    .VPWR(VPWR),
    .X(_1397_));
 sky130_fd_sc_hd__xor2_1 _4227_ (.A(_1360_),
    .B(_1372_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1398_));
 sky130_fd_sc_hd__xnor2_1 _4228_ (.A(_1392_),
    .B(_1395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1399_));
 sky130_fd_sc_hd__xnor2_1 _4229_ (.A(_1363_),
    .B(_1369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _4230_ (.A_N(_1386_),
    ...
    .VPWR(VPWR),
    .X(_1401_));
 sky130_fd_sc_hd__xnor2_1 _4231_ (.A(_1301_),
    .B(_1401_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1402_));
 sky130_fd_sc_hd__xor2_1 _4232_ (.A(_1125_),
    .B(_1366_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _4234_ (.A(net80),
    ...
    .VPWR(VPWR),
    .X(_1405_));
 sky130_fd_sc_hd__and2_1 _4235_ (.A(_1384_),
    .B(_1405_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _4236_ (.A(net71),
    ...
    .VPWR(VPWR),
    .X(_1407_));
 sky130_fd_sc_hd__a21oi_1 _4237_ (.A1(_1404_),
    .A2(_1406_),
    .B1(_1407_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1408_));
 sky130_fd_sc_hd__xnor2_1 _4238_ (.A(_1403_),
    .B(_1408_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1409_));
 sky130_fd_sc_hd__and2b_1 _4239_ (.A_N(_1408_),
    .B(_1403_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1410_));
 sky130_fd_sc_hd__a21oi_1 _4240_ (.A1(_1402_),
    .A2(_1409_),
    .B1(_1410_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1411_));
 sky130_fd_sc_hd__xnor2_1 _4241_ (.A(_1400_),
    .B(_1411_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _4243_ (.A1(_1399_),
    ...
    .VPWR(VPWR),
    .X(_1414_));
 sky130_fd_sc_hd__xnor2_1 _4244_ (.A(_1398_),
    .B(_1414_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _4245_ (.A_N(_1414_),
    ...
    .VPWR(VPWR),
    .X(_1416_));
 sky130_fd_sc_hd__a21oi_1 _4246_ (.A1(_1397_),
    .A2(_1415_),
    .B1(_1416_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4250_ (.A(_1418_),
    ...
    .VPWR(VPWR),
    .Y(_1421_));
 sky130_fd_sc_hd__xnor2_1 _4251_ (.A(_1294_),
    .B(_1264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1422_));
 sky130_fd_sc_hd__xor2_1 _4252_ (.A(_1296_),
    .B(_1334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1423_));
 sky130_fd_sc_hd__nand2_1 _4253_ (.A(_1422_),
    .B(_1423_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211o_1 _4255_ (.A1(_1382_),
    ...
    .VPWR(VPWR),
    .X(_1426_));
 sky130_fd_sc_hd__xnor2_1 _4256_ (.A(_1397_),
    .B(_1415_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _4263_ (.A(_1431_),
    ...
    .VPWR(VPWR),
    .X(_1434_));
 sky130_fd_sc_hd__xor2_1 _4264_ (.A(_1399_),
    .B(_1412_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _4266_ (.A(_1434_),
    ...
    .VPWR(VPWR),
    .X(_1437_));
 sky130_fd_sc_hd__xnor2_1 _4267_ (.A(_1402_),
    .B(_1409_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _4273_ (.A(net74),
    ...
    .VPWR(VPWR),
    .X(_1444_));
 sky130_fd_sc_hd__a21oi_1 _4274_ (.A1(_1270_),
    .A2(_1443_),
    .B1(_1444_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4276_ (.A_N(_1445_),
    ...
    .VPWR(VPWR),
    .X(_1447_));
 sky130_fd_sc_hd__a21oi_1 _4277_ (.A1(_1440_),
    .A2(_1446_),
    .B1(_1447_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1448_));
 sky130_fd_sc_hd__xnor2_1 _4278_ (.A(_1438_),
    .B(_1448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1449_));
 sky130_fd_sc_hd__or2_1 _4279_ (.A(_1438_),
    .B(_1448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _4280_ (.A1(_1437_),
    ...
    .VPWR(VPWR),
    .X(_1451_));
 sky130_fd_sc_hd__xnor2_1 _4281_ (.A(_1435_),
    .B(_1451_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _4282_ (.A_N(_1451_),
    ...
    .VPWR(VPWR),
    .X(_1453_));
 sky130_fd_sc_hd__a21oi_1 _4283_ (.A1(_1434_),
    .A2(_1452_),
    .B1(_1453_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _4284_ (.A(_1427_),
    ...
    .VPWR(VPWR),
    .X(_1455_));
 sky130_fd_sc_hd__xnor2_1 _4285_ (.A(_1383_),
    .B(_1417_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1456_));
 sky130_fd_sc_hd__xnor2_1 _4286_ (.A(_1434_),
    .B(_1452_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _4292_ (.A(_1461_),
    ...
    .VPWR(VPWR),
    .X(_1463_));
 sky130_fd_sc_hd__and2b_1 _4293_ (.A_N(_1460_),
    .B(_1463_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1464_));
 sky130_fd_sc_hd__xor2_1 _4294_ (.A(_1437_),
    .B(_1449_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _4295_ (.A_N(_1463_),
    ...
    .VPWR(VPWR),
    .X(_1466_));
 sky130_fd_sc_hd__or2_1 _4296_ (.A(_1464_),
    .B(_1466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _4297_ (.A(_1440_),
    ...
    .VPWR(VPWR),
    .Y(_1468_));
 sky130_fd_sc_hd__xnor2_1 _4298_ (.A(_1389_),
    .B(_1458_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1469_));
 sky130_fd_sc_hd__xnor2_1 _4299_ (.A(_1349_),
    .B(_1469_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1470_));
 sky130_fd_sc_hd__xor2_1 _4300_ (.A(_1270_),
    .B(_1443_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _4303_ (.A(net78),
    ...
    .VPWR(VPWR),
    .X(_1474_));
 sky130_fd_sc_hd__a21oi_1 _4304_ (.A1(_1196_),
    .A2(_1473_),
    .B1(_1474_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1475_));
 sky130_fd_sc_hd__xnor2_1 _4305_ (.A(_1471_),
    .B(_1475_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1476_));
 sky130_fd_sc_hd__and2b_1 _4306_ (.A_N(_1475_),
    .B(_1471_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1477_));
 sky130_fd_sc_hd__a21oi_1 _4307_ (.A1(_1470_),
    .A2(_1476_),
    .B1(_1477_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _4308_ (.A(_1468_),
    ...
    .VPWR(VPWR),
    .Y(_1479_));
 sky130_fd_sc_hd__or2_1 _4309_ (.A(_1468_),
    .B(_1478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _4310_ (.A1(_1467_),
    ...
    .VPWR(VPWR),
    .X(_1481_));
 sky130_fd_sc_hd__xnor2_1 _4311_ (.A(_1465_),
    .B(_1481_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1482_));
 sky130_fd_sc_hd__or2b_1 _4312_ (.A(_1481_),
    .B_N(_1465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _4316_ (.A(_1485_),
    ...
    .VPWR(VPWR),
    .Y(_1487_));
 sky130_fd_sc_hd__a2bb2o_1 _4317_ (.A1_N(_1455_),
    .A2_N(_1456_),
    .B1(_1485_),
    .B2(_1486_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor3_1 _4322_ (.A(_1461_),
    ...
    .VPWR(VPWR),
    .Y(_1493_));
 sky130_fd_sc_hd__and2_1 _4323_ (.A(net98),
    .B(_1493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _4327_ (.A(_1493_),
    ...
    .VPWR(VPWR),
    .X(_1498_));
 sky130_fd_sc_hd__xor2_1 _4328_ (.A(_1196_),
    .B(_1473_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _4335_ (.A1(_1498_),
    ...
    .VPWR(VPWR),
    .X(_1506_));
 sky130_fd_sc_hd__and2_1 _4336_ (.A(net92),
    .B(net94),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _4346_ (.A(_1498_),
    ...
    .VPWR(VPWR),
    .Y(_1517_));
 sky130_fd_sc_hd__xor2_1 _4347_ (.A(_1181_),
    .B(_1501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _4350_ (.A(net84),
    ...
    .VPWR(VPWR),
    .X(_1521_));
 sky130_fd_sc_hd__a21oi_1 _4351_ (.A1(_1165_),
    .A2(_1520_),
    .B1(_1521_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1522_));
 sky130_fd_sc_hd__xnor2_1 _4352_ (.A(_1518_),
    .B(_1522_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1523_));
 sky130_fd_sc_hd__xnor2_1 _4353_ (.A(_1463_),
    .B(_1507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4361_ (.A(_1513_),
    ...
    .VPWR(VPWR),
    .Y(_1532_));
 sky130_fd_sc_hd__xnor2_1 _4362_ (.A(_1464_),
    .B(_1482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _4363_ (.A(_1495_),
    ...
    .VPWR(VPWR),
    .Y(_1534_));
 sky130_fd_sc_hd__a21oi_1 _4364_ (.A1(_1494_),
    .A2(_1512_),
    .B1(_1534_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1535_));
 sky130_fd_sc_hd__xor2_1 _4365_ (.A(_1533_),
    .B(_1535_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4371_ (.A(net95),
    ...
    .VPWR(VPWR),
    .Y(_1542_));
 sky130_fd_sc_hd__xnor2_1 _4372_ (.A(_1523_),
    .B(_1524_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _4374_ (.A(_1165_),
    ...
    .VPWR(VPWR),
    .X(_1545_));
 sky130_fd_sc_hd__xnor2_1 _4375_ (.A(net95),
    .B(net97),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _4395_ (.A(net100),
    ...
    .VPWR(VPWR),
    .Y(_1566_));
 sky130_fd_sc_hd__xnor2_1 _4396_ (.A(_1302_),
    .B(_1546_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _4398_ (.A(net89),
    ...
    .VPWR(VPWR),
    .X(_1569_));
 sky130_fd_sc_hd__a31oi_1 _4399_ (.A1(_1344_),
    .A2(_1564_),
    .A3(_1568_),
    .B1(_1569_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _4421_ (.A1(_1559_),
    ...
    .VPWR(VPWR),
    .Y(_1592_));
 sky130_fd_sc_hd__or3_1 _4422_ (.A(_1489_),
    .B(_1541_),
    .C(_1592_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4431_ (.A_N(_1274_),
    ...
    .VPWR(VPWR),
    .X(_1602_));
 sky130_fd_sc_hd__o21ai_1 _4432_ (.A1(_1601_),
    .A2(_1602_),
    .B1(net87),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _4490_ (.A(_1147_),
    ...
    .VPWR(VPWR),
    .X(_1661_));
 sky130_fd_sc_hd__o21ai_1 _4491_ (.A1(_1658_),
    .A2(_1660_),
    .B1(_1661_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _4514_ (.A1(net54),
    ...
    .VPWR(VPWR),
    .X(_1685_));
 sky130_fd_sc_hd__xor2_1 _4515_ (.A(_1682_),
    .B(_1685_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _4525_ (.A1(_1692_),
    ...
    .VPWR(VPWR),
    .X(_1696_));
 sky130_fd_sc_hd__mux2_1 _4526_ (.A0(_0991_),
    .A1(_0995_),
    .S(_1696_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1697_));
 sky130_fd_sc_hd__a22o_1 _4527_ (.A1(net43),
    .A2(_0946_),
    .B1(_1697_),
    .B2(_0951_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a311o_1 _4535_ (.A1(_1691_),
    ...
    .VPWR(VPWR),
    .X(_1703_));
 sky130_fd_sc_hd__a21bo_1 _4536_ (.A1(net40),
    .A2(_0947_),
    .B1_N(_1703_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _4557_ (.A(_1717_),
    ...
    .VPWR(VPWR),
    .X(_1720_));
 sky130_fd_sc_hd__a22o_1 _4558_ (.A1(net50),
    .A2(_0946_),
    .B1(_1720_),
    .B2(_0951_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _4566_ (.A(_1646_),
    ...
    .VPWR(VPWR),
    .X(_1727_));
 sky130_fd_sc_hd__a22o_1 _4567_ (.A1(net48),
    .A2(_0946_),
    .B1(_1727_),
    .B2(_0258_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _4568_ (.A(_1725_),
    ...
    .VPWR(VPWR),
    .X(_1728_));
 sky130_fd_sc_hd__a22o_1 _4569_ (.A1(net47),
    .A2(_0946_),
    .B1(_1728_),
    .B2(_0258_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _4576_ (.A(_1730_),
    ...
    .VPWR(VPWR),
    .Y(_1734_));
 sky130_fd_sc_hd__a22o_1 _4577_ (.A1(net45),
    .A2(_0946_),
    .B1(_1734_),
    .B2(_0258_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4583_ (.A(_1968_),
    ...
    .VPWR(VPWR),
    .Y(_1738_));
 sky130_fd_sc_hd__a21o_1 _4584_ (.A1(net35),
    .A2(_1738_),
    .B1(_0951_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__a21o_1 _4585_ (.A1(net36),
    .A2(_1738_),
    .B1(_0951_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _4693_ (.A(clk),
    ...
    .VPWR(VPWR),
    .Y(_0106_));
 sky130_fd_sc_hd__dfrtp_1 _4694_ (.CLK(_0000_),
    .D(_0107_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\state[0] ));
 sky130_fd_sc_hd__dfstp_1 _4695_ (.CLK(_0001_),
    .D(_0108_),
    .SET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net36));
 sky130_fd_sc_hd__dfrtp_1 _4696_ (.CLK(_0002_),
    .D(_0109_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net35));
 sky130_fd_sc_hd__dfrtp_1 _4697_ (.CLK(_0003_),
    .D(_0110_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net37));
 sky130_fd_sc_hd__dfrtp_1 _4698_ (.CLK(_0004_),
    .D(_0111_),
    .RESET_B(net176),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net44));
 sky130_fd_sc_hd__dfrtp_1 _4699_ (.CLK(_0005_),
    .D(_0112_),
    .RESET_B(net176),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net45));
 sky130_fd_sc_hd__dfrtp_1 _4700_ (.CLK(_0006_),
    .D(_0113_),
    .RESET_B(net176),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net46));
 sky130_fd_sc_hd__dfrtp_1 _4701_ (.CLK(_0007_),
    .D(_0114_),
    .RESET_B(net176),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net47));
 sky130_fd_sc_hd__dfrtp_1 _4702_ (.CLK(_0008_),
    .D(_0115_),
    .RESET_B(net176),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net48));
 sky130_fd_sc_hd__dfrtp_1 _4703_ (.CLK(_0009_),
    .D(_0116_),
    .RESET_B(net174),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net49));
 sky130_fd_sc_hd__dfrtp_1 _4704_ (.CLK(_0010_),
    .D(_0117_),
    .RESET_B(net174),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net50));
 sky130_fd_sc_hd__dfrtp_1 _4705_ (.CLK(_0011_),
    .D(_0118_),
    .RESET_B(net174),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net51));
 sky130_fd_sc_hd__dfrtp_1 _4706_ (.CLK(_0012_),
    .D(_0119_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net52));
 sky130_fd_sc_hd__dfrtp_1 _4707_ (.CLK(_0013_),
    .D(_0120_),
    .RESET_B(net174),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net38));
 sky130_fd_sc_hd__dfrtp_1 _4708_ (.CLK(_0014_),
    .D(_0121_),
    .RESET_B(net174),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net39));
 sky130_fd_sc_hd__dfrtp_1 _4709_ (.CLK(_0015_),
    .D(_0122_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net40));
 sky130_fd_sc_hd__dfrtp_1 _4710_ (.CLK(_0016_),
    .D(_0123_),
    .RESET_B(net174),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net41));
 sky130_fd_sc_hd__dfrtp_1 _4711_ (.CLK(_0017_),
    .D(_0124_),
    .RESET_B(net174),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net42));
 sky130_fd_sc_hd__dfrtp_1 _4712_ (.CLK(_0018_),
    .D(_0125_),
    .RESET_B(net174),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net43));
 sky130_fd_sc_hd__dfrtp_1 _4713_ (.CLK(_0019_),
    .D(_0126_),
    .RESET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net19));
 sky130_fd_sc_hd__dfrtp_1 _4714_ (.CLK(_0020_),
    .D(_0127_),
    .RESET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net26));
 sky130_fd_sc_hd__dfrtp_1 _4715_ (.CLK(_0021_),
    .D(_0128_),
    .RESET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net27));
 sky130_fd_sc_hd__dfrtp_1 _4716_ (.CLK(_0022_),
    .D(_0129_),
    .RESET_B(net183),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net28));
 sky130_fd_sc_hd__dfrtp_1 _4717_ (.CLK(_0023_),
    .D(_0130_),
    .RESET_B(net183),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net29));
 sky130_fd_sc_hd__dfrtp_1 _4718_ (.CLK(_0024_),
    .D(_0131_),
    .RESET_B(net183),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net30));
 sky130_fd_sc_hd__dfrtp_1 _4719_ (.CLK(_0025_),
    .D(_0132_),
    .RESET_B(net183),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net31));
 sky130_fd_sc_hd__dfrtp_1 _4720_ (.CLK(_0026_),
    .D(_0133_),
    .RESET_B(net183),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net32));
 sky130_fd_sc_hd__dfrtp_1 _4721_ (.CLK(_0027_),
    .D(_0134_),
    .RESET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net33));
 sky130_fd_sc_hd__dfrtp_1 _4722_ (.CLK(_0028_),
    .D(_0135_),
    .RESET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net34));
 sky130_fd_sc_hd__dfrtp_1 _4723_ (.CLK(_0029_),
    .D(_0136_),
    .RESET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net20));
 sky130_fd_sc_hd__dfrtp_1 _4724_ (.CLK(_0030_),
    .D(_0137_),
    .RESET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net21));
 sky130_fd_sc_hd__dfrtp_1 _4725_ (.CLK(_0031_),
    .D(_0138_),
    .RESET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net22));
 sky130_fd_sc_hd__dfrtp_1 _4726_ (.CLK(_0032_),
    .D(_0139_),
    .RESET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net23));
 sky130_fd_sc_hd__dfrtp_1 _4727_ (.CLK(_0033_),
    .D(_0140_),
    .RESET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net24));
 sky130_fd_sc_hd__dfrtp_1 _4728_ (.CLK(_0034_),
    .D(_0141_),
    .RESET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net25));
 sky130_fd_sc_hd__dfrtp_1 _4729_ (.CLK(_0035_),
    .D(_0142_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\gm0.iter[0] ));
 sky130_fd_sc_hd__dfrtp_1 _4730_ (.CLK(_0036_),
    .D(_0143_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\gm0.iter[1] ));
 sky130_fd_sc_hd__dfrtp_1 _4731_ (.CLK(_0037_),
    .D(_0144_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\gm0.iter[2] ));
 sky130_fd_sc_hd__dfrtp_1 _4732_ (.CLK(_0038_),
    .D(_0145_),
    .RESET_B(net179),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\gm0.iter[3] ));
 sky130_fd_sc_hd__dfrtp_1 _4733_ (.CLK(_0039_),
    .D(_0146_),
    .RESET_B(net179),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\gm0.iter[4] ));
 sky130_fd_sc_hd__dfrtp_1 _4734_ (.CLK(_0040_),
    .D(_0147_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[0] ));
 sky130_fd_sc_hd__dfrtp_1 _4735_ (.CLK(_0041_),
    .D(_0148_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[1] ));
 sky130_fd_sc_hd__dfrtp_1 _4736_ (.CLK(_0042_),
    .D(_0149_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[2] ));
 sky130_fd_sc_hd__dfrtp_1 _4737_ (.CLK(_0043_),
    .D(_0150_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[3] ));
 sky130_fd_sc_hd__dfrtp_1 _4738_ (.CLK(_0044_),
    .D(_0151_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[4] ));
 sky130_fd_sc_hd__dfrtp_1 _4739_ (.CLK(_0045_),
    .D(_0152_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[5] ));
 sky130_fd_sc_hd__dfrtp_1 _4740_ (.CLK(_0046_),
    .D(_0153_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[6] ));
 sky130_fd_sc_hd__dfrtp_1 _4741_ (.CLK(_0047_),
    .D(_0154_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[7] ));
 sky130_fd_sc_hd__dfrtp_1 _4742_ (.CLK(_0048_),
    .D(_0155_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[8] ));
 sky130_fd_sc_hd__dfrtp_1 _4743_ (.CLK(_0049_),
    .D(_0156_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[9] ));
 sky130_fd_sc_hd__dfrtp_1 _4744_ (.CLK(_0050_),
    .D(_0157_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[10] ));
 sky130_fd_sc_hd__dfrtp_1 _4745_ (.CLK(_0051_),
    .D(_0158_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[11] ));
 sky130_fd_sc_hd__dfrtp_1 _4746_ (.CLK(_0052_),
    .D(_0159_),
    .RESET_B(net178),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[12] ));
 sky130_fd_sc_hd__dfrtp_1 _4747_ (.CLK(_0053_),
    .D(_0160_),
    .RESET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[13] ));
 sky130_fd_sc_hd__dfrtp_1 _4748_ (.CLK(_0054_),
    .D(_0161_),
    .RESET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[14] ));
 sky130_fd_sc_hd__dfrtp_1 _4749_ (.CLK(_0055_),
    .D(_0162_),
    .RESET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[15] ));
 sky130_fd_sc_hd__dfrtp_1 _4750_ (.CLK(_0056_),
    .D(_0163_),
    .RESET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opA[16] ));
 sky130_fd_sc_hd__dfstp_1 _4751_ (.CLK(_0057_),
    .D(_0164_),
    .SET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][0] ));
 sky130_fd_sc_hd__dfstp_1 _4752_ (.CLK(_0058_),
    .D(_0165_),
    .SET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][1] ));
 sky130_fd_sc_hd__dfstp_1 _4753_ (.CLK(_0059_),
    .D(_0166_),
    .SET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][2] ));
 sky130_fd_sc_hd__dfstp_1 _4754_ (.CLK(_0060_),
    .D(_0167_),
    .SET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][3] ));
 sky130_fd_sc_hd__dfstp_1 _4755_ (.CLK(_0061_),
    .D(_0168_),
    .SET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][4] ));
 sky130_fd_sc_hd__dfstp_1 _4756_ (.CLK(_0062_),
    .D(_0169_),
    .SET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][5] ));
 sky130_fd_sc_hd__dfstp_1 _4757_ (.CLK(_0063_),
    .D(_0170_),
    .SET_B(net182),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][6] ));
 sky130_fd_sc_hd__dfstp_1 _4758_ (.CLK(_0064_),
    .D(_0171_),
    .SET_B(net179),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][7] ));
 sky130_fd_sc_hd__dfstp_1 _4759_ (.CLK(_0065_),
    .D(_0172_),
    .SET_B(net179),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][8] ));
 sky130_fd_sc_hd__dfstp_1 _4760_ (.CLK(_0066_),
    .D(_0173_),
    .SET_B(net179),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][9] ));
 sky130_fd_sc_hd__dfstp_1 _4761_ (.CLK(_0067_),
    .D(_0174_),
    .SET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][10] ));
 sky130_fd_sc_hd__dfstp_1 _4762_ (.CLK(_0068_),
    .D(_0175_),
    .SET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][11] ));
 sky130_fd_sc_hd__dfstp_1 _4763_ (.CLK(_0069_),
    .D(_0176_),
    .SET_B(net181),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][12] ));
 sky130_fd_sc_hd__dfstp_1 _4764_ (.CLK(_0070_),
    .D(_0177_),
    .SET_B(net184),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][13] ));
 sky130_fd_sc_hd__dfstp_1 _4765_ (.CLK(_0071_),
    .D(_0178_),
    .SET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][14] ));
 sky130_fd_sc_hd__dfstp_1 _4766_ (.CLK(_0072_),
    .D(_0179_),
    .SET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][15] ));
 sky130_fd_sc_hd__dfrtp_1 _4767_ (.CLK(_0073_),
    .D(_0180_),
    .RESET_B(net178),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[0][16] ));
 sky130_fd_sc_hd__dfrtp_1 _4768_ (.CLK(_0074_),
    .D(_0181_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[0] ));
 sky130_fd_sc_hd__dfrtp_1 _4769_ (.CLK(_0075_),
    .D(_0182_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[1] ));
 sky130_fd_sc_hd__dfrtp_1 _4770_ (.CLK(_0076_),
    .D(_0183_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[2] ));
 sky130_fd_sc_hd__dfrtp_1 _4771_ (.CLK(_0077_),
    .D(_0184_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[3] ));
 sky130_fd_sc_hd__dfrtp_1 _4772_ (.CLK(_0078_),
    .D(_0185_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[4] ));
 sky130_fd_sc_hd__dfrtp_1 _4773_ (.CLK(_0079_),
    .D(_0186_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[5] ));
 sky130_fd_sc_hd__dfrtp_1 _4774_ (.CLK(_0080_),
    .D(_0187_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[6] ));
 sky130_fd_sc_hd__dfrtp_1 _4775_ (.CLK(_0081_),
    .D(_0188_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[7] ));
 sky130_fd_sc_hd__dfrtp_1 _4776_ (.CLK(_0082_),
    .D(_0189_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[8] ));
 sky130_fd_sc_hd__dfrtp_1 _4777_ (.CLK(_0083_),
    .D(_0190_),
    .RESET_B(net177),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[9] ));
 sky130_fd_sc_hd__dfrtp_1 _4778_ (.CLK(_0084_),
    .D(_0191_),
    .RESET_B(net178),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _4779_ (.CLK(_0085_),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[11] ));
 sky130_fd_sc_hd__dfrtp_1 _4780_ (.CLK(_0086_),
    .D(_0193_),
    .RESET_B(net178),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[12] ));
 sky130_fd_sc_hd__dfrtp_1 _4781_ (.CLK(_0087_),
    .D(_0194_),
    .RESET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[13] ));
 sky130_fd_sc_hd__dfrtp_1 _4782_ (.CLK(_0088_),
    .D(_0195_),
    .RESET_B(net178),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[14] ));
 sky130_fd_sc_hd__dfrtp_1 _4783_ (.CLK(_0089_),
    .D(_0196_),
    .RESET_B(net180),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\slte0.opB[15] ));
 sky130_fd_sc_hd__dfrtp_1 _4784_ (.CLK(_0090_),
    .D(_0197_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][0] ));
 sky130_fd_sc_hd__dfrtp_1 _4785_ (.CLK(_0091_),
    .D(_0198_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][1] ));
 sky130_fd_sc_hd__dfrtp_1 _4786_ (.CLK(_0092_),
    .D(_0199_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][2] ));
 sky130_fd_sc_hd__dfrtp_1 _4787_ (.CLK(_0093_),
    .D(_0200_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][3] ));
 sky130_fd_sc_hd__dfrtp_1 _4788_ (.CLK(_0094_),
    .D(_0201_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][4] ));
 sky130_fd_sc_hd__dfrtp_1 _4789_ (.CLK(_0095_),
    .D(_0202_),
    .RESET_B(net175),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][5] ));
 sky130_fd_sc_hd__dfrtp_1 _4790_ (.CLK(_0096_),
    .D(_0203_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][6] ));
 sky130_fd_sc_hd__dfrtp_1 _4791_ (.CLK(_0097_),
    .D(_0204_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][7] ));
 sky130_fd_sc_hd__dfrtp_1 _4792_ (.CLK(_0098_),
    .D(_0205_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][8] ));
 sky130_fd_sc_hd__dfrtp_1 _4793_ (.CLK(_0099_),
    .D(_0206_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][9] ));
 sky130_fd_sc_hd__dfrtp_1 _4794_ (.CLK(_0100_),
    .D(_0207_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][10] ));
 sky130_fd_sc_hd__dfrtp_1 _4795_ (.CLK(_0101_),
    .D(_0208_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][11] ));
 sky130_fd_sc_hd__dfrtp_1 _4796_ (.CLK(_0102_),
    .D(_0209_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][12] ));
 sky130_fd_sc_hd__dfrtp_1 _4797_ (.CLK(_0103_),
    .D(_0210_),
    .RESET_B(net173),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][13] ));
 sky130_fd_sc_hd__dfrtp_1 _4798_ (.CLK(_0104_),
    .D(_0211_),
    .RESET_B(net171),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][14] ));
 sky130_fd_sc_hd__dfrtp_1 _4799_ (.CLK(_0105_),
    .D(_0212_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vec[1][15] ));
 sky130_fd_sc_hd__dfrtp_1 _4800_ (.CLK(_0106_),
    .D(_0213_),
    .RESET_B(net172),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 input1 (.A(in_valid),
    ...
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_2 input2 (.A(rstb),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 fanout54 (.A(net55),
    ...
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__clkbuf_2 fanout55 (.A(\vec[1][16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout59 (.A(net60),
    ...
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__clkbuf_2 fanout60 (.A(\vec[1][14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 fanout62 (.A(net63),
    ...
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__clkbuf_2 fanout63 (.A(\vec[1][13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout71 (.A(net72),
    ...
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__clkbuf_2 fanout72 (.A(\vec[1][10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout74 (.A(net75),
    ...
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__buf_2 fanout75 (.A(\vec[1][9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 fanout77 (.A(net78),
    ...
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__clkbuf_2 fanout78 (.A(\vec[1][8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout80 (.A(net81),
    ...
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__clkbuf_4 fanout81 (.A(\vec[1][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 fanout86 (.A(\vec[1][5] ),
    ...
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__buf_2 fanout87 (.A(\vec[1][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout89 (.A(net90),
    ...
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__buf_2 fanout90 (.A(\vec[1][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout92 (.A(net93),
    ...
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__buf_2 fanout93 (.A(\vec[1][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout119 (.A(net120),
    ...
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__clkbuf_4 fanout120 (.A(\vec[0][11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 fanout121 (.A(net122),
    ...
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__buf_2 fanout122 (.A(\vec[0][10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 fanout130 (.A(\vec[0][7] ),
    ...
    .VPWR(VPWR),
    .X(net130));
 sky130_fd_sc_hd__clkbuf_4 fanout131 (.A(\vec[0][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout135 (.A(\vec[0][6] ),
    ...
    .VPWR(VPWR),
    .X(net135));
 sky130_fd_sc_hd__buf_4 fanout136 (.A(\vec[0][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout140 (.A(net141),
    ...
    .VPWR(VPWR),
    .X(net140));
 sky130_fd_sc_hd__buf_2 fanout141 (.A(\vec[0][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout150 (.A(\vec[0][1] ),
    ...
    .VPWR(VPWR),
    .X(net150));
 sky130_fd_sc_hd__buf_2 fanout151 (.A(\vec[0][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout152 (.A(net153),
    ...
    .VPWR(VPWR),
    .X(net152));
 sky130_fd_sc_hd__clkbuf_2 fanout153 (.A(\gm0.iter[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout154 (.A(\gm0.iter[3] ),
    ...
    .VPWR(VPWR),
    .X(net154));
 sky130_fd_sc_hd__buf_1 fanout155 (.A(\gm0.iter[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout160 (.A(net161),
    ...
    .VPWR(VPWR),
    .X(net160));
 sky130_fd_sc_hd__buf_2 fanout161 (.A(\gm0.iter[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout165 (.A(net166),
    ...
    .VPWR(VPWR),
    .X(net165));
 sky130_fd_sc_hd__buf_2 fanout166 (.A(\gm0.iter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout173 (.A(net174),
    ...
    .VPWR(VPWR),
    .X(net173));
 sky130_fd_sc_hd__clkbuf_4 fanout174 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
